...
typedef struct BossGanon2 {
    ...
    /* 0x0311 */ u8 unk_311;
    /* 0x0312 */ u8 unk_312;
    /* 0x0313 */ u8 look_on; // "look_on"
    /* 0x0314 */ u8 unk_314;
    /* 0x0316 */ s16 no_hit_time; // "no_hit_time"
    /* 0x0318 */ s16 unk_318;
    /* 0x031A */ s16 unk_31A;
    /* 0x031C */ s16 unk_31C;
    /* 0x0320 */ f32 unk_320;
    ...
    /* 0x041C */ f32 unk_41C;
    /* 0x0420 */ f32 unk_420;
    /* 0x0424 */ ColliderJntSph colliderSpheres;
    /* 0x0444 */ ColliderJntSph colliderSpheres2;
    /* 0x0464 */ ColliderJntSphElement colliderSphereElements[16];
    /* 0x0864 */ ColliderJntSphElement colliderSphereElements2[2];
