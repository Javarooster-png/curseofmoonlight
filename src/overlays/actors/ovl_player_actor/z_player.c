...
#include "src/code/z_bgcheck.h"

// Some player animations are played at this reduced speed, for reasons yet unclear.
// This is called "adjusted" for now.
#define PLAYER_ANIM_ADJUSTED_SPEED (2.0f / 3.0f)
#define SCENE_FOREST_TEMPLE 0
#define SCENE_SHADOW_TEMPLE 0
...
static GetItemEntry sGetItemTable[] = {
    ...
    // GI_SWORD_KOKIRI
    GET_ITEM(ITEM_SWORD_MASTER, OBJECT_GI_SWORD_1, GID_SWORD_KOKIRI, 0xA4, 0x80, CHEST_ANIM_LONG),
    // GI_SWORD_KNIFE
...
// this is taking the sfxId and adding offset to it (-3-)
u16 func_808327A4(Player* this, u16 sfxId) { // TODO HERE
    SurfaceSfxOffset sfx1;
    SurfaceSfxOffset sfx2;
    ...
    SurfaceSfxOffset getRandomSfx(SurfaceSfxOffset option1, SurfaceSfxOffset option2, SurfaceSfxOffset option3) {
        unsigned int randValue = simple_rand() % 3;
        return randValue == 0 ? option1 : (randValue == 1 ? option2 : option3);
    }


    sfx1 = getRandomSfx(NA_SE_EN_GANON_LAUGH, NA_SE_PL_WALK_GROUND + SURFACE_SFX_OFFSET_WOOD, NA_SE_EN_GANON_DEAD);
    sfx2 = getRandomSfx(NA_SE_EN_GERUDOFT_BREATH, NA_SE_EN_TWINROBA_YOUNG_WINK, NA_SE_PL_WALK_GROUND + SURFACE_SFX_OFFSET_BRIDGE);

    if (this->floorSfxOffset == SURFACE_SFX_OFFSET_WOOD) {
        return sfx1;
    } else if (this->floorSfxOffset == SURFACE_SFX_OFFSET_BRIDGE) {
        return sfx2;
    } else {
...
void func_808333FC(Player* this, s32 arg1) {
    if (D_80853E7C[arg1] != 0) {
        Player_ProcessAnimSfxList(this, D_80853E50[D_80853E7C[arg1] - 1]); // HEREk
    }
}
...
s32 Player_CalcSpeedAndYawFromControlStick(PlayState* play, Player* this, f32* outSpeedTarget, s16* outYawTarget,
                                           f32 speedMode) {
if (this->PlayerMadnessDecayTimer > 0) {
  f32 temp;
    f32 sinFloorPitch;
    f32 floorPitchInfluence;
    f32 speedCap;
    f32 debuffMultiplier;
    if (this->PlayerWebTimer > 0) {
        // Apply a flat speed reduction or gradual reduction
        debuffMultiplier = 1.0f - (this->PlayerWebTimer / 255.0f);

        // Decrease the timer each frame
        this->PlayerWebTimer--;
    }
    if ((this->unk_6AD != 0) || (play->transitionTrigger == TRANS_TRIGGER_START) || (this->stateFlags1 & PLAYER_STATE1_0)) {
        *outSpeedTarget = 0.0f;
        *outYawTarget = this->actor.shape.rot.y;
    } else {
        // Use the normal control stick magnitude for speed but reverse the yaw direction.
        *outSpeedTarget = sControlStickMagnitude;
        
        // Reverse the yaw angle
        *outYawTarget = sControlStickAngle + 0x8000;   // Add 180 degrees to angle

        // Normalize angle within 0 to 65535 range
        if (*outYawTarget < 0) {
            *outYawTarget += 0x10000;
        } else if (*outYawTarget >= 0x10000) {
            *outYawTarget -= 0x10000;
        }
        ...
        if (sControlStickMagnitude != 0.0f) {
            ...
            *outSpeedTarget = CLAMP(*outSpeedTarget, 0.0f, speedCap);
                if (this->PlayerWebTimer > 0) {
            *outSpeedTarget *= debuffMultiplier;
                }
            return true;
        }
    }
...
void func_8083AE40(Player* this, s16 objectId) {
    ...
    if (objectId != OBJECT_INVALID) {
        ...
        ASSERT(size <= GI_MODEL_LIMIT, "size <= 1024 * 8", "../z_player.c", 9091);
...
/*s32 func_8083BC7C(Player* this, PlayState* play) {
    if ((sFloorType != FLOOR_TYPE_7) && (this->speedXZ > 1.0f)) {
        // 2.0f is an example threshold for speed; you can adjust this value as needed
        func_8083BC04(this, play);
        return 1;
    }
...
void func_8083BCD0(Player* this, PlayState* play, s32 arg2) {
    ...
    if (this->PlayerWebTimer > 80) {
    this->speedXZ = !(arg2 & 1) ? 3.0f : 4.5f;
    } else {
...
void Player_Action_80843A38(Player* this, PlayState* play) {
    ...
    Player_ProcessAnimSfxList(this, D_808545DC); // HERE
}
...
void Player_Action_80843CEC(Player* this, PlayState* play) {
    ...
    if (this->skelAnime.animation == &gPlayerAnim_link_derth_rebirth) {
        Player_ProcessAnimSfxList(this, D_808545F0); // HERE
    ...
    if (func_80842964(this, play) == 0) {
        if (this->av2.actionVar2 != 0) {
            ...
            if ((this->skelAnime.curFrame < 15.0f) || !Player_ActionChange_7(this, play)) {
                ...
                Player_ProcessAnimSfxList(this, D_8085460C); // HERE
            }
        }
    }
}
...
void Player_Action_80846120(Player* this, PlayState* play) {
    ...
    Player_ProcessAnimSfxList(this, D_8085461C); // HERE
}
...
void Player_Init(Actor* thisx, PlayState* play2) {
    ...
    this->giObjectSegment = (void*)(((uintptr_t)ZeldaArena_MallocDebug(GI_MODEL_LIMIT, "../z_player.c", 17175) + 8) & ~0xF);
...
void Player_UpdateCommon(Player* this, PlayState* play, Input* input) {
    ...
    if (this->currentTunic == PLAYER_TUNIC_GORON && gSaveContext.save.info.inventory.defenseHearts < 20) {
        gSaveContext.save.info.playerData.isDoubleDefenseAcquired = true;
        gSaveContext.save.info.inventory.defenseHearts++;
    } else if (this->currentTunic != PLAYER_TUNIC_GORON && gSaveContext.save.info.inventory.defenseHearts > 0) {
        gSaveContext.save.info.playerData.isDoubleDefenseAcquired = false;
        gSaveContext.save.info.inventory.defenseHearts--;
    }

    if ((gSaveContext.save.info.playerData.bgsFlag == 0) && (CHECK_OWNED_EQUIP(EQUIP_TYPE_SWORD, EQUIP_INV_SWORD_BIGGORON))) {
        gSaveContext.save.info.playerData.bgsFlag = true;
    }

    if (this->PlayerMadnessDecayTimer >= 1) {
    this->PlayerMadnessDecayTimer --;
    }
    if (this->PlayerMadnessTimer >= 1) {
    this->PlayerMadnessTimer --;
    }
    if (this->PlayerMadnessTimer == 254) {
        Player_PlaySfx(this, NA_SE_VO_LI_FALL_L);
        Play_EnableMotionBlur(200);
    }
    if (this->PlayerMadnessTimer == 0) {
...
void Player_Draw(Actor* thisx, PlayState* play2) {
    ...
    if (!(this->stateFlags2 & PLAYER_STATE2_29)) {
        ...
        s32 lod = 0;
        s32 pad;
        u32 flashingInterval;
        u32 flashingInterval2;
    ...
    if (this->PlayerWebTimer <= 50) {
        // Flash faster as timer gets lower
        flashingInterval = 7 - (50 - this->PlayerWebTimer) / 10;
        if (flashingInterval < 1) flashingInterval = 1;  // Ensure interval doesn't go below 1
    }
        if ((this->PlayerWebTimer > 0) && ((play->gameplayFrames % flashingInterval) == 0)){
        Actor_SetColorFilter(&this->actor, COLORFILTER_COLORFLAG_GRAY, 255, COLORFILTER_BUFFLAG_OPA, 3);
        } else if ((this->PlayerWebTimer > 0) && ((play->gameplayFrames % 10) == 0)){
        Actor_SetColorFilter(&this->actor, COLORFILTER_COLORFLAG_GRAY, 255, COLORFILTER_BUFFLAG_OPA, 3);
        }

    if (this->PlayerMadnessDecayTimer <= 50) {
        // Flash faster as timer gets lower
        flashingInterval2 = 7 - (50 - this->PlayerMadnessDecayTimer) / 10;
        if (flashingInterval2 < 1) flashingInterval2 = 1;  // Ensure interval doesn't go below 1
    }
        if ((this->PlayerMadnessDecayTimer > 0) && ((play->gameplayFrames % flashingInterval2) == 0)){
        Actor_SetColorFilter(&this->actor, COLORFILTER_COLORFLAG_BLUE, 255, COLORFILTER_BUFFLAG_OPA, 3);
        } else if ((this->PlayerMadnessDecayTimer > 0) && ((play->gameplayFrames % 10) == 0)){
        Actor_SetColorFilter(&this->actor, COLORFILTER_COLORFLAG_BLUE, 255, COLORFILTER_BUFFLAG_OPA, 3);
        }
...
void Player_Action_8084B898(Player* this, PlayState* play) {
    ...
    Player_ProcessAnimSfxList(this, D_80854870); // HERE
    func_8083F524(play, this);
...
void Player_Action_8084B9E4(Player* this, PlayState* play) {
    ...
    if (func_80832CB0(play, this, anim)) {
        ...
        if (this->av2.actionVar2 == 0) {
            ...
            Player_ProcessAnimSfxList(this, D_80854878); // HERE
        }
    }
...
void Player_Action_8084C760(Player* this, PlayState* play) {
    ...
    Player_ProcessAnimSfxList(this, D_808548B4); // HERE
}
...
void Player_Action_8084C81C(Player* this, PlayState* play) {
    ...
    Player_ProcessAnimSfxList(this, D_808548D8); // HERE
}
...
void Player_Action_8084CC98(Player* this, PlayState* play) {
    ...
    if (this->av2.actionVar2 == 1) {
        if ((D_808535E0 != 0) || func_8083224C(play)) {
            ...
            Player_ProcessAnimSfxList(this, D_808549A4); // HERE
        }
    } else {
...
void Player_Action_8084D3E4(Player* this, PlayState* play) {
    ...
    if (LinkAnimation_Update(play, &this->skelAnime)) {
        ...
        Player_ProcessAnimSfxList(this, D_808549C4); // HERE
    }
}
...
void func_8084D530(Player* this, f32* arg1, f32 arg2, s16 arg3) {
    ...
    Player_ProcessAnimSfxList(this, D_808549D0); // HERE
}
...
void Player_Action_8084E6D4(Player* this, PlayState* play) {
    ...
    if (LinkAnimation_Update(play, &this->skelAnime)) {
        ...
        if (this->av2.actionVar2 == 0) {
            if (!LINK_IS_ADULT) {
                Player_ProcessAnimSfxList(this, D_808549E0); // HERE
            }
            return;
        }
...
void func_8084E988(Player* this) {
    Player_ProcessAnimSfxList(this, D_808549F0); // HERE
}
...
void Player_Action_8084E9AC(Player* this, PlayState* play) {
    if (LinkAnimation_Update(play, &this->skelAnime)) {
        ...
        if (!LINK_IS_ADULT) {
            Player_ProcessAnimSfxList(this, D_808549F4); // HERE
        } else {
            func_8084E988(this);
        }
    }
...
void Player_Action_8084EFC0(Player* this, PlayState* play) {
    ...
    Player_ProcessAnimSfxList(this, D_80854A34); // HERE
}
...
void Player_Action_8084F104(Player* this, PlayState* play) {
    ...
    if (LinkAnimation_Update(play, &this->skelAnime)) {
        ...
        Player_ProcessAnimSfxList(this, D_80854A3C); // HERE
    }
...
void Player_Action_808507F4(Player* this, PlayState* play) {
    if (LinkAnimation_Update(play, &this->skelAnime)) {
        ...
        if (this->av2.actionVar2 < 0) {
            ...
            if (this->av2.actionVar2 == 0) {
                Player_ProcessAnimSfxList(this, D_80854A80); // HERE
            } else if (this->av2.actionVar2 == 1) {
                Player_ProcessAnimSfxList(this, D_80854A8C[this->av1.actionVar1]); // HERE
...
void func_808512E0(PlayState* play, Player* this, void* arg2) {
    LinkAnimation_Update(play, &this->skelAnime);
    Player_ProcessAnimSfxList(this, arg2); // HERE
}
...
void func_80851750(PlayState* play, Player* this, CsCmdActorCue* cue) {
    LinkAnimation_Update(play, &this->skelAnime);
    Player_ProcessAnimSfxList(this, D_80855188); // HERE
}
...
void func_80851A50(PlayState* play, Player* this, CsCmdActorCue* cue) {
    ...
    if ((LINK_IS_ADULT && LinkAnimation_OnFrame(&this->skelAnime, 70.0f)) ||
        ...
        Player_ProcessAnimSfxList(this, D_808551AC); // HERE
    }
}
...
void func_80851BE8(PlayState* play, Player* this, CsCmdActorCue* cue) {
    ...
    if (this->av2.actionVar2 >= 180) {
        ...
        Player_ProcessAnimSfxList(this, D_808551B4); // HERE
    }
}
...
void func_80851D80(PlayState* play, Player* this, CsCmdActorCue* cue) {
    ...
    if (LinkAnimation_OnFrame(&this->skelAnime, 6.0f)) {
        ...
        Player_ProcessAnimSfxList(this, D_808551B8); // HERE
    }
}
...
void func_80851F14(PlayState* play, Player* this, LinkAnimationHeader* anim, AnimSfxEntry* arg3) {
    if (LinkAnimation_Update(play, &this->skelAnime)) {
        ...
        Player_ProcessAnimSfxList(this, arg3); // HERE
    }
}
