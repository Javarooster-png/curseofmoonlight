...
void EnBeast_Init(EnBeast* this, PlayState* play);
void EnBeast_Destroy(EnBeast* this, PlayState* play);
void EnBeast_Update(EnBeast* this, PlayState* play);
void EnBeast_Draw(EnBeast* this, PlayState* play);
void EnBeast_MoveR(EnBeast* this, PlayState* play);
void EnBeast_SetupMoveR(EnBeast* this, PlayState* play);
void EnBeast_MoveL(EnBeast* this, PlayState* play);
void EnBeast_SetupMoveL(EnBeast* this, PlayState* play);
...
ActorInit En_Beast_InitVars = {
    /**/ ACTOR_BEAST,
    /**/ ACTORCAT_ENEMY,
    /**/ FLAGS,
    /**/ OBJECT_BEAST,
    /**/ sizeof(EnBeast),
    /**/ (ActorFunc)EnBeast_Init,
    /**/ (ActorFunc)EnBeast_Destroy,
    /**/ (ActorFunc)EnBeast_Update,
    /**/ (ActorFunc)EnBeast_Draw,
};
...
static ColliderCylinderInit sCylinderInit = {
    ...
    { .radius = 60, .height = 60, .yShift = 0, .pos = { 0, 0, 0,} },
};
...
static DamageTable sDamageTable = {
    /* Deku nut      */ DMG_ENTRY(0xF, WERE_DMGEFF_NORMAL),
    /* Deku stick    */ DMG_ENTRY(2, WERE_DMGEFF_NORMAL),
    /* Slingshot     */ DMG_ENTRY(0, WERE_DMGEFF_SLING),
    /* Explosive     */ DMG_ENTRY(3, WERE_DMGEFF_NORMAL),
    ...
    /* Giant spin    */ DMG_ENTRY(2, WERE_DMGEFF_NORMAL),
...
void EnBeast_Init(EnBeast* this, PlayState* play) {
    ...
    SkelAnime_InitFlex(play, &this->skelAnime, &gBeastSkel, &gBeastSkelIdleAnim, this->jointTable, this->morphTable,
                       GBEASTSKEL_NUM_LIMBS);
...
void EnBeast_Update(EnBeast* this, PlayState* play) {
    ...
    if (((this->actionFunc == EnBeast_AttackA) || (this->actionFunc == EnBeast_AttackA2)) &&
        (this->skelAnime.curFrame > 20.0f) && (this->skelAnime.curFrame < 36.0f)) {
        CollisionCheck_SetAT(play, &play->colChkCtx, &this->colliderSpheres.base);
    }
    if ((this->actionFunc == EnBeast_AttackB) && (this->skelAnime.curFrame > 13.0f) &&
        (this->skelAnime.curFrame < 21.0f)) {
        CollisionCheck_SetAT(play, &play->colChkCtx, &this->colliderSpheres.base);
    }
    if ((this->actionFunc == EnBeast_AttackC) && (this->skelAnime.curFrame > 14.0f) &&
    ...
    if ((player->meleeWeaponState != 0) && Actor_IsFacingPlayer(&this->actor, 0xA38) &&
        (this->actor.xzDistToPlayer < 200.0f) && (this->canDodge == 1) && (this->hurtboxCooldown == 0) &&
...
void EnBeast_Draw(EnBeast* this, PlayState* play) {
    ...
    SkelAnime_DrawFlexOpa(play, this->skelAnime.skeleton, this->skelAnime.jointTable, this->skelAnime.dListCount,
                          EnBeast_OverrideLimbDraw, EnBeast_PostLimbDraw, this);
}
void EnBeast_CheckDamage(EnBeast* this, PlayState* play) {
...
void EnBeast_ForwardBackCheck(EnBeast* this, PlayState* play) {
    ...
    if ((this->alarmstate == 0) && (this->cantSee == 1)) {
        ...
        if ((this->actor.xzDistToPlayer < 70.0f)) {
            ...
            } else if ((relYawTowardsPlayer < 0x1000) && ((this->actor.params & 0xFF) != 1)) {
                this->timer = 28;
...
void EnBeast_AttackA2(EnBeast* this, PlayState* play) {
    ...
    if (this->timer > 0) {
        ...
        Flags_UnsetSwitch(play, (this->actor.params >> 8) & 0xFF);
        EnBeast_ForwardBackCheck(this, play);
    }
}
...
void EnBeast_AttackDa(EnBeast* this, PlayState* play) {
    ...
    if (this->timer > 0) {
        ...
        if ((this->skelAnime.curFrame >= 20.0f) && (this->actor.xzDistToPlayer <= 80) &&
            (relYawTowardsPlayer < 0x1000) && (fabsf(this->actor.world.pos.y - player->actor.world.pos.y) <= 80.0f)) {
            this->actor.speed = 0.0f;
            this->timer = 48;
...
void EnBeast_AttackDb(EnBeast* this, PlayState* play) {
    ...
    pos.y = player->actor.world.pos.y + 65.0f;
    pos.z = player->actor.world.pos.z;
    Vec3f result = vector_between(this->HandR, this->HandL);
    SkelAnime_Update(&this->skelAnime);
