...
#define gHyruleCastleIntroCs 0
#define gGerudoFortressIntroCs 0
#define gDesertColossusIntroCs 0
#define gDeathMountainCraterIntroCs 0
#define gGerudoFortressFirstCaptureCs 0
#define gDeathMountainCraterIntroCs 0
EntranceCutscene sEntranceCutsceneTable[] = {
    ...
    { ENTR_TEMPLE_OF_TIME_0, 2, EVENTCHKINF_A7, NULL },
...
void CutsceneCmd_Destination(PlayState* play, CutsceneContext* csCtx, CsCmdDestination* cmd) {
    ...
    if ((csCtx->curFrame == cmd->startFrame) || titleDemoSkipped || csSkipped) {
