...
StandardLimb gMalonChildRootLimb = { 
    { 0, 1848, 0 }, CHILD_MALON_LIMB_LEFT_THIGH - 1, LIMB_DONE,
    gMalonChildDressUpperDL
};

StandardLimb gMalonChildLeftThighLimb = { 
    { 250, 250, 250 }, CHILD_MALON_LIMB_LEFT_SHIN - 1, CHILD_MALON_LIMB_RIGHT_THIGH - 1,
    gMalonChildLeftThighDL
};

StandardLimb gMalonChildLeftShinLimb = { 
    { 700, 0, 0 }, CHILD_MALON_LIMB_LEFT_FOOT - 1, LIMB_DONE,
...
StandardLimb gMalonChildRightThighLimb = { 
    { 250, 250, -250 }, CHILD_MALON_LIMB_RIGHT_SHIN - 1, CHILD_MALON_LIMB_CHEST - 1,
    gMalonChildRightThighDL
};

StandardLimb gMalonChildRightShinLimb = { 
    { 700, 0, 0 }, CHILD_MALON_LIMB_RIGHT_FOOT - 1, LIMB_DONE,
...
StandardLimb gMalonChildChestLimb = { 
    { 0, 0, 0 }, CHILD_MALON_LIMB_LEFT_SHOULDER - 1, CHILD_MALON_LIMB_DRESS_UPPER - 1,
    gMalonChildChestDL
};

StandardLimb gMalonChildLeftShoulderLimb = { 
    { 950, -100, 500 }, CHILD_MALON_LIMB_LEFT_ARM - 1, CHILD_MALON_LIMB_RIGHT_SHOULDER - 1,
    gMalonChildLeftShoulderDL
};

StandardLimb gMalonChildLeftArmLimb = { 
    { 550, 0, 0 }, CHILD_MALON_LIMB_LEFT_HAND - 1, LIMB_DONE,
...
StandardLimb gMalonChildRightShoulderLimb = { 
    { 950, -100, -500 }, CHILD_MALON_LIMB_RIGHT_ARM - 1, CHILD_MALON_LIMB_HEAD - 1,
    gMalonChildRightShoulderDL
};

StandardLimb gMalonChildRightArmLimb = { 
    { 550, 0, 0 }, CHILD_MALON_LIMB_RIGHT_HAND - 1, LIMB_DONE,
...
StandardLimb gMalonChildDressUpperLimb = { 
    { 450, 0, 0 }, CHILD_MALON_LIMB_DRESS_MIDDLE - 1, LIMB_DONE,
    NULL
};

StandardLimb gMalonChildDressMiddleLimb = { 
    { 0, 0, 0 }, LIMB_DONE, CHILD_MALON_LIMB_DRESS_LOWER - 1,
...
void* gMalonChildSkelLimbs[] = {
    &gMalonChildRootLimb, /* CHILD_MALON_ROOT */
    &gMalonChildLeftThighLimb, /* CHILD_MALON_LIMB_LEFT_THIGH */
    &gMalonChildLeftShinLimb, /* CHILD_MALON_LIMB_LEFT_SHIN */
    &gMalonChildLeftFootLimb, /* CHILD_MALON_LIMB_LEFT_FOOT */
    &gMalonChildRightThighLimb, /* CHILD_MALON_LIMB_RIGHT_THIGH */
    &gMalonChildRightShinLimb, /* CHILD_MALON_LIMB_RIGHT_SHIN */
    &gMalonChildRightFootLimb, /* CHILD_MALON_LIMB_RIGHT_FOOT */
    &gMalonChildChestLimb, /* CHILD_MALON_LIMB_CHEST */
    &gMalonChildLeftShoulderLimb, /* CHILD_MALON_LIMB_LEFT_SHOULDER */
    &gMalonChildLeftArmLimb, /* CHILD_MALON_LIMB_LEFT_ARM */
    &gMalonChildLeftHandLimb, /* CHILD_MALON_LIMB_LEFT_HAND */
    &gMalonChildRightShoulderLimb, /* CHILD_MALON_LIMB_RIGHT_SHOULDER */
    &gMalonChildRightArmLimb, /* CHILD_MALON_LIMB_RIGHT_ARM */
    &gMalonChildRightHandLimb, /* CHILD_MALON_LIMB_RIGHT_HAND */
    &gMalonChildHeadLimb, /* CHILD_MALON_LIMB_HEAD */
    &gMalonChildDressUpperLimb, /* CHILD_MALON_LIMB_DRESS_UPPER */
    &gMalonChildDressMiddleLimb, /* CHILD_MALON_LIMB_DRESS_MIDDLE */
    &gMalonChildDressLowerLimb, /* CHILD_MALON_LIMB_DRESS_LOWER */
};
