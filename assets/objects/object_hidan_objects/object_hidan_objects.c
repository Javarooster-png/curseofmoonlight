...
BgCamInfo gFireTempleStoneBlock1ColCamDataList[] = {
    { 0x0000, 0, NULL },
};

SurfaceType gFireTempleStoneBlock1ColSurfaceType[] = {
    {0x00E00000, 0x000007C0},   {0x00000000, 0x000007C0},   {0x00000000, 0x000007C2},
};
...
CollisionHeader gFireTempleStoneBlock1Col = { 
    { -600, 0, -600 },
    { 600, 1200, 600 },
    ARRAY_COUNT(gFireTempleStoneBlock1ColVertices), gFireTempleStoneBlock1ColVertices,
    ARRAY_COUNT(gFireTempleStoneBlock1ColPolygons), gFireTempleStoneBlock1ColPolygons,
...
BgCamInfo gFireTempleStationaryFlamethrowerShortColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gFireTempleStationaryFlamethrowerShortCol = { 
    { -280, 0, -320 },
    { 280, 1000, 320 },
    ARRAY_COUNT(gFireTempleStationaryFlamethrowerShortColVertices), gFireTempleStationaryFlamethrowerShortColVertices,
    ARRAY_COUNT(gFireTempleStationaryFlamethrowerShortColPolygons), gFireTempleStationaryFlamethrowerShortColPolygons,
...
BgCamInfo gFireTempleStationaryFlamethrowerTallColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gFireTempleStationaryFlamethrowerTallCol = { 
    { -200, 0, -200 },
    { 200, 2400, 200 },
    ARRAY_COUNT(gFireTempleStationaryFlamethrowerTallColVertices), gFireTempleStationaryFlamethrowerTallColVertices,
    ARRAY_COUNT(gFireTempleStationaryFlamethrowerTallColPolygons), gFireTempleStationaryFlamethrowerTallColPolygons,
...
BgCamInfo gFireTempleTallestPillarAboveRoomBeforeBossColCamDataList[] = {
    { 0x0000, 0, NULL },
};

SurfaceType gFireTempleTallestPillarAboveRoomBeforeBossColSurfaceType[] = {
    {0x00000000, 0x000007C2},   {0x0000C000, 0x000007C2},
};
...
CollisionHeader gFireTempleTallestPillarAboveRoomBeforeBossCol = { 
    { -600, -26388, -600 },
    { 600, 0, 600 },
    ARRAY_COUNT(gFireTempleTallestPillarAboveRoomBeforeBossColVertices),
    gFireTempleTallestPillarAboveRoomBeforeBossColVertices,
    ARRAY_COUNT(gFireTempleTallestPillarAboveRoomBeforeBossColPolygons),
    gFireTempleTallestPillarAboveRoomBeforeBossColPolygons,
    gFireTempleTallestPillarAboveRoomBeforeBossColSurfaceType,
    gFireTempleTallestPillarAboveRoomBeforeBossColCamDataList,
    0, NULL
};

BgCamInfo gFireTemplePillarInsertedInGroundColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gFireTemplePillarInsertedInGroundCol = { 
    { -400, -1800, -400 },
    { 400, 0, 400 },
    ARRAY_COUNT(gFireTemplePillarInsertedInGroundColVertices), gFireTemplePillarInsertedInGroundColVertices,
    ARRAY_COUNT(gFireTemplePillarInsertedInGroundColPolygons), gFireTemplePillarInsertedInGroundColPolygons,
...
BgCamInfo gFireTempleSpinningFlamethrowerColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gFireTempleSpinningFlamethrowerCol = { 
    { -300, 0, -300 },
    { 300, 800, 300 },
    ARRAY_COUNT(gFireTempleSpinningFlamethrowerColVertices), gFireTempleSpinningFlamethrowerColVertices,
    ARRAY_COUNT(gFireTempleSpinningFlamethrowerColPolygons), gFireTempleSpinningFlamethrowerColPolygons,
...
BgCamInfo gFireTempleCrackedStoneFloorColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gFireTempleCrackedStoneFloorCol = { 
    { -800, -40, -800 },
    { 800, 80, 800 },
    ARRAY_COUNT(gFireTempleCrackedStoneFloorColVertices), gFireTempleCrackedStoneFloorColVertices,
    ARRAY_COUNT(gFireTempleCrackedStoneFloorColPolygons), gFireTempleCrackedStoneFloorColPolygons,
...
BgCamInfo gFireTempleBombableWallColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gFireTempleBombableWallCol = { 
    { -300, 0, 0 },
    { 300, 1000, 0 },
    ARRAY_COUNT(gFireTempleBombableWallColVertices), gFireTempleBombableWallColVertices,
    ARRAY_COUNT(gFireTempleBombableWallColPolygons), gFireTempleBombableWallColPolygons,
...
BgCamInfo gFireTempleLargeBombableWallColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gFireTempleLargeBombableWallCol = { 
    { -800, 0, 0 },
    { 800, 1200, 0 },
    ARRAY_COUNT(gFireTempleLargeBombableWallColVertices), gFireTempleLargeBombableWallColVertices,
    ARRAY_COUNT(gFireTempleLargeBombableWallColPolygons), gFireTempleLargeBombableWallColPolygons,
...
BgCamInfo gFireTempleHammerableTotemColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gFireTempleHammerableTotemCol = { 
    { -300, 0, -300 },
    { 300, 600, 300 },
    ARRAY_COUNT(gFireTempleHammerableTotemColVertices), gFireTempleHammerableTotemColVertices,
    ARRAY_COUNT(gFireTempleHammerableTotemColPolygons), gFireTempleHammerableTotemColPolygons,
...
BgCamInfo gFireTempleStoneStep2ColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gFireTempleStoneStep2Col = { 
    { -1000, -1000, -800 },
    { 1000, 0, 800 },
    ARRAY_COUNT(gFireTempleStoneStep2ColVertices), gFireTempleStoneStep2ColVertices,
    ARRAY_COUNT(gFireTempleStoneStep2ColPolygons), gFireTempleStoneStep2ColPolygons,
...
BgCamInfo gFireTempleStoneStep1ColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gFireTempleStoneStep1Col = { 
    { -200, -1000, -200 },
    { 200, 0, 200 },
    ARRAY_COUNT(gFireTempleStoneStep1ColVertices), gFireTempleStoneStep1ColVertices,
    ARRAY_COUNT(gFireTempleStoneStep1ColPolygons), gFireTempleStoneStep1ColPolygons,
    gFireTempleStoneStep1ColSurfaceType,
    gFireTempleStoneStep1ColCamDataList,
    0, NULL
};

BgCamInfo gFireTempleStoneBlock2ColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gFireTempleStoneBlock2Col = { 
    { -800, 0, -800 },
    { 800, 1000, 800 },
    ARRAY_COUNT(gFireTempleStoneBlock2ColVertices), gFireTempleStoneBlock2ColVertices,
    ARRAY_COUNT(gFireTempleStoneBlock2ColPolygons), gFireTempleStoneBlock2ColPolygons,
...
BgCamInfo gFireTempleHookshotElevatorColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gFireTempleHookshotElevatorCol = { 
    { -600, 0, -600 },
    { 600, 600, 600 },
    ARRAY_COUNT(gFireTempleHookshotElevatorColVertices), gFireTempleHookshotElevatorColVertices,
    ARRAY_COUNT(gFireTempleHookshotElevatorColPolygons), gFireTempleHookshotElevatorColPolygons,
...
BgCamInfo gFireTempleMetalFenceWithSlantColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gFireTempleMetalFenceWithSlantCol = { 
    { -720, 0, -40 },
    { 720, 1040, 40 },
    ARRAY_COUNT(gFireTempleMetalFenceWithSlantColVertices), gFireTempleMetalFenceWithSlantColVertices,
    ARRAY_COUNT(gFireTempleMetalFenceWithSlantColPolygons), gFireTempleMetalFenceWithSlantColPolygons,
...
BgCamInfo gFireTempleMetalFenceColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gFireTempleMetalFenceCol = { 
    { -800, 0, -40 },
    { 800, 1200, 40 },
    ARRAY_COUNT(gFireTempleMetalFenceColVertices), gFireTempleMetalFenceColVertices,
    ARRAY_COUNT(gFireTempleMetalFenceColPolygons), gFireTempleMetalFenceColPolygons,
...
BgCamInfo gFireTempleMetalFence2ColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gFireTempleMetalFence2Col = { 
    { -800, 0, -40 },
    { 800, 1200, 40 },
    ARRAY_COUNT(gFireTempleMetalFence2ColVertices), gFireTempleMetalFence2ColVertices,
    ARRAY_COUNT(gFireTempleMetalFence2ColPolygons), gFireTempleMetalFence2ColPolygons,
...
BgCamInfo gFireTempleFlareDancerPlatformColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gFireTempleFlareDancerPlatformCol = { 
    { -800, 0, -800 },
    { 800, 800, 800 },
    ARRAY_COUNT(gFireTempleFlareDancerPlatformColVertices), gFireTempleFlareDancerPlatformColVertices,
    ARRAY_COUNT(gFireTempleFlareDancerPlatformColPolygons), gFireTempleFlareDancerPlatformColPolygons,
...
Gfx gFireTempleDoorWithHandleRightDL[] = {
...
Gfx gFireTempleDoorWithHandleLeftDL[] = {
    gsSPDisplayList(gFireTempleBombableDoorFrameDL),
...
BgCamInfo gFireTempleStonePlatform2ColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gFireTempleStonePlatform2Col = { 
    { -800, 0, -800 },
    { 800, 1000, 800 },
    ARRAY_COUNT(gFireTempleStonePlatform2ColVertices), gFireTempleStonePlatform2ColVertices,
    ARRAY_COUNT(gFireTempleStonePlatform2ColPolygons), gFireTempleStonePlatform2ColPolygons,
...
BgCamInfo gFireTempleStonePlatform1ColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gFireTempleStonePlatform1Col = { 
    { -800, 1, -800 },
    { 800, 1001, 800 },
    ARRAY_COUNT(gFireTempleStonePlatform1ColVertices), gFireTempleStonePlatform1ColVertices,
    ARRAY_COUNT(gFireTempleStonePlatform1ColPolygons), gFireTempleStonePlatform1ColPolygons,
