...
BgCamInfo gCarpetMerchantColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gCarpetMerchantCol = { 
    { -5500, 0, -5500 },
    { 5500, 0, 5500 },
    ARRAY_COUNT(gCarpetMerchantColVertices), gCarpetMerchantColVertices,
    ARRAY_COUNT(gCarpetMerchantColPolygons), gCarpetMerchantColPolygons,
