...
BgCamInfo gBotwCoffinLidColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gBotwCoffinLidCol = { 
    { -500, 0, 0 },
    { 0, 100, 1200 },
    ARRAY_COUNT(gBotwCoffinLidColVertices), gBotwCoffinLidColVertices,
    ARRAY_COUNT(gBotwCoffinLidColPolygons), gBotwCoffinLidColPolygons,
...
BgCamInfo gBotwBombSpotColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gBotwBombSpotCol = { 
    { -605, -240, -829 },
    { 995, 360, 871 },
    ARRAY_COUNT(gBotwBombSpotColVertices), gBotwBombSpotColVertices,
    ARRAY_COUNT(gBotwBombSpotColPolygons), gBotwBombSpotColPolygons,
...
BgCamInfo gBotw1ColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gBotw1Col = { 
    { -9600, 0, -8200 },
    { 6800, 2000, 11800 },
    ARRAY_COUNT(gBotw1ColVertices), gBotw1ColVertices,
    ARRAY_COUNT(gBotw1ColPolygons), gBotw1ColPolygons,
...
BgCamInfo gBotw2ColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gBotw2Col = { 
    { -1800, 0, -2000 },
    { 1600, 0, 2000 },
    ARRAY_COUNT(gBotw2ColVertices), gBotw2ColVertices,
    ARRAY_COUNT(gBotw2ColPolygons), gBotw2ColPolygons,
