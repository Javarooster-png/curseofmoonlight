...
BgCamInfo gGTGRotatingRingPlatformColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gGTGRotatingRingPlatformCol = { 
    { -6240, -800, -6240 },
    { 6240, 800, 6240 },
    ARRAY_COUNT(gGTGRotatingRingPlatformColVertices), gGTGRotatingRingPlatformColVertices,
    ARRAY_COUNT(gGTGRotatingRingPlatformColPolygons), gGTGRotatingRingPlatformColPolygons,
