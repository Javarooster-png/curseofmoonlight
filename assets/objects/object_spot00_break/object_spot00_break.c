...
BgCamInfo gBrokenDrawbridgeColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gBrokenDrawbridgeCol = { 
    { -248, -130, -79 },
    { 227, 437, 370 },
    ARRAY_COUNT(gBrokenDrawbridgeColVertices), gBrokenDrawbridgeColVertices,
    ARRAY_COUNT(gBrokenDrawbridgeColPolygons), gBrokenDrawbridgeColPolygons,
...
BgCamInfo gBarbedWireFenceColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gBarbedWireFenceCol = { 
    { -850, -20, -10 },
    { 850, 40, 10 },
    ARRAY_COUNT(gBarbedWireFenceColVertices), gBarbedWireFenceColVertices,
    ARRAY_COUNT(gBarbedWireFenceColPolygons), gBarbedWireFenceColPolygons,
