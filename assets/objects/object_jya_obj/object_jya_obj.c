...
BgCamInfo g1fliftColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader g1fliftCol = { 
    { -400, 0, -400 },
    { 400, 200, 400 },
    ARRAY_COUNT(g1fliftColVertices), g1fliftColVertices,
    ARRAY_COUNT(g1fliftColPolygons), g1fliftColPolygons,
...
BgCamInfo GMegamiColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader GMegamiCol = { 
    { -767, -1518, -758 },
    { 767, 131, 252 },
    ARRAY_COUNT(GMegamiColVertices), GMegamiColVertices,
    ARRAY_COUNT(GMegamiColPolygons), GMegamiColPolygons,
...
BgCamInfo gAmishutterColCamDataList[] = {
    { 0x0000, 0, NULL },
};

SurfaceType gAmishutterColSurfaceType[] = {
    {0x00000000, 0x000207C0},   {0x00000000, 0x000007C0},
};
...
CollisionHeader gAmishutterCol = { 
    { -506, 0, -100 },
    { 506, 1000, 100 },
    ARRAY_COUNT(gAmishutterColVertices), gAmishutterColVertices,
    ARRAY_COUNT(gAmishutterColPolygons), gAmishutterColPolygons,
...
CollisionHeader gLiftCol = { 
    { -1200, -800, -1200 },
    { 1200, 9300, 1200 },
    ARRAY_COUNT(gLiftColVertices), gLiftColVertices,
    ARRAY_COUNT(gLiftColPolygons), gLiftColPolygons,
    gLiftColSurfaceType,
    gLiftColCamDataList,
    0, NULL
};
...
BgCamInfo gBombiwaColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gBombiwaCol = { 
    { -600, 0, 0 },
    { 600, 1400, 300 },
    ARRAY_COUNT(gBombiwaColVertices), gBombiwaColVertices,
    ARRAY_COUNT(gBombiwaColPolygons), gBombiwaColPolygons,
...
BgCamInfo gKanaamiColCamDataList[] = {
    { 0x0000, 0, NULL },
};

SurfaceType gKanaamiColSurfaceType[] = {
    {0x00000000, 0x000007C2},   {0x00800000, 0x000007C2},
};
...
CollisionHeader gKanaamiCol = { 
    { -400, 0, 0 },
    { 400, 2400, 100 },
    ARRAY_COUNT(gKanaamiColVertices), gKanaamiColVertices,
    ARRAY_COUNT(gKanaamiColPolygons), gKanaamiColPolygons,
...
BgCamInfo gCobraColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gCobraCol = { 
    { -542, 0, -249 },
    { 537, 1159, 302 },
    ARRAY_COUNT(gCobraColVertices), gCobraColVertices,
    ARRAY_COUNT(gCobraColPolygons), gCobraColPolygons,
...
BgCamInfo gZurerukabeColCamDataList[] = {
    { 0x0000, 0, NULL },
};

SurfaceType gZurerukabeColSurfaceType[] = {
    {0x00800000, 0x000007C0},   {0x00000000, 0x000007C0},
};
...
CollisionHeader gZurerukabeCol = { 
    { -5000, 0, 0 },
    { 5000, 1000, 0 },
    ARRAY_COUNT(gZurerukabeColVertices), gZurerukabeColVertices,
    ARRAY_COUNT(gZurerukabeColPolygons), gZurerukabeColPolygons,
