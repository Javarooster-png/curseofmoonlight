...
BgCamInfo gLonLonMilkCrateColCamDataList[] = {
    { 0x0000, 0, NULL },
};

SurfaceType gLonLonMilkCrateColSurfaceType[] = {
    {0x00E00000, 0x000007CA},   {0x00000000, 0x000007CA},
};
...
CollisionHeader gLonLonMilkCrateCol = { 
    { -300, 0, -300 },
    { 300, 600, 300 },
    ARRAY_COUNT(gLonLonMilkCrateColVertices), gLonLonMilkCrateColVertices,
    ARRAY_COUNT(gLonLonMilkCrateColPolygons), gLonLonMilkCrateColPolygons,
...
BgCamInfo gLonLonCorralFenceColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gLonLonCorralFenceCol = { 
    { -1200, 0, -100 },
    { 1200, 1800, 100 },
    ARRAY_COUNT(gLonLonCorralFenceColVertices), gLonLonCorralFenceColVertices,
    ARRAY_COUNT(gLonLonCorralFenceColPolygons), gLonLonCorralFenceColPolygons,
