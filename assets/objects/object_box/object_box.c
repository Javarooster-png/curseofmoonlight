...
CurveInterpKnot object_boxCurveAnime_CurveInterpKnot_00495C[] = {
...
CurveAnimationHeader gTreasureChestCurveAnim_4B60 = { 
    ...
    object_boxCurveAnime_CurveInterpKnot_00495C,
...
CurveInterpKnot object_boxCurveAnime_CurveInterpKnot_004CDC[] = {
    { 0x000C, 0x0001, 0, 0, 1.200000f },
...
CurveAnimationHeader gTreasureChestCurveAnim_4F70 = { 
    ...
    object_boxCurveAnime_CurveInterpKnot_004CDC,
...
BgCamInfo gTreasureChestColCamDataList[] = {
    { 0x0000, 0, NULL },
};

SurfaceType gTreasureChestColSurfaceType[] = {
    {0x00000000, 0x000207CA},   {0x00200000, 0x000207CA},
};
...
CollisionHeader gTreasureChestCol = { 
    { -2525, 2, -1942 },
    { 2525, 4475, 1962 },
    ARRAY_COUNT(gTreasureChestColVertices), gTreasureChestColVertices,
    ARRAY_COUNT(gTreasureChestColPolygons), gTreasureChestColPolygons,
