...
BgCamInfo gCraterBombableWallColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gCraterBombableWallCol = { 
    { -927, -9, -77 },
    { 944, 1600, 66 },
    ARRAY_COUNT(gCraterBombableWallColVertices), gCraterBombableWallColVertices,
    ARRAY_COUNT(gCraterBombableWallColPolygons), gCraterBombableWallColPolygons,
