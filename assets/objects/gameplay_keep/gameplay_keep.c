...
CollisionHeader gLargerCubeCol = { 
    { -4000, 0, -4000 },
    { 4000, 8000, 4000 },
    ARRAY_COUNT(gLargerCubeColVertices), gLargerCubeColVertices,
    ARRAY_COUNT(gLargerCubeColPolygons), gLargerCubeColPolygons,
...
CollisionHeader gWideTallBlockCol = { 
    { -3000, 0, -6000 },
    { 3000, 12000, 6000 },
    ARRAY_COUNT(gWideTallBlockColVertices), gWideTallBlockColVertices,
    ARRAY_COUNT(gWideTallBlockColPolygons), gWideTallBlockColPolygons,
...
CollisionHeader gTallBlockCol = { 
    { -300, 0, -600 },
    { 300, 2400, 600 },
    ARRAY_COUNT(gTallBlockColVertices), gTallBlockColVertices,
    ARRAY_COUNT(gTallBlockColPolygons), gTallBlockColPolygons,
...
CollisionHeader gSmallerFlatBlockCol = { 
    { -2000, -1200, -4000 },
    { 2000, 1200, 4000 },
    ARRAY_COUNT(gSmallerFlatBlockColVertices), gSmallerFlatBlockColVertices,
    ARRAY_COUNT(gSmallerFlatBlockColPolygons), gSmallerFlatBlockColPolygons,
...
BgCamInfo gLargerFlatBlockColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gLargerFlatBlockCol = { 
    { -3000, -1800, -7000 },
    { 3000, 1800, 7000 },
    ARRAY_COUNT(gLargerFlatBlockColVertices), gLargerFlatBlockColVertices,
    ARRAY_COUNT(gLargerFlatBlockColPolygons), gLargerFlatBlockColPolygons,
...
CollisionHeader gSmallerCubeCol = { 
    { -300, 0, -300 },
    { 300, 600, 300 },
    ARRAY_COUNT(gSmallerCubeColVertices), gSmallerCubeColVertices,
    ARRAY_COUNT(gSmallerCubeColPolygons), gSmallerCubeColPolygons,
...
#include "gDoorRightDL.c"

#include "gDoorLeftDL.c"

/* #include "gLinkAdultLeftHandNearDL_mesh.c"

#include "gLinkAdultLeftHandClosedNearDL_mesh.c"
 */
#include "gWhiskeyDL.c"
