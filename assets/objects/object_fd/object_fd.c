...
BgCamInfo gVolvagiaPlatformColCamDataList[] = {
    { 0x0000, 0, NULL },
};

SurfaceType gVolvagiaPlatformColSurfaceType[] = {
    {0x00000000, 0x000007C2},   {0x00000000, 0x000007C0},
};
...
CollisionHeader gVolvagiaPlatformCol = { 
    { -800, 0, -800 },
    { 800, 2000, 800 },
    ARRAY_COUNT(gVolvagiaPlatformColVertices), gVolvagiaPlatformColVertices,
    ARRAY_COUNT(gVolvagiaPlatformColPolygons), gVolvagiaPlatformColPolygons,
...
u64 gVolvagiaTitleCardTex[] = {
#include "assets/objects/object_fd/volvagia_title_card.ia8.inc.c"
};
