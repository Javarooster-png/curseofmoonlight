...
BgCamInfo gBgBombwallColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gBgBombwallCol = { 
    { -700, -40, 0 },
    { 700, 1760, 300 },
    ARRAY_COUNT(gBgBombwallColVertices), gBgBombwallColVertices,
    ARRAY_COUNT(gBgBombwallColPolygons), gBgBombwallColPolygons,
