...
BgCamInfo gJabuElevatorColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gJabuElevatorCol = { 
    { -600, -1200, -600 },
    { 600, 0, 600 },
    ARRAY_COUNT(gJabuElevatorColVertices), gJabuElevatorColVertices,
    ARRAY_COUNT(gJabuElevatorColPolygons), gJabuElevatorColPolygons,
...
BgCamInfo gJabuLoweringPlatformColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gJabuLoweringPlatformCol = { 
    { -849, -2800, -1803 },
    { 1797, 0, 1460 },
    ARRAY_COUNT(gJabuLoweringPlatformColVertices), gJabuLoweringPlatformColVertices,
    ARRAY_COUNT(gJabuLoweringPlatformColPolygons), gJabuLoweringPlatformColPolygons,
...
BgCamInfo gJabuFloorSwitchColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gJabuFloorSwitchCol = { 
    { -320, -5, -320 },
    { 320, 200, 320 },
    ARRAY_COUNT(gJabuFloorSwitchColVertices), gJabuFloorSwitchColVertices,
    ARRAY_COUNT(gJabuFloorSwitchColPolygons), gJabuFloorSwitchColPolygons,
...
BgCamInfo gJabuBigOctoPlatformColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gJabuBigOctoPlatformCol = { 
    { -1840, -2000, -1840 },
    { 1840, 1400, 1842 },
    ARRAY_COUNT(gJabuBigOctoPlatformColVertices), gJabuBigOctoPlatformColVertices,
    ARRAY_COUNT(gJabuBigOctoPlatformColPolygons), gJabuBigOctoPlatformColPolygons,
