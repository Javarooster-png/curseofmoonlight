...
BgCamInfo object_spot01_matoyab_colCamDataList[] = {
    { 0x0000, 0, NULL },
};

SurfaceType object_spot01_matoyab_colSurfaceType[] = {
    {0x00000000, 0x000007CA},   {0x00000000, 0x000007C2},
};
...
CollisionHeader object_spot01_matoyab_col = { 
    { -2000, 0, -2400 },
    { 2000, 1400, 2000 },
    ARRAY_COUNT(object_spot01_matoyab_colVertices), object_spot01_matoyab_colVertices,
    ARRAY_COUNT(object_spot01_matoyab_colPolygons), object_spot01_matoyab_colPolygons,
...
CollisionHeader gKakarikoGuardGateCol = { 
    { -100, 0, 0 },
    { 100, 120, 0 },
    ARRAY_COUNT(gKakarikoGuardGateColVertices), gKakarikoGuardGateColVertices,
    ARRAY_COUNT(gKakarikoGuardGateColPolygons), gKakarikoGuardGateColPolygons,
