...
BgCamInfo object_bwall_Col_000118CamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader object_bwall_Col_000118 = { 
    { -1000, -100, 0 },
    { 1000, 2000, 0 },
    ARRAY_COUNT(object_bwall_Col_000118Vertices), object_bwall_Col_000118Vertices,
    ARRAY_COUNT(object_bwall_Col_000118Polygons), object_bwall_Col_000118Polygons,
