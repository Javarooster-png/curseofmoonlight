...
BgCamInfo gGerudoCellDoorColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gGerudoCellDoorCol = { 
    { -33, 0, -10 },
    { 33, 110, 10 },
    ARRAY_COUNT(gGerudoCellDoorColVertices), gGerudoCellDoorColVertices,
    ARRAY_COUNT(gGerudoCellDoorColPolygons), gGerudoCellDoorColPolygons,
