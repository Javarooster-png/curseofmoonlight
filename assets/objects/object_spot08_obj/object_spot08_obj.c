...
SurfaceType gZorasFountainIceRampColSurfaceType[] = {
    {0x0000A000, 0x000007CC},   {0x00000000, 0x000007CC},
};
...
CollisionHeader gZorasFountainIceRampCol = { 
    { -3200, -3378, -2527 },
    { 3921, 1422, 2000 },
    ARRAY_COUNT(gZorasFountainIceRampColVertices), gZorasFountainIceRampColVertices,
    ARRAY_COUNT(gZorasFountainIceRampColPolygons), gZorasFountainIceRampColPolygons,
...
BgCamInfo gZorasFountainIcebergColCamDataList[] = {
    { 0x0000, 0, NULL },
};

SurfaceType gZorasFountainIcebergColSurfaceType[] = {
    {0x00000000, 0x000007CC},   {0x0000A000, 0x000007CC},
};
...
CollisionHeader gZorasFountainIcebergCol = { 
    { -1473, -1985, -1696 },
    { 1473, 150, 1696 },
    ARRAY_COUNT(gZorasFountainIcebergColVertices), gZorasFountainIcebergColVertices,
    ARRAY_COUNT(gZorasFountainIcebergColPolygons), gZorasFountainIcebergColPolygons,
...
BgCamInfo gZorasFountainBombableWallColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gZorasFountainBombableWallCol = { 
    { -229, 0, -23 },
    { 229, 233, 51 },
    ARRAY_COUNT(gZorasFountainBombableWallColVertices), gZorasFountainBombableWallColVertices,
    ARRAY_COUNT(gZorasFountainBombableWallColPolygons), gZorasFountainBombableWallColPolygons,
