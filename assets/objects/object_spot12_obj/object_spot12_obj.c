...
BgCamInfo gGerudoFortressWastelandGateColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gGerudoFortressWastelandGateCol = { 
    { -1796, -100, -179 },
    { 1796, 2656, 21 },
    ARRAY_COUNT(gGerudoFortressWastelandGateColVertices), gGerudoFortressWastelandGateColVertices,
    ARRAY_COUNT(gGerudoFortressWastelandGateColPolygons), gGerudoFortressWastelandGateColPolygons,
...
BgCamInfo gGerudoFortressGTGShutterColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gGerudoFortressGTGShutterCol = { 
    { -840, -20, -114 },
    { 840, 1176, 100 },
    ARRAY_COUNT(gGerudoFortressGTGShutterColVertices), gGerudoFortressGTGShutterColVertices,
    ARRAY_COUNT(gGerudoFortressGTGShutterColPolygons), gGerudoFortressGTGShutterColPolygons,
