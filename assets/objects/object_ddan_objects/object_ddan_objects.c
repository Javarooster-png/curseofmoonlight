...
BgCamInfo gDodongoLowerJawColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gDodongoLowerJawCol = { 
    { -2703, -2068, -2142 },
    { 2703, 800, 4753 },
    ARRAY_COUNT(gDodongoLowerJawColVertices), gDodongoLowerJawColVertices,
    ARRAY_COUNT(gDodongoLowerJawColPolygons), gDodongoLowerJawColPolygons,
...
BgCamInfo gDodongoRisingPlatformColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gDodongoRisingPlatformCol = { 
    { -600, -7600, -600 },
    { 600, 400, 600 },
    ARRAY_COUNT(gDodongoRisingPlatformColVertices), gDodongoRisingPlatformColVertices,
    ARRAY_COUNT(gDodongoRisingPlatformColPolygons), gDodongoRisingPlatformColPolygons,
...
BgCamInfo gDodongoFallingStairsColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gDodongoFallingStairsCol = { 
    { 0, -6400, -800 },
    { 5600, 0, 840 },
    ARRAY_COUNT(gDodongoFallingStairsColVertices), gDodongoFallingStairsColVertices,
    ARRAY_COUNT(gDodongoFallingStairsColPolygons), gDodongoFallingStairsColPolygons,
