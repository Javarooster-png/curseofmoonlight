...
s16 sTorchSlugEyestalkWaveAnimFrameData[] = {
...
JointIndex sTorchSlugEyestalkWaveAnimJointIndices[] = {
...
AnimationHeader gTorchSlugEyestalkWaveAnim = { 
    { 59 }, sTorchSlugEyestalkWaveAnimFrameData,
    sTorchSlugEyestalkWaveAnimJointIndices, 3
};
...
Gfx gTorchSlugLeftLowerEyestalkDL[] = {
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_NONE),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock(gTorchSlugEyestalkTex, G_IM_FMT_RGBA, G_IM_SIZ_16b, 16, 16, 0, G_TX_NOMIRROR | G_TX_WRAP,
...
Gfx gTorchSlugLeftUpperEyestalkDL[] = {
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_NONE),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock(gTorchSlugEyeTex, G_IM_FMT_RGBA, G_IM_SIZ_16b, 16, 16, 0, G_TX_MIRROR | G_TX_CLAMP, G_TX_MIRROR
...
Gfx gTorchSlugRightLowerEyestalkDL[] = {
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_NONE),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock(gTorchSlugEyestalkTex, G_IM_FMT_RGBA, G_IM_SIZ_16b, 16, 16, 0, G_TX_NOMIRROR | G_TX_WRAP,
...
Gfx gTorchSlugRightUpperEyestalkDL[] = {
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_NONE),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock(gTorchSlugEyeTex, G_IM_FMT_RGBA, G_IM_SIZ_16b, 16, 16, 0, G_TX_MIRROR | G_TX_CLAMP, G_TX_MIRROR
...
Gfx gTorchSlugBodyDL[] = {
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_RGBA16),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock(gTorchSlugBody2Tex, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_WRAP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsDPLoadMultiBlock(gTorchSlugBody1Tex, 0x0100, 1, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP,
                       G_TX_NOMIRROR | G_TX_WRAP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsDPLoadTLUT_pal256(gTorchSlugBodyTLUT),
...
u64 gTorchSlugEyestalkTex[] = {
#include "assets/objects/object_bw/torch_slug_eyestalk.rgba16.inc.c"
};

u64 gTorchSlugEyeTex[] = {
#include "assets/objects/object_bw/torch_slug_eye.rgba16.inc.c"
};

u64 gTorchSlugBodyTLUT[] = {
#include "assets/objects/object_bw/torch_slug_body_tlut.rgba16.inc.c"
};

u64 gTorchSlugBody1Tex[] = {
#include "assets/objects/object_bw/torch_slug_body_1.ci8.inc.c"
};

u64 gTorchSlugBody2Tex[] = {
#include "assets/objects/object_bw/torch_slug_body_2.ci8.inc.c"
};

StandardLimb gTorchSlugBodyLimb = { 
    { 0, 0, 0 }, 0x01, LIMB_DONE,
    gTorchSlugBodyDL
};

StandardLimb gTorchSlugLeftEyestalkRootRootLimb = { 
    { 300, 400, 1200 }, 0x02, 0x06,
    NULL
};

StandardLimb gTorchSlugLeftEyestalkRootLimb = { 
    { 0, 0, 0 }, 0x03, LIMB_DONE,
    NULL
};

StandardLimb gTorchSlugLeftUpperEyestalkRootLimb = { 
    { 700, 0, 0 }, 0x04, 0x05,
    NULL
};

StandardLimb gTorchSlugLeftUpperEyestalkLimb = { 
    { 0, 0, 0 }, LIMB_DONE, LIMB_DONE,
    gTorchSlugLeftUpperEyestalkDL
};

StandardLimb gTorchSlugLeftLowerEyestalkLimb = { 
    { 0, 0, 0 }, LIMB_DONE, LIMB_DONE,
    gTorchSlugLeftLowerEyestalkDL
};

StandardLimb gTorchSlugRightEyestalkRootRootLimb = { 
    { -300, 400, 1200 }, 0x07, LIMB_DONE,
    NULL
};

StandardLimb gTorchSlugRightEyestalkRootLimb = { 
    { 0, 0, 0 }, 0x08, LIMB_DONE,
    NULL
};

StandardLimb gTorchSlugRightUpperEyestalkRootLimb = { 
    { 700, 0, 0 }, 0x09, 0x0A,
    NULL
};

StandardLimb gTorchSlugRightUpperEyestalkLimb = { 
    { 0, 0, 0 }, LIMB_DONE, LIMB_DONE,
    gTorchSlugRightUpperEyestalkDL
};

StandardLimb gTorchSlugRightLowerEyestalkLimb = { 
    { 0, 0, 0 }, LIMB_DONE, LIMB_DONE,
    gTorchSlugRightLowerEyestalkDL
};

void* gTorchSlugSkelLimbs[] = {
    &gTorchSlugBodyLimb,
    &gTorchSlugLeftEyestalkRootRootLimb,
    &gTorchSlugLeftEyestalkRootLimb,
    &gTorchSlugLeftUpperEyestalkRootLimb,
    &gTorchSlugLeftUpperEyestalkLimb,
    &gTorchSlugLeftLowerEyestalkLimb,
    &gTorchSlugRightEyestalkRootRootLimb,
    &gTorchSlugRightEyestalkRootLimb,
    &gTorchSlugRightUpperEyestalkRootLimb,
    &gTorchSlugRightUpperEyestalkLimb,
    &gTorchSlugRightLowerEyestalkLimb,
};

SkeletonHeader gTorchSlugSkel = { 
    gTorchSlugSkelLimbs, ARRAY_COUNT(gTorchSlugSkelLimbs)
};
...
s16 sTorchSlugEyestalkRaiseAnimFrameData[] = {
...
JointIndex sTorchSlugEyestalkRaiseAnimJointIndices[] = {
    { 0x0000, 0x0000, 0x0000 },
    { 0x0000, 0x0000, 0x0000 },
    { 0x0000, 0x0001, 0x0000 },
...
AnimationHeader gTorchSlugEyestalkRaiseAnim = { 
    { 7 }, sTorchSlugEyestalkRaiseAnimFrameData,
    sTorchSlugEyestalkRaiseAnimJointIndices, 1
};

s16 sTorchSlugEyestalkFlailAnimFrameData[] = {
...
JointIndex sTorchSlugEyestalkFlailAnimJointIndices[] = {
    { 0x0000, 0x0000, 0x0000 },
    { 0x0000, 0x0000, 0x0000 },
    { 0x0000, 0x0001, 0x0000 },
    { 0x0000, 0x0000, 0x0008 },
...
AnimationHeader gTorchSlugEyestalkFlailAnim = { 
    { 7 }, sTorchSlugEyestalkFlailAnimFrameData,
    sTorchSlugEyestalkFlailAnimJointIndices, 1
};
