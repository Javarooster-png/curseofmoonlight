...
BgCamInfo gGoronCityVaseLidColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gGoronCityVaseLidCol = { 
    { -322, 2041, -279 },
    { 322, 2120, 279 },
    ARRAY_COUNT(gGoronCityVaseLidColVertices), gGoronCityVaseLidColVertices,
    ARRAY_COUNT(gGoronCityVaseLidColPolygons), gGoronCityVaseLidColPolygons,
...
BgCamInfo gGoronCityDoorColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gGoronCityDoorCol = { 
    { -613, 0, -165 },
    { 613, 1636, 0 },
    ARRAY_COUNT(gGoronCityDoorColVertices), gGoronCityDoorColVertices,
    ARRAY_COUNT(gGoronCityDoorColPolygons), gGoronCityDoorColPolygons,
...
BgCamInfo gGoronCityVaseColCamDataList[] = {
    { 0x0000, 0, NULL },
};

SurfaceType gGoronCityVaseColSurfaceType[] = {
    {0x00000000, 0x000007C0},   {0x30000000, 0x000007C0},
};
...
CollisionHeader gGoronCityVaseCol = { 
    { -1144, 0, -820 },
    { 1144, 2155, 1322 },
    ARRAY_COUNT(gGoronCityVaseColVertices), gGoronCityVaseColVertices,
    ARRAY_COUNT(gGoronCityVaseColPolygons), gGoronCityVaseColPolygons,
...
BgCamInfo gGoronCityStatueSpearColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gGoronCityStatueSpearCol = { 
    { 231, 0, 161 },
    { 431, 502, 1011 },
    ARRAY_COUNT(gGoronCityStatueSpearColVertices), gGoronCityStatueSpearColVertices,
    ARRAY_COUNT(gGoronCityStatueSpearColPolygons), gGoronCityStatueSpearColPolygons,
...
BgCamInfo gGoronCityStatueColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gGoronCityStatueCol = { 
    { -472, 0, -390 },
    { 475, 1631, 435 },
    ARRAY_COUNT(gGoronCityStatueColVertices), gGoronCityStatueColVertices,
    ARRAY_COUNT(gGoronCityStatueColPolygons), gGoronCityStatueColPolygons,
