...
BgCamInfo gTowerCollapseBarsColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gTowerCollapseBarsCol = { 
    { -70, -20, 0 },
    { 70, 180, 0 },
    ARRAY_COUNT(gTowerCollapseBarsColVertices), gTowerCollapseBarsColVertices,
    ARRAY_COUNT(gTowerCollapseBarsColPolygons), gTowerCollapseBarsColPolygons,
