...
BgCamInfo gHookshotTargetColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gHookshotTargetCol = { 
    { -200, -200, 0 },
    { 200, 200, 80 },
    ARRAY_COUNT(gHookshotTargetColVertices), gHookshotTargetColVertices,
    ARRAY_COUNT(gHookshotTargetColPolygons), gHookshotTargetColPolygons,
...
BgCamInfo gHookshotPostColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gHookshotPostCol = { 
    { -200, 0, -200 },
    { 200, 1000, 200 },
    ARRAY_COUNT(gHookshotPostColVertices), gHookshotPostColVertices,
    ARRAY_COUNT(gHookshotPostColPolygons), gHookshotPostColPolygons,
