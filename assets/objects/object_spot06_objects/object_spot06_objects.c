...
BgCamInfo gLakeHyliaWaterTempleGateColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gLakeHyliaWaterTempleGateCol = { 
    { -900, 0, 0 },
    { 900, 1800, 0 },
    ARRAY_COUNT(gLakeHyliaWaterTempleGateColVertices), gLakeHyliaWaterTempleGateColVertices,
    ARRAY_COUNT(gLakeHyliaWaterTempleGateColPolygons), gLakeHyliaWaterTempleGateColPolygons,
...
BgCamInfo gLakeHyliaZoraShortcutIceblockColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gLakeHyliaZoraShortcutIceblockCol = { 
    { -300, 0, 0 },
    { 300, 723, 0 },
    ARRAY_COUNT(gLakeHyliaZoraShortcutIceblockColVertices), gLakeHyliaZoraShortcutIceblockColVertices,
    ARRAY_COUNT(gLakeHyliaZoraShortcutIceblockColPolygons), gLakeHyliaZoraShortcutIceblockColPolygons,
