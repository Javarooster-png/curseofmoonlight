...
BgCamInfo gGanonsCastleRubbleAroundArenaColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gGanonsCastleRubbleAroundArenaCol = { 
    { -9010, -208, -9183 },
    { 8317, 3423, 10400 },
    ARRAY_COUNT(gGanonsCastleRubbleAroundArenaColVertices), gGanonsCastleRubbleAroundArenaColVertices,
    ARRAY_COUNT(gGanonsCastleRubbleAroundArenaColPolygons), gGanonsCastleRubbleAroundArenaColPolygons,
...
BgCamInfo gGanonsCastleRubble2ColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gGanonsCastleRubble2Col = { 
    { -440, -222, -961 },
    { 1350, 1333, 831 },
    ARRAY_COUNT(gGanonsCastleRubble2ColVertices), gGanonsCastleRubble2ColVertices,
    ARRAY_COUNT(gGanonsCastleRubble2ColPolygons), gGanonsCastleRubble2ColPolygons,
...
BgCamInfo gGanonsCastleRubble3ColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gGanonsCastleRubble3Col = { 
    { -1051, 0, -236 },
    { 852, 1829, 236 },
    ARRAY_COUNT(gGanonsCastleRubble3ColVertices), gGanonsCastleRubble3ColVertices,
    ARRAY_COUNT(gGanonsCastleRubble3ColPolygons), gGanonsCastleRubble3ColPolygons,
...
BgCamInfo gGanonsCastleRubble4ColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gGanonsCastleRubble4Col = { 
    { -451, -287, -1532 },
    { 2065, 968, 787 },
    ARRAY_COUNT(gGanonsCastleRubble4ColVertices), gGanonsCastleRubble4ColVertices,
    ARRAY_COUNT(gGanonsCastleRubble4ColPolygons), gGanonsCastleRubble4ColPolygons,
...
BgCamInfo gGanonsCastleRubble5ColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gGanonsCastleRubble5Col = { 
    { -971, 0, -578 },
    { 788, 1749, 501 },
    ARRAY_COUNT(gGanonsCastleRubble5ColVertices), gGanonsCastleRubble5ColVertices,
    ARRAY_COUNT(gGanonsCastleRubble5ColPolygons), gGanonsCastleRubble5ColPolygons,
...
BgCamInfo gGanonsCastleRubble6ColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gGanonsCastleRubble6Col = { 
    { -2654, -327, -2173 },
    { 475, 1050, 778 },
    ARRAY_COUNT(gGanonsCastleRubble6ColVertices), gGanonsCastleRubble6ColVertices,
    ARRAY_COUNT(gGanonsCastleRubble6ColPolygons), gGanonsCastleRubble6ColPolygons,
...
BgCamInfo gGanonsCastleRubble7ColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gGanonsCastleRubble7Col = { 
    { -700, -57, -1962 },
    { 287, 2316, 329 },
    ARRAY_COUNT(gGanonsCastleRubble7ColVertices), gGanonsCastleRubble7ColVertices,
    ARRAY_COUNT(gGanonsCastleRubble7ColPolygons), gGanonsCastleRubble7ColPolygons,
...
BgCamInfo gGanonsCastleRubbleTallColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gGanonsCastleRubbleTallCol = { 
    { -499, -25, -309 },
    { 470, 3692, 464 },
    ARRAY_COUNT(gGanonsCastleRubbleTallColVertices), gGanonsCastleRubbleTallColVertices,
    ARRAY_COUNT(gGanonsCastleRubbleTallColPolygons), gGanonsCastleRubbleTallColPolygons,
