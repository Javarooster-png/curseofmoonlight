...
BgCamInfo gBlockSmallColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gBlockSmallCol = { 
    { -3999, 0, -4000 },
    { 4000, 4000, 3999 },
    ARRAY_COUNT(gBlockSmallColVertices), gBlockSmallColVertices,
    ARRAY_COUNT(gBlockSmallColPolygons), gBlockSmallColPolygons,
...
BgCamInfo gBlockMediumColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gBlockMediumCol = { 
    { -3999, 0, -4000 },
    { 4000, 8000, 3999 },
    ARRAY_COUNT(gBlockMediumColVertices), gBlockMediumColVertices,
    ARRAY_COUNT(gBlockMediumColPolygons), gBlockMediumColPolygons,
...
BgCamInfo gBlockTallColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gBlockTallCol = { 
    { -3999, 0, -4000 },
    { 4000, 12000, 3999 },
    ARRAY_COUNT(gBlockTallColVertices), gBlockTallColVertices,
    ARRAY_COUNT(gBlockTallColPolygons), gBlockTallColPolygons,
...
BgCamInfo gBlockTallestColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gBlockTallestCol = { 
    { -3999, 0, -4000 },
    { 4000, 16000, 3999 },
    ARRAY_COUNT(gBlockTallestColVertices), gBlockTallestColVertices,
    ARRAY_COUNT(gBlockTallestColPolygons), gBlockTallestColPolygons,
