...
BgCamInfo object_spot05_objects_Col_000918CamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader object_spot05_objects_Col_000918 = { 
    { -1200, 0, -1200 },
    { 1200, 0, 1200 },
    ARRAY_COUNT(object_spot05_objects_Col_000918Vertices), object_spot05_objects_Col_000918Vertices,
    ARRAY_COUNT(object_spot05_objects_Col_000918Polygons), object_spot05_objects_Col_000918Polygons,
...
BgCamInfo object_spot05_objects_Col_0012C0CamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader object_spot05_objects_Col_0012C0 = { 
    { -1000, 0, -100 },
    { 1000, 1200, 100 },
    ARRAY_COUNT(object_spot05_objects_Col_0012C0Vertices), object_spot05_objects_Col_0012C0Vertices,
    ARRAY_COUNT(object_spot05_objects_Col_0012C0Polygons), object_spot05_objects_Col_0012C0Polygons,
