...
u64 gDogFurLink2Tex[] = {
#include "assets/objects/object_link_boy/fur_2_link.rgba16.inc.c"
};

u64 gDogFurLink3Tex[] = {
#include "assets/objects/object_link_boy/fur_3_link.rgba16.inc.c"
};

u64 gDogFurLink4Tex[] = {
#include "assets/objects/object_link_boy/fur_4_link.rgba16.inc.c"
};

u64 gDogFaceEyeLinkTex[] = {
#include "assets/objects/object_link_boy/face_and_eye_link.rgba16.inc.c"
};

u64 gDogFaceNoseLinkTex[] = {
#include "assets/objects/object_link_boy/face_and_nose_link.rgba16.inc.c"
};

Vtx object_dog_linkVtx_004D80[] = {
#include "assets/objects/object_link_boy/object_dog_linkVtx_004D80.vtx.inc"
};
...
Gfx gDogHeadLinkDL[] = {
    ...
    gsSPSetGeometryMode(G_FOG | G_LIGHTING),
    gsSPClearGeometryMode(G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
    gsSPVertex(object_dog_linkVtx_004D80, 9, 0),
    gsSPMatrix(0x0D0001C0, G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPPipeSync(),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
    gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
    gsDPSetTextureLUT(G_TT_NONE),
    gsDPLoadTextureBlock(gDogFurLink3Tex, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 32, 0, G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMIRROR
                         | G_TX_CLAMP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetTileSize(G_TX_RENDERTILE, 0, 0, 0x007C, 0x007C),
    gsDPSetPrimColor(0, 0x80, 255, 255, 255, 255),
    gsSPSetGeometryMode(G_CULL_BACK),
    gsSPVertex(&object_dog_linkVtx_004D80[9], 15, 9),
    gsSP2Triangles(7, 5, 9, 0, 7, 10, 11, 0),
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_NONE),
    gsDPLoadTextureBlock(gDogFurLink4Tex, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 32, 0, G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMIRROR
                         | G_TX_CLAMP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetTileSize(G_TX_RENDERTILE, 0, 0, 0x007C, 0x007C),
    ...
    gsDPLoadTextureBlock(gDogFurLink3Tex, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 32, 0, G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMIRROR
                         | G_TX_CLAMP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetTileSize(G_TX_RENDERTILE, 0, 0, 0x007C, 0x007C),
    gsSPVertex(&object_dog_linkVtx_004D80[24], 25, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 2, 4, 0),
    ...
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_NONE),
    gsDPLoadTextureBlock(gDogFurLink2Tex, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 32, 0, G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMIRROR
                         | G_TX_CLAMP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetTileSize(G_TX_RENDERTILE, 0, 0, 0x007C, 0x007C),
    gsSP2Triangles(13, 14, 15, 0, 16, 17, 18, 0),
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_NONE),
    gsDPLoadTextureBlock(gDogFaceEyeLinkTex, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 32, 0, G_TX_NOMIRROR | G_TX_CLAMP,
                         G_TX_NOMIRROR | G_TX_CLAMP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetTileSize(G_TX_RENDERTILE, 0, 0, 0x007C, 0x007C),
    ...
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_NONE),
    gsDPLoadTextureBlock(gDogFaceNoseLinkTex, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 32, 0, G_TX_NOMIRROR | G_TX_CLAMP,
                         G_TX_NOMIRROR | G_TX_CLAMP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetTileSize(G_TX_RENDERTILE, 0, 0, 0x007C, 0x007C),
    gsSPVertex(&object_dog_linkVtx_004D80[49], 31, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
...
#include "gLinkAdultLeftHandHoldingMasterSwordNearDL_mesh.c"

#include "gLinkAdultRightHandNearDL_mesh.c"

#include "gLinkAdultRightHandClosedNearDL_mesh.c"

#include "gLinkAdultRightHandHoldingHylianShieldNearDL_mesh.c"

#include "gLinkAdultRightArmOutNearDL_mesh.c"

#include "gLinkAdultRightHandOutNearDL_mesh.c"

#include "gLinkAdultRightHandHoldingBowNearDL_mesh.c"

#include "gLinkAdultRightHandHoldingHookshotNearDL_mesh.c"

#include "gLinkAdultLeftHandHoldingBgsNearDL.c"

#include "gLinkAdultMasterSwordAndSheathNearDL.c"

#include "gLinkAdultHylianShieldSwordAndSheathNearDL.c"

#include "gLinkAdultHylianShieldAndSheathNearDL.c"
