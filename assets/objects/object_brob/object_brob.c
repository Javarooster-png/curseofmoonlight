...
JointIndex sBrobStunnedAnimJointIndices[] = {
...
AnimationHeader gBrobStunnedAnim = { 
    { 33 }, sBrobStunnedAnimFrameData,
    sBrobStunnedAnimJointIndices, 1
};
...
Gfx gBrobBaseSegmentDL[] = {
    ...
    gsDPLoadTextureBlock(gBrobFleshTex, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 32, 0, G_TX_NOMIRROR | G_TX_CLAMP,
...
u64 gBrobFleshTex[] = {
#include "assets/objects/object_brob/flesh.rgba16.inc.c"
};

StandardLimb gBrobRootLimb = { 
    { 0, 0, 0 }, 0x01, LIMB_DONE,
    NULL
};

StandardLimb gBrobBaseSegmentRootLimb = { 
    { 0, -12000, 0 }, 0x02, LIMB_DONE,
    NULL
};

StandardLimb gBrobBaseSegmentLimb = { 
    { 0, 0, 0 }, 0x03, LIMB_DONE,
    gBrobBaseSegmentDL
};

StandardLimb gBrobLowerSegmentRootLimb = { 
    { 6000, 0, 0 }, 0x04, LIMB_DONE,
    NULL
};

StandardLimb gBrobLowerSegmentLimb = { 
    { 0, 0, 0 }, LIMB_DONE, 0x05,
    gBrobLowerSegmentDL
};

StandardLimb gBrobMiddleSegmentLimb = { 
    { 6000, 0, 0 }, 0x06, LIMB_DONE,
    gBrobMiddleSegmentDL
};

StandardLimb gBrobUpperSegmentRootLimb = { 
    { 6000, 0, 0 }, 0x07, LIMB_DONE,
    NULL
};

StandardLimb gBrobUpperSegmentLimb = { 
    { 0, 0, 0 }, LIMB_DONE, 0x08,
    gBrobUpperSegmentDL
};

StandardLimb gBrobTopSegmentLimb = { 
...
void* gBrobSkelLimbs[] = {
    &gBrobRootLimb,
    &gBrobBaseSegmentRootLimb,
    &gBrobBaseSegmentLimb,
    &gBrobLowerSegmentRootLimb,
    &gBrobLowerSegmentLimb,
    &gBrobMiddleSegmentLimb,
    &gBrobUpperSegmentRootLimb,
    &gBrobUpperSegmentLimb,
    &gBrobTopSegmentLimb,
};

FlexSkeletonHeader gBrobSkel = { 
    { gBrobSkelLimbs, ARRAY_COUNT(gBrobSkelLimbs) }, 5
};
...
JointIndex sBrobShockAnimJointIndices[] = {
    { 0x0000, 0x0000, 0x0000 },
    { 0x0000, 0x0000, 0x0000 },
    { 0x0000, 0x0000, 0x0000 },
    { 0x0000, 0x0000, 0x0001 },
...
AnimationHeader gBrobShockAnim = { 
    { 4 }, sBrobShockAnimFrameData,
    sBrobShockAnimJointIndices, 1
};
...
JointIndex sBrobMoveUpAnimJointIndices[] = {
    { 0x0000, 0x0000, 0x0000 },
    { 0x0000, 0x0000, 0x0000 },
    { 0x0000, 0x0000, 0x0000 },
    { 0x0000, 0x0000, 0x0001 },
...
AnimationHeader gBrobMoveUpAnim = { 
    { 16 }, sBrobMoveUpAnimFrameData,
    sBrobMoveUpAnimJointIndices, 2
};

s16 sBrobWobbleAnimFrameData[] = {
...
JointIndex sBrobWobbleAnimJointIndices[] = {
    { 0x0000, 0x0000, 0x0000 },
    { 0x0000, 0x0000, 0x0000 },
    { 0x0000, 0x0000, 0x0000 },
    { 0x0000, 0x0000, 0x0001 },
...
AnimationHeader gBrobWobbleAnim = { 
    { 20 }, sBrobWobbleAnimFrameData,
    sBrobWobbleAnimJointIndices, 1
};
...
BgCamInfo gBrobColCamDataList[] = {
    { 0x0000, 0, NULL },
};

SurfaceType gBrobColSurfaceType[] = {
    {0x00000000, 0x000007C3},
};

CollisionPoly gBrobColPolygons[] = {
...
CollisionHeader gBrobCol = { 
    { -600, 0, -600 },
    { 600, 1200, 600 },
    ARRAY_COUNT(gBrobColVertices), gBrobColVertices,
    ARRAY_COUNT(gBrobColPolygons), gBrobColPolygons,
    gBrobColSurfaceType,
    gBrobColCamDataList,
    0, NULL
};
