...
BgCamInfo gDekuTreeMouthColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gDekuTreeMouthCol = { 
    { -170, -286, -189 },
    { 172, 129, 176 },
    ARRAY_COUNT(gDekuTreeMouthColVertices), gDekuTreeMouthColVertices,
    ARRAY_COUNT(gDekuTreeMouthColPolygons), gDekuTreeMouthColPolygons,
