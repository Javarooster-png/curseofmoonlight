...
StandardLimb gCowRootLimb = { 
    { 0, 0, 0 }, COW_LIMB_HEAD - 1, LIMB_DONE,
    gCowTorsoDL
};

StandardLimb gCowHeadLimb = { 
    { 0, 4875, 5094 }, COW_LIMB_JAW - 1, LIMB_DONE,
    gCowHeadDL
};

StandardLimb gCowJawLimb = { 
    { 0, -2156, 594 }, LIMB_DONE, COW_LIMB_NOSE - 1,
    gCowJawDL
};

StandardLimb gCowNoseLimb = { 
    { 0, -2156, 1094 }, COW_LIMB_NOSE_RING - 1, LIMB_DONE,
    gCowNoseDL
};
...
void* gCowBodySkelLimbs[] = {
    &gCowRootLimb, /* COW_LIMB_ROOT */
    &gCowHeadLimb, /* COW_LIMB_HEAD */
    &gCowJawLimb, /* COW_LIMB_JAW */
    &gCowNoseLimb, /* COW_LIMB_NOSE */
    &gCowNoseRingLimb, /* COW_LIMB_NOSE_RING */
};
...
StandardLimb gCowTailRootLimb = { 
    { 0, 0, 0 }, COW_TAIL_LIMB_UPPER - 1, LIMB_DONE,
    gCowTailConnectionDL
};

StandardLimb gCowTailUpperLimb = { 
    { 0, -250, -1000 }, COW_TAIL_LIMB_MIDDLE - 1, LIMB_DONE,
    gCowTailUpperDL
};

StandardLimb gCowTailMiddleLimb = { 
    { 1000, 0, 0 }, COW_TAIL_LIMB_LOWER - 1, LIMB_DONE,
    gCowTailMiddleDL
};

StandardLimb gCowTailLowerLimb = { 
    { 1156, 0, 0 }, COW_TAIL_LIMB_END - 1, LIMB_DONE,
    gCowTailLowerDL
};
...
void* gCowTailSkelLimbs[] = {
    &gCowTailRootLimb, /* COW_TAIL_LIMB_ROOT */
    &gCowTailUpperLimb, /* COW_TAIL_LIMB_UPPER */
    &gCowTailMiddleLimb, /* COW_TAIL_LIMB_MIDDLE */
    &gCowTailLowerLimb, /* COW_TAIL_LIMB_LOWER */
    &gCowTailEndLimb, /* COW_TAIL_LIMB_END */
};
