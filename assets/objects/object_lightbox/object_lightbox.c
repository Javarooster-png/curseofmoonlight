...
BgCamInfo object_lightbox_Col_001F10CamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader object_lightbox_Col_001F10 = { 
    { -3999, 0, -4000 },
    { 4000, 16000, 3999 },
    ARRAY_COUNT(object_lightbox_Col_001F10Vertices), object_lightbox_Col_001F10Vertices,
    ARRAY_COUNT(object_lightbox_Col_001F10Polygons), object_lightbox_Col_001F10Polygons,
