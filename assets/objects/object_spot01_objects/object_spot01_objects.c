...
BgCamInfo gKakarikoWellArchColCamDataList[] = {
    { 0x0000, 0, NULL },
};

SurfaceType gKakarikoWellArchColSurfaceType[] = {
    {0x00200000, 0x000007CA},   {0x00000000, 0x000007CA},
};
...
CollisionHeader gKakarikoWellArchCol = { 
    { -1106, 0, -100 },
    { 1106, 1300, 100 },
    ARRAY_COUNT(gKakarikoWellArchColVertices), gKakarikoWellArchColVertices,
    ARRAY_COUNT(gKakarikoWellArchColPolygons), gKakarikoWellArchColPolygons,
