...
s16 sHappyMaskSalesmanIdleAnimFrameData[] = {
...
JointIndex sHappyMaskSalesmanIdleAnimJointIndices[] = {
...
AnimationHeader gHappyMaskSalesmanIdleAnim = { 
    { 24 }, sHappyMaskSalesmanIdleAnimFrameData,
    sHappyMaskSalesmanIdleAnimJointIndices, 6
};
...
Gfx gHappyMaskSalesmanTorsoDL[] = {
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPPipeSync(),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
    gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
    gsDPSetTextureLUT(G_TT_RGBA16),
    gsDPLoadTLUT_pal256(gHappyMaskSalesmanTLUT),
    gsDPLoadTextureBlock(gHappyMaskSalesmanShirtTex, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_CLAMP,
    ...
    gsDPSetTextureLUT(G_TT_RGBA16),
    gsDPLoadTLUT_pal256(gHappyMaskSalesmanTLUT),
    gsDPLoadTextureBlock(gHappyMaskSalesmanSkinTex, G_IM_FMT_CI, G_IM_SIZ_8b, 8, 8, 0, G_TX_NOMIRROR | G_TX_CLAMP,
    ...
    gsDPSetTextureLUT(G_TT_RGBA16),
    gsDPLoadTLUT_pal256(gHappyMaskSalesmanTLUT),
    gsDPLoadTextureBlock(gHappyMaskSalesmanGoldFabricTex, G_IM_FMT_CI, G_IM_SIZ_8b, 8, 16, 0, G_TX_NOMIRROR | G_TX_WRAP,
    ...
    gsDPSetTextureLUT(G_TT_RGBA16),
    gsDPLoadTLUT_pal256(gHappyMaskSalesmanTLUT),
    gsDPLoadTextureBlock(gHappyMaskSalesmanGoldFabricCenterTex, G_IM_FMT_CI, G_IM_SIZ_8b, 8, 16, 0, G_TX_MIRROR |
...
Gfx gHappyMaskSalesmanHeadDL[] = {
    ...
    gsDPSetTextureLUT(G_TT_RGBA16),
    gsDPLoadTLUT_pal256(gHappyMaskSalesmanTLUT),
    gsDPLoadTextureBlock(gHappyMaskSalesmanHairTex, G_IM_FMT_CI, G_IM_SIZ_8b, 16, 16, 0, G_TX_NOMIRROR | G_TX_WRAP,
    ...
    gsDPSetTextureLUT(G_TT_RGBA16),
    gsDPLoadTLUT_pal256(gHappyMaskSalesmanTLUT),
    gsDPLoadTextureBlock(gHappyMaskSalesmanEarTex, G_IM_FMT_CI, G_IM_SIZ_8b, 8, 8, 0, G_TX_NOMIRROR | G_TX_CLAMP,
                         G_TX_NOMIRROR | G_TX_CLAMP, 3, 3, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetTileSize(G_TX_RENDERTILE, 0, 0, 0x001C, 0x001C),
    ...
    gsDPSetTextureLUT(G_TT_RGBA16),
    gsDPLoadTLUT_pal256(gHappyMaskSalesmanTLUT),
    gsDPLoadTextureBlock(gHappyMaskSalesmanNostrilTex, G_IM_FMT_CI, G_IM_SIZ_8b, 8, 8, 0, G_TX_MIRROR | G_TX_WRAP,
                         G_TX_NOMIRROR | G_TX_CLAMP, 3, 3, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetTileSize(G_TX_RENDERTILE, 0, 0, 0x001C, 0x001C),
    gsSP1Triangle(8, 9, 10, 0),
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_RGBA16),
    gsDPLoadTLUT_pal256(gHappyMaskSalesmanEyeMouthTLUT),
    gsDPLoadTextureBlock(gHappyMaskSalesmanMouthTex, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 16, 0, G_TX_NOMIRROR | G_TX_CLAMP,
...
Gfx gHappyMaskSalesmanRightUpperArmDL[] = {
    gsSPMatrix(0x0D000000, G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPSetGeometryMode(G_FOG | G_LIGHTING),
    gsSPClearGeometryMode(G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
    ...
    gsDPSetTextureLUT(G_TT_RGBA16),
    gsDPLoadTLUT_pal256(gHappyMaskSalesmanTLUT),
    gsDPLoadTextureBlock(gHappyMaskSalesmanSleeveTex, G_IM_FMT_CI, G_IM_SIZ_8b, 16, 32, 0, G_TX_NOMIRROR | G_TX_WRAP,
...
Gfx gHappyMaskSalesmanRightForearmDL[] = {
    gsSPMatrix(0x0D000100, G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPSetGeometryMode(G_FOG | G_LIGHTING),
    gsSPClearGeometryMode(G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
...
Gfx gHappyMaskSalesmanRightHandDL[] = {
    gsSPMatrix(0x0D000140, G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPSetGeometryMode(G_FOG | G_LIGHTING),
    gsSPClearGeometryMode(G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
    ...
    gsDPSetTextureLUT(G_TT_RGBA16),
    gsDPLoadTLUT_pal256(gHappyMaskSalesmanTLUT),
    gsDPLoadTextureBlock(gHappyMaskSalesmanFingersTex, G_IM_FMT_CI, G_IM_SIZ_8b, 16, 16, 0, G_TX_NOMIRROR | G_TX_CLAMP,
                         G_TX_NOMIRROR | G_TX_CLAMP, 4, 4, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetTileSize(G_TX_RENDERTILE, 0, 0, 0x003C, 0x003C),
    gsDPSetPrimColor(0, 0x80, 255, 255, 255, 255),
...
Gfx gHappyMaskSalesmanLeftUpperArmDL[] = {
    gsSPMatrix(0x0D000000, G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPSetGeometryMode(G_FOG | G_LIGHTING),
    gsSPClearGeometryMode(G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
...
Gfx gHappyMaskSalesmanLeftForearmDL[] = {
    gsSPMatrix(0x0D000040, G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPSetGeometryMode(G_FOG | G_LIGHTING),
    gsSPClearGeometryMode(G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
...
Gfx gHappyMaskSalesmanLeftHandDL[] = {
    gsSPMatrix(0x0D000080, G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPSetGeometryMode(G_FOG | G_LIGHTING),
    gsSPClearGeometryMode(G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
...
u64 gHappyMaskSalesmanTLUT[] = {
#include "assets/objects/object_os/tlut.rgba16.inc.c"
};

u64 gHappyMaskSalesmanEyeMouthTLUT[] = {
#include "assets/objects/object_os/eye_mouth_tlut.rgba16.inc.c"
};

u64 gHappyMaskSalesmanSkinTex[] = {
#include "assets/objects/object_os/skin.ci8.inc.c"
};

u64 gHappyMaskSalesmanHairTex[] = {
#include "assets/objects/object_os/hair.ci8.inc.c"
};

u64 gHappyMaskSalesmanEarTex[] = {
#include "assets/objects/object_os/ear.ci8.inc.c"
};

u64 gHappyMaskSalesmanNostrilTex[] = {
#include "assets/objects/object_os/nostril.ci8.inc.c"
};

u64 gHappyMaskSalesmanMouthTex[] = {
#include "assets/objects/object_os/mouth.ci8.inc.c"
};

u64 gHappyMaskSalesmanEyeClosedTex[] = {
#include "assets/objects/object_os/eye_closed.ci8.inc.c"
};

u64 gHappyMaskSalesmanEyeOpenTex[] = {
#include "assets/objects/object_os/eye_open.ci8.inc.c"
};

u64 gHappyMaskSalesmanFingersTex[] = {
#include "assets/objects/object_os/fingers.ci8.inc.c"
};

u64 gHappyMaskSalesmanSleeveTex[] = {
#include "assets/objects/object_os/sleeve.ci8.inc.c"
};

u64 gHappyMaskSalesmanShirtTex[] = {
#include "assets/objects/object_os/shirt.ci8.inc.c"
};

u64 gHappyMaskSalesmanGoldFabricTex[] = {
#include "assets/objects/object_os/gold_fabric.ci8.inc.c"
};

u64 gHappyMaskSalesmanGoldFabricCenterTex[] = {
#include "assets/objects/object_os/gold_fabric_center.ci8.inc.c"
};

StandardLimb gHappyMaskSalesmanTorsoLimb = { 
    { 0, 3500, -100 }, 0x01, LIMB_DONE,
    gHappyMaskSalesmanTorsoDL
};

StandardLimb gHappyMaskSalesmanLeftUpperArmLimb = { 
    { 1850, 0, 700 }, 0x02, 0x04,
    gHappyMaskSalesmanLeftUpperArmDL
};

StandardLimb gHappyMaskSalesmanLeftForearmLimb = { 
    { 950, 0, 0 }, 0x03, LIMB_DONE,
    gHappyMaskSalesmanLeftForearmDL
};

StandardLimb gHappyMaskSalesmanLeftHandLimb = { 
    { 1000, 0, 0 }, LIMB_DONE, LIMB_DONE,
    gHappyMaskSalesmanLeftHandDL
};

StandardLimb gHappyMaskSalesmanRightUpperArmLimb = { 
    { 1850, 0, -700 }, 0x05, 0x07,
    gHappyMaskSalesmanRightUpperArmDL
};

StandardLimb gHappyMaskSalesmanRightForearmLimb = { 
    { 950, 0, 0 }, 0x06, LIMB_DONE,
    gHappyMaskSalesmanRightForearmDL
};

StandardLimb gHappyMaskSalesmanRightHandLimb = { 
    { 1000, 0, 0 }, LIMB_DONE, LIMB_DONE,
    gHappyMaskSalesmanRightHandDL
};

StandardLimb gHappyMaskSalesmanHeadLimb = { 
    { 2450, 0, 0 }, LIMB_DONE, LIMB_DONE,
    gHappyMaskSalesmanHeadDL
};

void* gHappyMaskSalesmanSkelLimbs[] = {
    &gHappyMaskSalesmanTorsoLimb,
    &gHappyMaskSalesmanLeftUpperArmLimb,
    &gHappyMaskSalesmanLeftForearmLimb,
    &gHappyMaskSalesmanLeftHandLimb,
    &gHappyMaskSalesmanRightUpperArmLimb,
    &gHappyMaskSalesmanRightForearmLimb,
    &gHappyMaskSalesmanRightHandLimb,
    &gHappyMaskSalesmanHeadLimb,
};

FlexSkeletonHeader gHappyMaskSalesmanSkel = { 
    { gHappyMaskSalesmanSkelLimbs, ARRAY_COUNT(gHappyMaskSalesmanSkelLimbs) }, 8
};
