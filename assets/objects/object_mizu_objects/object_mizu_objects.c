...
Gfx gWaterTempleFloatingPlatformOutsideCentralPillarDL[] = {
    gsDPPipeSync(),
...
BgCamInfo gWaterTempleFloatingPlatformOutsideCentralPillarColCamDataList[] = {
    { 0x0000, 0, NULL },
};

SurfaceType gWaterTempleFloatingPlatformOutsideCentralPillarColSurfaceType[] = {
    {0x00000000, 0x000007C2},
};

CollisionPoly gWaterTempleFloatingPlatformOutsideCentralPillarColPolygons[] = {
...
Vec3s gWaterTempleFloatingPlatformOutsideCentralPillarColVertices[] = {
    {    600,      0,    600 },
    {    600,      0,   -600 },
    {   -600,      0,   -600 },
    {   -600,      0,    600 },
...
CollisionHeader gWaterTempleFloatingPlatformOutsideCentralPillarCol = { 
    { -600, -800, -600 },
    { 600, 0, 600 },
    ARRAY_COUNT(gWaterTempleFloatingPlatformOutsideCentralPillarColVertices),
    gWaterTempleFloatingPlatformOutsideCentralPillarColVertices,
    ARRAY_COUNT(gWaterTempleFloatingPlatformOutsideCentralPillarColPolygons),
    gWaterTempleFloatingPlatformOutsideCentralPillarColPolygons,
    gWaterTempleFloatingPlatformOutsideCentralPillarColSurfaceType,
    gWaterTempleFloatingPlatformOutsideCentralPillarColCamDataList,
    0, NULL
};
...
Gfx gWaterTempleFloatingPlatformWestDL[] = {
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_NONE),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock(object_mizu_objectsTex_007D20, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 32, 0, G_TX_NOMIRROR |
...
BgCamInfo gWaterTempleFloatingPlatformWestColCamDataList[] = {
    { 0x0000, 0, NULL },
};

SurfaceType gWaterTempleFloatingPlatformWestColSurfaceType[] = {
    {0x00000000, 0x000007C2},
};

CollisionPoly gWaterTempleFloatingPlatformWestColPolygons[] = {
...
Vec3s gWaterTempleFloatingPlatformWestColVertices[] = {
    {   -400,   -700,   -600 },
    {   -400,   -700,    600 },
    {   -400,      0,    600 },
    {   -400,      0,   -600 },
...
CollisionHeader gWaterTempleFloatingPlatformWestCol = { 
    { -400, -850, -600 },
    { 800, 0, 600 },
    ARRAY_COUNT(gWaterTempleFloatingPlatformWestColVertices), gWaterTempleFloatingPlatformWestColVertices,
    ARRAY_COUNT(gWaterTempleFloatingPlatformWestColPolygons), gWaterTempleFloatingPlatformWestColPolygons,
    gWaterTempleFloatingPlatformWestColSurfaceType,
    gWaterTempleFloatingPlatformWestColCamDataList,
    0, NULL
};
...
Gfx gWaterTempleFloatingPlatformInsideCentralPillarDL[] = {
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_NONE),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock(object_mizu_objectsTex_007D20, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 32, 0, G_TX_NOMIRROR |
...
BgCamInfo gWaterTempleFloatingPlatformInsideCentralPillarColCamDataList[] = {
    { 0x0000, 0, NULL },
};

SurfaceType gWaterTempleFloatingPlatformInsideCentralPillarColSurfaceType[] = {
    {0x00000000, 0x000007C2},
};

CollisionPoly gWaterTempleFloatingPlatformInsideCentralPillarColPolygons[] = {
...
Vec3s gWaterTempleFloatingPlatformInsideCentralPillarColVertices[] = {
    {   -600,  -1200,    600 },
    {   -600,  -1200,   -600 },
    {    600,  -1200,   -600 },
    {    600,  -1200,    600 },
...
CollisionHeader gWaterTempleFloatingPlatformInsideCentralPillarCol = { 
    { -600, -1200, -600 },
    { 600, 0, 600 },
    ARRAY_COUNT(gWaterTempleFloatingPlatformInsideCentralPillarColVertices),
    gWaterTempleFloatingPlatformInsideCentralPillarColVertices,
    ARRAY_COUNT(gWaterTempleFloatingPlatformInsideCentralPillarColPolygons),
    gWaterTempleFloatingPlatformInsideCentralPillarColPolygons,
    gWaterTempleFloatingPlatformInsideCentralPillarColSurfaceType,
    gWaterTempleFloatingPlatformInsideCentralPillarColCamDataList,
    0, NULL
};
...
Gfx gWaterTempleHookshotPlatformDL[] = {
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_NONE),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock(object_mizu_objectsTex_007D20, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 32, 0, G_TX_NOMIRROR |
...
BgCamInfo gWaterTempleHookshotPlatformColCamDataList[] = {
    { 0x0000, 0, NULL },
};

SurfaceType gWaterTempleHookshotPlatformColSurfaceType[] = {
    {0x00000000, 0x000007C2},   {0x00000000, 0x000207C2},
};

CollisionPoly gWaterTempleHookshotPlatformColPolygons[] = {
...
Vec3s gWaterTempleHookshotPlatformColVertices[] = {
    {   -600,   -350,   -600 },
    {   -600,   -600,   -600 },
    {   -600,   -600,    600 },
    {   -600,   -350,    600 },
...
CollisionHeader gWaterTempleHookshotPlatformCol = { 
    { -600, -600, -600 },
    { 600, 0, 600 },
    ARRAY_COUNT(gWaterTempleHookshotPlatformColVertices), gWaterTempleHookshotPlatformColVertices,
    ARRAY_COUNT(gWaterTempleHookshotPlatformColPolygons), gWaterTempleHookshotPlatformColPolygons,
    gWaterTempleHookshotPlatformColSurfaceType,
    gWaterTempleHookshotPlatformColCamDataList,
    0, NULL
};
...
BgCamInfo gObjectMizuObjectsBwallCol_001C58CamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gObjectMizuObjectsBwallCol_001C58 = { 
    { -400, -40, -400 },
    { 400, 0, 400 },
    ARRAY_COUNT(gObjectMizuObjectsBwallCol_001C58Vertices), gObjectMizuObjectsBwallCol_001C58Vertices,
    ARRAY_COUNT(gObjectMizuObjectsBwallCol_001C58Polygons), gObjectMizuObjectsBwallCol_001C58Polygons,
...
BgCamInfo gObjectMizuObjectsBwallCol_001DE8CamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gObjectMizuObjectsBwallCol_001DE8 = { 
    { -600, 0, 0 },
    { 600, 1200, 0 },
    ARRAY_COUNT(gObjectMizuObjectsBwallCol_001DE8Vertices), gObjectMizuObjectsBwallCol_001DE8Vertices,
    ARRAY_COUNT(gObjectMizuObjectsBwallCol_001DE8Polygons), gObjectMizuObjectsBwallCol_001DE8Polygons,
...
BgCamInfo gObjectMizuObjectsBwallCol_0025A4CamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gObjectMizuObjectsBwallCol_0025A4 = { 
    { -40, 0, -400 },
    { 40, 1160, 653 },
    ARRAY_COUNT(gObjectMizuObjectsBwallCol_0025A4Vertices), gObjectMizuObjectsBwallCol_0025A4Vertices,
    ARRAY_COUNT(gObjectMizuObjectsBwallCol_0025A4Polygons), gObjectMizuObjectsBwallCol_0025A4Polygons,
...
Gfx gWaterTempleDragonStatueDL[] = {
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_NONE),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock(object_mizu_objectsTex_007D20, G_IM_FMT_RGBA, G_IM_SIZ_16b, 32, 32, 0, G_TX_NOMIRROR |
...
BgCamInfo gWaterTempleDragonStatueColCamDataList[] = {
    { 0x0000, 0, NULL },
};

SurfaceType gWaterTempleDragonStatueColSurfaceType[] = {
    {0x00000000, 0x000007C2},
};

CollisionPoly gWaterTempleDragonStatueColPolygons[] = {
...
Vec3s gWaterTempleDragonStatueColVertices[] = {
    {   -262,   2165,   -326 },
    {   -262,   1815,   -155 },
    {    262,   1815,   -155 },
    {    262,   2165,   -326 },
...
CollisionHeader gWaterTempleDragonStatueCol = { 
    { -262, 0, -326 },
    { 262, 2165, 692 },
    ARRAY_COUNT(gWaterTempleDragonStatueColVertices), gWaterTempleDragonStatueColVertices,
    ARRAY_COUNT(gWaterTempleDragonStatueColPolygons), gWaterTempleDragonStatueColPolygons,
    gWaterTempleDragonStatueColSurfaceType,
    gWaterTempleDragonStatueColCamDataList,
    0, NULL
};
...
BgCamInfo gObjectMizuObjectsShutterCol_007250CamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gObjectMizuObjectsShutterCol_007250 = { 
    { -600, 0, -100 },
    { 600, 1200, 100 },
    ARRAY_COUNT(gObjectMizuObjectsShutterCol_007250Vertices), gObjectMizuObjectsShutterCol_007250Vertices,
    ARRAY_COUNT(gObjectMizuObjectsShutterCol_007250Polygons), gObjectMizuObjectsShutterCol_007250Polygons,
...
BgCamInfo gObjectMizuObjectsShutterCol_0073F0CamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gObjectMizuObjectsShutterCol_0073F0 = { 
    { -800, 0, -40 },
    { 800, 1600, 40 },
    ARRAY_COUNT(gObjectMizuObjectsShutterCol_0073F0Vertices), gObjectMizuObjectsShutterCol_0073F0Vertices,
    ARRAY_COUNT(gObjectMizuObjectsShutterCol_0073F0Polygons), gObjectMizuObjectsShutterCol_0073F0Polygons,
...
BgCamInfo gObjectMizuObjectsUzuCol_0074ECCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gObjectMizuObjectsUzuCol_0074EC = { 
    { -2000, -4548, -2000 },
    { 2000, 0, 2000 },
    ARRAY_COUNT(gObjectMizuObjectsUzuCol_0074ECVertices), gObjectMizuObjectsUzuCol_0074ECVertices,
    ARRAY_COUNT(gObjectMizuObjectsUzuCol_0074ECPolygons), gObjectMizuObjectsUzuCol_0074ECPolygons,
