...
BgCamInfo gSongOfTimeBlockColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gSongOfTimeBlockCol = { 
    { -50, 0, -50 },
    { 50, 100, 50 },
    ARRAY_COUNT(gSongOfTimeBlockColVertices), gSongOfTimeBlockColVertices,
    ARRAY_COUNT(gSongOfTimeBlockColPolygons), gSongOfTimeBlockColPolygons,
