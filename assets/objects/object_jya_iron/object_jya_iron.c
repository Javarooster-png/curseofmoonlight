...
BgCamInfo gPillarColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gPillarCol = { 
    { -173, 0, -200 },
    { 173, 1600, 200 },
    ARRAY_COUNT(gPillarColVertices), gPillarColVertices,
    ARRAY_COUNT(gPillarColPolygons), gPillarColPolygons,
...
BgCamInfo gThroneColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gThroneCol = { 
    { -255, 0, -270 },
    { 255, 1200, 270 },
    ARRAY_COUNT(gThroneColVertices), gThroneColVertices,
    ARRAY_COUNT(gThroneColPolygons), gThroneColPolygons,
