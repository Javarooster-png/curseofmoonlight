...
BgCamInfo gBowlingFirstAndFinalRoundColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gBowlingFirstAndFinalRoundCol = { 
    { -220, 0, -103 },
    { 220, 386, 0 },
    ARRAY_COUNT(gBowlingFirstAndFinalRoundColVertices), gBowlingFirstAndFinalRoundColVertices,
    ARRAY_COUNT(gBowlingFirstAndFinalRoundColPolygons), gBowlingFirstAndFinalRoundColPolygons,
...
BgCamInfo gBowlingSecondRoundColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gBowlingSecondRoundCol = { 
    { -240, -233, -84 },
    { 240, 246, 0 },
    ARRAY_COUNT(gBowlingSecondRoundColVertices), gBowlingSecondRoundColVertices,
    ARRAY_COUNT(gBowlingSecondRoundColPolygons), gBowlingSecondRoundColPolygons,
...
BgCamInfo gBowlingDefaultColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gBowlingDefaultCol = { 
    { -200, 0, 0 },
    { 160, 200, 0 },
    ARRAY_COUNT(gBowlingDefaultColVertices), gBowlingDefaultColVertices,
    ARRAY_COUNT(gBowlingDefaultColPolygons), gBowlingDefaultColPolygons,
