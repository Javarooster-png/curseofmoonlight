...
BgCamInfo gPushBlockColCamDataList[] = {
    { 0x0000, 0, NULL },
};

SurfaceType gPushBlockColSurfaceType[] = {
    {0x00E00000, 0x000007C2},   {0x00000000, 0x000007C2},
};
...
CollisionHeader gPushBlockCol = { 
    { -300, 0, -300 },
    { 300, 600, 300 },
    ARRAY_COUNT(gPushBlockColVertices), gPushBlockColVertices,
    ARRAY_COUNT(gPushBlockColPolygons), gPushBlockColPolygons,
...
BgCamInfo gFloorSwitchColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gFloorSwitchCol = { 
    { -240, 10, -240 },
    { 240, 110, 240 },
    ARRAY_COUNT(gFloorSwitchColVertices), gFloorSwitchColVertices,
    ARRAY_COUNT(gFloorSwitchColPolygons), gFloorSwitchColPolygons,
