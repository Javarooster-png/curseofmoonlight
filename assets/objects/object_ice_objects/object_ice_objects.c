...
BgCamInfo object_ice_objects_Col_0003F0CamDataList[] = {
    { 0x0000, 0, NULL },
};

SurfaceType object_ice_objects_Col_0003F0SurfaceType[] = {
    {0x00E0A000, 0x000007CC},   {0x0000A000, 0x000007CC},
};
...
CollisionHeader object_ice_objects_Col_0003F0 = { 
    { -600, 0, -600 },
    { 600, 600, 600 },
    ARRAY_COUNT(object_ice_objects_Col_0003F0Vertices), object_ice_objects_Col_0003F0Vertices,
    ARRAY_COUNT(object_ice_objects_Col_0003F0Polygons), object_ice_objects_Col_0003F0Polygons,
...
Gfx gRedIceBlockDL[] = {
    ...
    gsDPLoadTextureBlock(gRedIceBlockTex, G_IM_FMT_I, G_IM_SIZ_8b, 32, 32, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR |
...
Gfx gRedIcePlatformDL[] = {
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_NONE),
    gsSPTexture(0x0FA0, 0x0FA0, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock_4b(gRedIcePlatformTex, G_IM_FMT_I, 64, 64, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR |
                            G_TX_WRAP, 6, 6, 1, 1),
    gsDPTileSync(),
...
BgCamInfo gRedIcePlatformColCamDataList[] = {
    { 0x0000, 0, NULL },
};

SurfaceType gRedIcePlatformColSurfaceType[] = {
    {0x0000A000, 0x000007CC},
};

CollisionPoly gRedIcePlatformColPolygons[] = {
...
Vec3s gRedIcePlatformColVertices[] = {
    {    394,    784,    454 },
    {    477,    784,   -199 },
    {   -118,    784,   -480 },
    {   -569,    784,     -1 },
...
CollisionHeader gRedIcePlatformCol = { 
    { -814, 0, -756 },
    { 685, 1027, 751 },
    ARRAY_COUNT(gRedIcePlatformColVertices), gRedIcePlatformColVertices,
    ARRAY_COUNT(gRedIcePlatformColPolygons), gRedIcePlatformColPolygons,
    gRedIcePlatformColSurfaceType,
    gRedIcePlatformColCamDataList,
    0, NULL
};
...
BgCamInfo object_ice_objects_Col_002594CamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader object_ice_objects_Col_002594 = { 
    { -141, 0, -157 },
    { 165, 1200, 152 },
    ARRAY_COUNT(object_ice_objects_Col_002594Vertices), object_ice_objects_Col_002594Vertices,
    ARRAY_COUNT(object_ice_objects_Col_002594Polygons), object_ice_objects_Col_002594Polygons,
...
Gfx gRedIceWallDL[] = {
    ...
    gsDPSetTextureLUT(G_TT_NONE),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPLoadTextureBlock(gRedIceWallTex, G_IM_FMT_I, G_IM_SIZ_8b, 32, 128, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR |
...
BgCamInfo object_ice_objects_Col_002854CamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader object_ice_objects_Col_002854 = { 
    { -900, 0, 0 },
    { 900, 1800, 0 },
    ARRAY_COUNT(object_ice_objects_Col_002854Vertices), object_ice_objects_Col_002854Vertices,
    ARRAY_COUNT(object_ice_objects_Col_002854Polygons), object_ice_objects_Col_002854Polygons,
    object_ice_objects_Col_002854SurfaceType,
    object_ice_objects_Col_002854CamDataList,
    0, NULL
};

BgCamInfo gRedIceWallColCamDataList[] = {
    { 0x0000, 0, NULL },
};

SurfaceType gRedIceWallColSurfaceType[] = {
    {0x00000000, 0x000007C0},
};

CollisionPoly gRedIceWallColPolygons[] = {
...
CollisionHeader gRedIceWallCol = { 
    { -819, 0, -2 },
    { 819, 1336, 377 },
    ARRAY_COUNT(gRedIceWallColVertices), gRedIceWallColVertices,
    ARRAY_COUNT(gRedIceWallColPolygons), gRedIceWallColPolygons,
    gRedIceWallColSurfaceType,
    gRedIceWallColCamDataList,
    0, NULL
};
...
u64 gRedIceWallTex[] = {
#include "assets/objects/object_ice_objects/red_ice_wall.i8.inc.c"
};
...
u64 gRedIceBlockTex[] = {
#include "assets/objects/object_ice_objects/red_ice_block.i8.inc.c"
};

u64 gRedIcePlatformTex[] = {
#include "assets/objects/object_ice_objects/red_ice_platform.i4.inc.c"
};
