...
BgCamInfo gPoSistersAmyBlockColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gPoSistersAmyBlockCol = { 
    { -30, -30, -30 },
    { 30, 30, 30 },
    ARRAY_COUNT(gPoSistersAmyBlockColVertices), gPoSistersAmyBlockColVertices,
    ARRAY_COUNT(gPoSistersAmyBlockColPolygons), gPoSistersAmyBlockColPolygons,
