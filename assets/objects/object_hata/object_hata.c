...
BgCamInfo gFlagpoleColCamDataList[] = {
    { 0x0000, 0, NULL },
};

SurfaceType gFlagpoleColCamPosData[] = {
...
CollisionHeader gFlagpoleCol = { 
    { -400, 0, -400 },
    { 400, 20000, 400 },
    ARRAY_COUNT(gFlagpoleColVertices), gFlagpoleColVertices,
    ARRAY_COUNT(gFlagpoleColPolygons), gFlagpoleColPolygons,
    gFlagpoleColCamPosData,
