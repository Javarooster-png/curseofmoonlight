...
BgCamInfo gKakarikoShootingGalleryColCamDataList[] = {
    { 0x0000, 0, NULL },
};

SurfaceType gKakarikoShootingGalleryColSurfaceType[] = {
    {0x00000000, 0x000007CA},   {0x00000000, 0x000207CA},
};
...
CollisionHeader gKakarikoShootingGalleryCol = { 
    { -2000, 0, -2000 },
    { 2000, 3000, 2000 },
    ARRAY_COUNT(gKakarikoShootingGalleryColVertices), gKakarikoShootingGalleryColVertices,
    ARRAY_COUNT(gKakarikoShootingGalleryColPolygons), gKakarikoShootingGalleryColPolygons,
...
BgCamInfo gKakarikoBOTWStoneColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gKakarikoBOTWStoneCol = { 
    { -470, 0, -700 },
    { 530, 1413, 700 },
    ARRAY_COUNT(gKakarikoBOTWStoneColVertices), gKakarikoBOTWStoneColVertices,
    ARRAY_COUNT(gKakarikoBOTWStoneColPolygons), gKakarikoBOTWStoneColPolygons,
