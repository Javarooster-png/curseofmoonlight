...
s16 sBombchuShopkeeperIdleAnimFrameData[] = {
...
JointIndex sBombchuShopkeeperIdleAnimJointIndices[] = {
...
AnimationHeader gBombchuShopkeeperIdleAnim = { 
    { 39 }, sBombchuShopkeeperIdleAnimFrameData,
    sBombchuShopkeeperIdleAnimJointIndices, 5
};
...
Gfx gBombchuShopkeeperTorsoDL[] = {
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPPipeSync(),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
    gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
    gsDPSetTextureLUT(G_TT_RGBA16),
    gsDPLoadTLUT_pal256(gBombchuShopkeeperTLUT),
    gsDPLoadTextureBlock(gBombchuShopkeeperSkinTex, G_IM_FMT_CI, G_IM_SIZ_8b, 8, 8, 0, G_TX_NOMIRROR | G_TX_CLAMP,
    ...
    gsDPLoadTextureBlock(gBombchuShopkeeperVestTex, G_IM_FMT_I, G_IM_SIZ_8b, 8, 16, 0, G_TX_NOMIRROR | G_TX_WRAP,
    ...
    gsDPSetTextureLUT(G_TT_RGBA16),
    gsDPLoadTLUT_pal256(gBombchuShopkeeperTLUT),
    gsDPLoadTextureBlock(gBombchuShopkeeperTorsoTex, G_IM_FMT_CI, G_IM_SIZ_8b, 8, 32, 0, G_TX_MIRROR | G_TX_WRAP,
...
Gfx gBombchuShopkeeperHeadDL[] = {
    ...
    gsDPSetTextureLUT(G_TT_RGBA16),
    gsDPLoadTLUT_pal256(gBombchuShopkeeperTLUT),
    gsDPLoadTextureBlock(gBombchuShopkeeperEarTex, G_IM_FMT_CI, G_IM_SIZ_8b, 8, 8, 0, G_TX_NOMIRROR | G_TX_CLAMP,
                         G_TX_NOMIRROR | G_TX_CLAMP, 3, 3, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetTileSize(G_TX_RENDERTILE, 0, 0, 0x001C, 0x001C),
    ...
    gsDPSetTextureLUT(G_TT_RGBA16),
    gsDPLoadTLUT_pal256(gBombchuShopkeeperTLUT),
    gsDPLoadTextureBlock(gBombchuShopkeeperTattooTex, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 64, 0, G_TX_MIRROR | G_TX_WRAP,
...
Gfx gBombchuShopkeeperRightUpperArmDL[] = {
    gsSPMatrix(0x0D000000, G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPSetGeometryMode(G_LIGHTING),
    gsSPClearGeometryMode(G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
...
Gfx gBombchuShopkeeperRightForearmDL[] = {
    gsSPMatrix(0x0D000100, G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPSetGeometryMode(G_LIGHTING),
    gsSPClearGeometryMode(G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
...
Gfx gBombchuShopkeeperRightHandDL[] = {
    gsSPMatrix(0x0D000140, G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPSetGeometryMode(G_LIGHTING),
    gsSPClearGeometryMode(G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
    ...
    gsDPSetTextureLUT(G_TT_RGBA16),
    gsDPLoadTLUT_pal256(gBombchuShopkeeperTLUT),
    gsDPLoadTextureBlock(gBombchuShopkeeperFingersTex, G_IM_FMT_CI, G_IM_SIZ_8b, 16, 16, 0, G_TX_NOMIRROR | G_TX_CLAMP,
...
Gfx gBombchuShopkeeperLeftUpperArmDL[] = {
    gsSPMatrix(0x0D000000, G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPSetGeometryMode(G_LIGHTING),
    gsSPClearGeometryMode(G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
...
Gfx gBombchuShopkeeperLeftForearmDL[] = {
    gsSPMatrix(0x0D000040, G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPSetGeometryMode(G_LIGHTING),
    gsSPClearGeometryMode(G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
...
Gfx gBombchuShopkeeperLeftHandDL[] = {
    gsSPMatrix(0x0D000080, G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPSetGeometryMode(G_LIGHTING),
    gsSPClearGeometryMode(G_TEXTURE_GEN | G_TEXTURE_GEN_LINEAR),
...
u64 gBombchuShopkeeperTLUT[] = {
#include "assets/objects/object_rs/tlut.rgba16.inc.c"
};

u64 gBombchuShopkeeperSkinTex[] = {
#include "assets/objects/object_rs/skin.ci8.inc.c"
};

u64 gBombchuShopkeeperEarTex[] = {
#include "assets/objects/object_rs/ear.ci8.inc.c"
};

u64 gBombchuShopkeeperTattooTex[] = {
#include "assets/objects/object_rs/tattoo.ci8.inc.c"
};
...
u64 gBombchuShopkeeperFingersTex[] = {
#include "assets/objects/object_rs/fingers.ci8.inc.c"
};

u64 gBombchuShopkeeperVestTex[] = {
#include "assets/objects/object_rs/vest.i8.inc.c"
};

u64 gBombchuShopkeeperTorsoTex[] = {
#include "assets/objects/object_rs/torso.ci8.inc.c"
};

StandardLimb gBombchuShopkeeperTorsoLimb = { 
    { 0, 3837, 50 }, 0x01, LIMB_DONE,
    gBombchuShopkeeperTorsoDL
};

StandardLimb gBombchuShopkeeperLeftUpperArmLimb = { 
    { 1400, -100, 650 }, 0x02, 0x04,
    gBombchuShopkeeperLeftUpperArmDL
};

StandardLimb gBombchuShopkeeperLeftForearmLimb = { 
    { 1050, 0, 0 }, 0x03, LIMB_DONE,
    gBombchuShopkeeperLeftForearmDL
};

StandardLimb gBombchuShopkeeperLeftHandLimb = { 
    { 751, 0, 0 }, LIMB_DONE, LIMB_DONE,
    gBombchuShopkeeperLeftHandDL
};

StandardLimb gBombchuShopkeeperRightUpperArmLimb = { 
    { 1400, -100, -650 }, 0x05, 0x07,
    gBombchuShopkeeperRightUpperArmDL
};

StandardLimb gBombchuShopkeeperRightForearmLimb = { 
    { 1050, 0, 0 }, 0x06, LIMB_DONE,
    gBombchuShopkeeperRightForearmDL
};

StandardLimb gBombchuShopkeeperRightHandLimb = { 
    { 750, 0, 0 }, LIMB_DONE, LIMB_DONE,
    gBombchuShopkeeperRightHandDL
};

StandardLimb gBombchuShopkeeperHeadLimb = { 
    { 2004, 0, 0 }, LIMB_DONE, LIMB_DONE,
    gBombchuShopkeeperHeadDL
};

void* gBombchuShopkeeperSkelLimbs[] = {
    &gBombchuShopkeeperTorsoLimb,
    &gBombchuShopkeeperLeftUpperArmLimb,
    &gBombchuShopkeeperLeftForearmLimb,
    &gBombchuShopkeeperLeftHandLimb,
    &gBombchuShopkeeperRightUpperArmLimb,
    &gBombchuShopkeeperRightForearmLimb,
    &gBombchuShopkeeperRightHandLimb,
    &gBombchuShopkeeperHeadLimb,
};

FlexSkeletonHeader gBombchuShopkeeperSkel = { 
    { gBombchuShopkeeperSkelLimbs, ARRAY_COUNT(gBombchuShopkeeperSkelLimbs) }, 8
};
