...
BgCamInfo gArmosColCamDataList[] = {
    { 0x0000, 0, NULL },
};

SurfaceType gArmosColCamPosData[] = {
...
CollisionHeader gArmosCol = { 
    { -1700, 0, -2000 },
    { 1700, 6500, 2500 },
    ARRAY_COUNT(gArmosColVertices), gArmosColVertices,
    ARRAY_COUNT(gArmosColPolygons), gArmosColPolygons,
    gArmosColCamPosData,
