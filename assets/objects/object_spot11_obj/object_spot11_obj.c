...
BgCamInfo gDesertColossusBombableWallColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gDesertColossusBombableWallCol = { 
    { 2199, 108, -1550 },
    { 2318, 268, -1549 },
    ARRAY_COUNT(gDesertColossusBombableWallColVertices), gDesertColossusBombableWallColVertices,
    ARRAY_COUNT(gDesertColossusBombableWallColPolygons), gDesertColossusBombableWallColPolygons,
