...
BgCamInfo gHyruleFieldCastleDrawbridgeChainsColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gHyruleFieldCastleDrawbridgeChainsCol = { 
    { -10, -26, -490 },
    { 10, 428, 14 },
    ARRAY_COUNT(gHyruleFieldCastleDrawbridgeChainsColVertices), gHyruleFieldCastleDrawbridgeChainsColVertices,
    ARRAY_COUNT(gHyruleFieldCastleDrawbridgeChainsColPolygons), gHyruleFieldCastleDrawbridgeChainsColPolygons,
...
BgCamInfo gHyruleFieldCastleDrawbridgeColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gHyruleFieldCastleDrawbridgeCol = { 
    { -180, -10, -10 },
    { 180, 10, 410 },
    ARRAY_COUNT(gHyruleFieldCastleDrawbridgeColVertices), gHyruleFieldCastleDrawbridgeColVertices,
    ARRAY_COUNT(gHyruleFieldCastleDrawbridgeColPolygons), gHyruleFieldCastleDrawbridgeColPolygons,
