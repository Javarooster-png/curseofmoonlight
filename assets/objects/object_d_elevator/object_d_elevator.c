...
BgCamInfo object_d_elevator_Col_000360CamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader object_d_elevator_Col_000360 = { 
    { -600, 0, -600 },
    { 600, 4000, 600 },
    ARRAY_COUNT(object_d_elevator_Col_000360Vertices), object_d_elevator_Col_000360Vertices,
    ARRAY_COUNT(object_d_elevator_Col_000360Polygons), object_d_elevator_Col_000360Polygons,
