...
s16 object_yb_Anim_000200FrameData[] = {
...
JointIndex object_yb_Anim_000200JointIndices[] = {
...
AnimationHeader object_yb_Anim_000200 = { 
    { 5 }, object_yb_Anim_000200FrameData,
    object_yb_Anim_000200JointIndices, 5
};

Vtx object_ybVtx_000210[] = {
#include "assets/objects/object_yb/object_ybVtx_000210.vtx.inc"
};

u8 object_yb_unaccounted_002080[] = {
...
Vtx object_ybVtx_0020B0[] = {
#include "assets/objects/object_yb/object_ybVtx_0020B0.vtx.inc"
};

u8 object_yb_unaccounted_002D50[] = {
...
Vtx object_ybVtx_002D80[] = {
#include "assets/objects/object_yb/object_ybVtx_002D80.vtx.inc"
};

Gfx gYbPantsAndBellyButtonDL[] = {
    ...
    gsDPLoadTextureBlock(gYbPantsTex, G_IM_FMT_I, G_IM_SIZ_8b, 16, 16, 0, G_TX_MIRROR | G_TX_CLAMP, G_TX_MIRROR |
                         G_TX_CLAMP, 4, 4, G_TX_NOLOD, G_TX_NOLOD),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&object_ybVtx_000210[231], 27, 0),
    ...
    gsDPLoadTLUT_pal256(gYbTLUT),
    gsDPLoadTextureBlock(gYbForeheadBlotchTex, G_IM_FMT_CI, G_IM_SIZ_8b, 8, 8, 0, G_TX_MIRROR | G_TX_CLAMP, G_TX_MIRROR
                         | G_TX_CLAMP, 3, 3, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetPrimColor(0, 0x80, 255, 255, 255, 255),
    gsSPVertex(&object_ybVtx_000210[258], 11, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
    gsSP2Triangles(6, 7, 8, 0, 9, 1, 10, 0),
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_RGBA16),
    gsDPLoadTLUT_pal256(gYbTLUT),
    gsDPLoadTextureBlock(gYbBellybuttonTex, G_IM_FMT_CI, G_IM_SIZ_8b, 8, 16, 0, G_TX_MIRROR | G_TX_CLAMP, G_TX_MIRROR |
                         G_TX_CLAMP, 3, 4, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&object_ybVtx_000210[269], 4, 0),
...
Gfx gYbRightThighDL[] = {
    ...
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&object_ybVtx_000210[76], 11, 0),
    ...
    gsDPLoadTextureBlock(gYbPantsTex, G_IM_FMT_I, G_IM_SIZ_8b, 16, 16, 0, G_TX_MIRROR | G_TX_CLAMP, G_TX_MIRROR |
                         G_TX_CLAMP, 4, 4, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&object_ybVtx_000210[87], 8, 11),
...
Gfx gYbRightShinDL[] = {
    ...
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&object_ybVtx_000210[46], 4, 0),
    ...
    gsDPLoadTextureBlock(gYbForeheadBlotchTex, G_IM_FMT_CI, G_IM_SIZ_8b, 8, 8, 0, G_TX_MIRROR | G_TX_CLAMP, G_TX_MIRROR
                         | G_TX_CLAMP, 3, 3, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetPrimColor(0, 0x80, 255, 255, 255, 255),
    gsSPVertex(&object_ybVtx_000210[50], 12, 4),
    ...
    gsSPVertex(&object_ybVtx_000210[62], 14, 0),
...
Gfx gYbRightFoodDL[] = {
    ...
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(object_ybVtx_000210, 4, 0),
    ...
    gsDPLoadTextureBlock(gYbForeheadBlotchTex, G_IM_FMT_CI, G_IM_SIZ_8b, 8, 8, 0, G_TX_MIRROR | G_TX_CLAMP, G_TX_MIRROR
                         | G_TX_CLAMP, 3, 3, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetPrimColor(0, 0x80, 255, 255, 255, 255),
    gsSPVertex(&object_ybVtx_000210[4], 12, 4),
    ...
    gsDPSetTextureLUT(G_TT_RGBA16),
    gsDPLoadTLUT_pal256(gYbTLUT),
    gsDPLoadTextureBlock(gYbToesTex, G_IM_FMT_CI, G_IM_SIZ_8b, 16, 16, 0, G_TX_MIRROR | G_TX_CLAMP, G_TX_MIRROR |
                         G_TX_CLAMP, 4, 4, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&object_ybVtx_000210[16], 7, 0),
    gsSP2Triangles(0, 1, 2, 0, 1, 3, 2, 0),
    gsSP1Triangle(4, 5, 6, 0),
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_RGBA16),
    gsDPLoadTLUT_pal256(gYbTLUT),
    gsDPLoadTextureBlock(gYbFingersTex, G_IM_FMT_CI, G_IM_SIZ_8b, 16, 16, 0, G_TX_MIRROR | G_TX_CLAMP, G_TX_MIRROR |
                         G_TX_CLAMP, 4, 4, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&object_ybVtx_000210[23], 17, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
    ...
    gsDPLoadTextureBlock(gYbForeheadBlotchTex, G_IM_FMT_CI, G_IM_SIZ_8b, 8, 8, 0, G_TX_MIRROR | G_TX_CLAMP, G_TX_MIRROR
                         | G_TX_CLAMP, 3, 3, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&object_ybVtx_000210[40], 6, 0),
...
Gfx gYbLeftThighDL[] = {
    ...
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&object_ybVtx_000210[191], 12, 0),
    ...
    gsDPLoadTextureBlock(gYbPantsTex, G_IM_FMT_I, G_IM_SIZ_8b, 16, 16, 0, G_TX_MIRROR | G_TX_CLAMP, G_TX_MIRROR |
                         G_TX_CLAMP, 4, 4, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&object_ybVtx_000210[203], 8, 12),
...
Gfx gYbLeftShinDL[] = {
    ...
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&object_ybVtx_000210[161], 4, 0),
    ...
    gsDPLoadTextureBlock(gYbForeheadBlotchTex, G_IM_FMT_CI, G_IM_SIZ_8b, 8, 8, 0, G_TX_MIRROR | G_TX_CLAMP, G_TX_MIRROR
                         | G_TX_CLAMP, 3, 3, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetPrimColor(0, 0x80, 255, 255, 255, 255),
    gsSPVertex(&object_ybVtx_000210[165], 12, 4),
    ...
    gsSPVertex(&object_ybVtx_000210[177], 14, 0),
...
Gfx gYbLeftFootDL[] = {
    ...
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&object_ybVtx_000210[115], 4, 0),
    ...
    gsDPLoadTextureBlock(gYbForeheadBlotchTex, G_IM_FMT_CI, G_IM_SIZ_8b, 8, 8, 0, G_TX_MIRROR | G_TX_CLAMP, G_TX_MIRROR
                         | G_TX_CLAMP, 3, 3, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetPrimColor(0, 0x80, 255, 255, 255, 255),
    gsSPVertex(&object_ybVtx_000210[119], 12, 4),
    ...
    gsSPVertex(&object_ybVtx_000210[131], 6, 0),
    ...
    gsDPLoadTextureBlock(gYbToesTex, G_IM_FMT_CI, G_IM_SIZ_8b, 16, 16, 0, G_TX_MIRROR | G_TX_CLAMP, G_TX_MIRROR |
                         G_TX_CLAMP, 4, 4, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&object_ybVtx_000210[137], 7, 0),
    ...
    gsDPLoadTextureBlock(gYbFingersTex, G_IM_FMT_CI, G_IM_SIZ_8b, 16, 16, 0, G_TX_MIRROR | G_TX_CLAMP, G_TX_MIRROR |
                         G_TX_CLAMP, 4, 4, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&object_ybVtx_000210[144], 17, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
    gsSP2Triangles(2, 6, 0, 0, 7, 8, 9, 0),
...
Gfx gYbUpperTorsoDL[] = {
    ...
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(object_ybVtx_002D80, 3, 0),
    gsSPVertex(&object_ybVtx_002D80[3], 4, 3),
    gsSPVertex(&object_ybVtx_002D80[7], 1, 7),
    ...
    gsDPLoadTextureBlock(gYbForeheadBlotchTex, G_IM_FMT_CI, G_IM_SIZ_8b, 8, 8, 0, G_TX_MIRROR | G_TX_CLAMP, G_TX_MIRROR
                         | G_TX_CLAMP, 3, 3, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetPrimColor(0, 0x80, 255, 255, 255, 255),
    gsSPVertex(&object_ybVtx_002D80[8], 22, 8),
    ...
    gsSPVertex(&object_ybVtx_002D80[30], 32, 0),
    ...
    gsSPVertex(&object_ybVtx_002D80[62], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 1, 0, 0),
    ...
    gsSPVertex(&object_ybVtx_002D80[94], 10, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
...
Gfx gYbHeadDL[] = {
    ...
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&object_ybVtx_000210[293], 6, 0),
    ...
    gsDPLoadTextureBlock(gYbForeheadBlotchTex, G_IM_FMT_CI, G_IM_SIZ_8b, 8, 8, 0, G_TX_MIRROR | G_TX_CLAMP, G_TX_MIRROR
                         | G_TX_CLAMP, 3, 3, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetPrimColor(0, 0x80, 255, 255, 255, 255),
    gsSPVertex(&object_ybVtx_000210[299], 12, 6),
    ...
    gsDPSetTextureLUT(G_TT_RGBA16),
    gsDPLoadTLUT_pal256(gYbTLUT),
    gsDPLoadTextureBlock(gYbEyeTex, G_IM_FMT_CI, G_IM_SIZ_8b, 32, 32, 0, G_TX_MIRROR | G_TX_CLAMP, G_TX_MIRROR |
                         G_TX_CLAMP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&object_ybVtx_000210[311], 20, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 3, 1, 0),
    ...
    gsDPLoadTextureBlock(gYbForeheadBlotchTex, G_IM_FMT_CI, G_IM_SIZ_8b, 8, 8, 0, G_TX_MIRROR | G_TX_CLAMP, G_TX_MIRROR
                         | G_TX_CLAMP, 3, 3, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&object_ybVtx_000210[331], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 0, 0),
    ...
    gsSPVertex(&object_ybVtx_000210[361], 32, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
    ...
    gsSPVertex(&object_ybVtx_000210[392], 30, 0),
    ...
    gsDPSetTextureLUT(G_TT_RGBA16),
    gsDPLoadTLUT_pal256(gYbTLUT),
    gsDPLoadTextureBlock(gYbHairlineTex, G_IM_FMT_CI, G_IM_SIZ_8b, 16, 16, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_MIRROR |
                         G_TX_CLAMP, 4, 4, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&object_ybVtx_000210[422], 32, 0),
    ...
    gsSPVertex(&object_ybVtx_000210[454], 17, 0),
    ...
    gsDPSetTextureLUT(G_TT_RGBA16),
    gsDPLoadTLUT_pal256(gYbTLUT),
    gsDPLoadTextureBlock(gYbNoseTex, G_IM_FMT_CI, G_IM_SIZ_8b, 16, 16, 0, G_TX_MIRROR | G_TX_CLAMP, G_TX_MIRROR |
                         G_TX_CLAMP, 4, 4, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&object_ybVtx_000210[471], 16, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
...
Gfx gYbPonyTailDL[] = {
    ...
    gsDPLoadTextureBlock(gYbPantsTex, G_IM_FMT_I, G_IM_SIZ_8b, 16, 16, 0, G_TX_MIRROR | G_TX_CLAMP, G_TX_MIRROR |
                         G_TX_CLAMP, 4, 4, G_TX_NOLOD, G_TX_NOLOD),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&object_ybVtx_000210[273], 7, 0),
    gsSP2Triangles(0, 1, 2, 0, 2, 1, 3, 0),
    ...
    gsDPSetTextureLUT(G_TT_RGBA16),
    gsDPLoadTLUT_pal256(gYbTLUT),
    gsDPLoadTextureBlock(gYbPonytailTex, G_IM_FMT_CI, G_IM_SIZ_8b, 8, 16, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_MIRROR |
                         G_TX_CLAMP, 3, 4, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetPrimColor(0, 0x80, 255, 255, 255, 255),
    gsSPVertex(&object_ybVtx_000210[280], 13, 0),
...
Gfx gYbEndDisplayList4970DL[] = {
    gsSPEndDisplayList(),
};

Gfx gYbRightUpperArmDL[] = {
    gsSPMatrix(0x0D000440, G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&object_ybVtx_0020B0[174], 7, 0),
    ...
    gsDPLoadTextureBlock(gYbForeheadBlotchTex, G_IM_FMT_CI, G_IM_SIZ_8b, 8, 8, 0, G_TX_MIRROR | G_TX_CLAMP, G_TX_MIRROR
                         | G_TX_CLAMP, 3, 3, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetPrimColor(0, 0x80, 255, 255, 255, 255),
    gsSPVertex(&object_ybVtx_0020B0[181], 13, 7),
    ...
    gsSPVertex(&object_ybVtx_0020B0[194], 8, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
...
Gfx gYbRightForearmDL[] = {
    gsSPMatrix(0x0D000340, G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&object_ybVtx_0020B0[150], 4, 0),
    ...
    gsDPLoadTextureBlock(gYbForeheadBlotchTex, G_IM_FMT_CI, G_IM_SIZ_8b, 8, 8, 0, G_TX_MIRROR | G_TX_CLAMP, G_TX_MIRROR
                         | G_TX_CLAMP, 3, 3, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetPrimColor(0, 0x80, 255, 255, 255, 255),
    gsSPVertex(&object_ybVtx_0020B0[154], 12, 4),
    ...
    gsSPVertex(&object_ybVtx_0020B0[166], 8, 0),
    gsSP2Triangles(0, 1, 2, 0, 2, 3, 0, 0),
...
Gfx gYbRightHandDL[] = {
    ...
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&object_ybVtx_0020B0[101], 4, 0),
    ...
    gsDPLoadTextureBlock(gYbFingersTex, G_IM_FMT_CI, G_IM_SIZ_8b, 16, 16, 0, G_TX_MIRROR | G_TX_CLAMP, G_TX_MIRROR |
                         G_TX_CLAMP, 4, 4, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetPrimColor(0, 0x80, 255, 255, 255, 255),
    gsSPVertex(&object_ybVtx_0020B0[105], 18, 4),
    ...
    gsSPVertex(&object_ybVtx_0020B0[123], 19, 0),
    gsSP2Triangles(0, 1, 2, 0, 2, 3, 0, 0),
    ...
    gsDPLoadTextureBlock(gYbToesTex, G_IM_FMT_CI, G_IM_SIZ_8b, 16, 16, 0, G_TX_MIRROR | G_TX_CLAMP, G_TX_MIRROR |
                         G_TX_CLAMP, 4, 4, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&object_ybVtx_0020B0[142], 8, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 0, 2, 0),
    gsSP2Triangles(4, 5, 6, 0, 5, 7, 6, 0),
    gsSPEndDisplayList(),
};

Gfx gYbLeftUpperArmDL[] = {
    gsSPMatrix(0x0D000440, G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&object_ybVtx_0020B0[73], 7, 0),
    ...
    gsDPLoadTextureBlock(gYbForeheadBlotchTex, G_IM_FMT_CI, G_IM_SIZ_8b, 8, 8, 0, G_TX_MIRROR | G_TX_CLAMP, G_TX_MIRROR
                         | G_TX_CLAMP, 3, 3, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetPrimColor(0, 0x80, 255, 255, 255, 255),
    gsSPVertex(&object_ybVtx_0020B0[80], 13, 7),
    ...
    gsSPVertex(&object_ybVtx_0020B0[93], 8, 0),
    gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
...
Gfx gYbLeftForearmDL[] = {
    gsSPMatrix(0x0D000280, G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&object_ybVtx_0020B0[49], 4, 0),
    ...
    gsDPLoadTextureBlock(gYbForeheadBlotchTex, G_IM_FMT_CI, G_IM_SIZ_8b, 8, 8, 0, G_TX_MIRROR | G_TX_CLAMP, G_TX_MIRROR
                         | G_TX_CLAMP, 3, 3, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetPrimColor(0, 0x80, 255, 255, 255, 255),
    gsSPVertex(&object_ybVtx_0020B0[53], 12, 4),
    ...
    gsSPVertex(&object_ybVtx_0020B0[65], 8, 0),
    gsSP2Triangles(0, 1, 2, 0, 2, 3, 0, 0),
...
Gfx gYbLeftHandDL[] = {
    ...
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(object_ybVtx_0020B0, 4, 0),
    ...
    gsDPLoadTextureBlock(gYbFingersTex, G_IM_FMT_CI, G_IM_SIZ_8b, 16, 16, 0, G_TX_MIRROR | G_TX_CLAMP, G_TX_MIRROR |
                         G_TX_CLAMP, 4, 4, G_TX_NOLOD, G_TX_NOLOD),
    gsDPSetPrimColor(0, 0x80, 255, 255, 255, 255),
    gsSPVertex(&object_ybVtx_0020B0[4], 18, 4),
    ...
    gsSPVertex(&object_ybVtx_0020B0[22], 19, 0),
    gsSP2Triangles(0, 1, 2, 0, 2, 3, 0, 0),
    ...
    gsDPLoadTextureBlock(gYbToesTex, G_IM_FMT_CI, G_IM_SIZ_8b, 16, 16, 0, G_TX_MIRROR | G_TX_CLAMP, G_TX_MIRROR |
                         G_TX_CLAMP, 4, 4, G_TX_NOLOD, G_TX_NOLOD),
    gsSPVertex(&object_ybVtx_0020B0[41], 8, 0),
...
u64 gYbTLUT[] = {
#include "assets/objects/object_yb/yb_tlut.rgba16.inc.c"
};

u64 gYbForeheadBlotchTex[] = {
#include "assets/objects/object_yb/yb_forhead_blotch.ci8.inc.c"
};

u64 gYbPonytailTex[] = {
#include "assets/objects/object_yb/yb_ponytail.ci8.inc.c"
};

u64 gYbFingersTex[] = {
#include "assets/objects/object_yb/yb_fingers.ci8.inc.c"
};

u64 gYbToesTex[] = {
#include "assets/objects/object_yb/yb_toes.ci8.inc.c"
};

u64 gYbHairlineTex[] = {
#include "assets/objects/object_yb/yb_hairline.ci8.inc.c"
};

u64 gYbBellybuttonTex[] = {
#include "assets/objects/object_yb/yb_bellybutton.ci8.inc.c"
};

u64 gYbNoseTex[] = {
#include "assets/objects/object_yb/yb_nose.ci8.inc.c"
};

u64 gYbEyeTex[] = {
#include "assets/objects/object_yb/yb_eye.ci8.inc.c"
};

u64 gYbPantsTex[] = {
#include "assets/objects/object_yb/yb_pants.i8.inc.c"
};

StandardLimb gYbMainRootLimb = { 
    { 0, 3600, 100 }, YB_LIMB_PANTS - 1, LIMB_DONE,
    NULL
};

StandardLimb gYbPantsLimb = { 
    { 0, 0, 0 }, YB_LIMB_LEGS_ROOT - 1, YB_LIMB_CHEST_ROOT - 1,
    gYbPantsAndBellyButtonDL
};

StandardLimb gYbLegsRootLimb = { 
    { 945, 0, 0 }, YB_LIMB_RIGHT_THIGH - 1, LIMB_DONE,
    NULL
};

StandardLimb gYbRightThighLimb = { 
    { -442, -5, -350 }, YB_LIMB_RIGHT_SHIN - 1, YB_LIMB_LEFT_THIGH - 1,
    gYbRightThighDL
};

StandardLimb gYbRightShinLimb = { 
    { 1100, 0, 0 }, YB_LIMB_RIGHT_FOOT - 1, LIMB_DONE,
    gYbRightShinDL
};

StandardLimb gYbRightFootLimb = { 
    { 1500, 0, 0 }, LIMB_DONE, LIMB_DONE,
    gYbRightFoodDL
};

StandardLimb gYbLeftThighLimb = { 
    { -442, -5, 350 }, YB_LIMB_LEFT_SHIN - 1, LIMB_DONE,
    gYbLeftThighDL
};

StandardLimb gYbLeftShinLimb = { 
    { 1100, 0, 0 }, YB_LIMB_LEFT_FOOT - 1, LIMB_DONE,
    gYbLeftShinDL
};

StandardLimb gYbLeftFootLimb = { 
    { 1500, 0, 0 }, LIMB_DONE, LIMB_DONE,
    gYbLeftFootDL
};

StandardLimb gYbChestRootLimb = { 
    { 0, 21, -7 }, YB_LIMB_HEAD - 1, LIMB_DONE,
    NULL
};

StandardLimb gYbHeadLimb = { 
    { 1806, 100, 0 }, YB_LIMB_PONYTAIL - 1, YB_LIMB_EMPTY_5E88 - 1,
    gYbHeadDL
};

StandardLimb gYbPonyTailLimb = { 
    { -199, -915, 0 }, LIMB_DONE, LIMB_DONE,
    gYbPonyTailDL
};

StandardLimb gYbEmpty5E88Limb = { 
    { 0, 0, 0 }, LIMB_DONE, YB_LIMB_LEFT_UPPER_ARM - 1,
    gYbEndDisplayList4108DL
};

StandardLimb gYbLeftUpperArmLimb = { 
    { 1295, -140, 480 }, YB_LIMB_LEFT_FOREARM - 1, YB_LIMB_RIGHT_UPPER_ARM - 1,
    gYbLeftUpperArmDL
};

StandardLimb gYbLeftForearmLimb = { 
    { 1171, 0, 0 }, YB_LIMB_LEFT_HAND - 1, LIMB_DONE,
    gYbLeftForearmDL
};

StandardLimb gYbLeftHandLimb = { 
    { 1004, 0, 0 }, LIMB_DONE, LIMB_DONE,
    gYbLeftHandDL
};

StandardLimb gYbRightUpperArmLimb = { 
    { 1300, -140, -480 }, YB_LIMB_RIGHT_FOREARM - 1, YB_LIMB_EMPTY_5EDC - 1,
    gYbRightUpperArmDL
};

StandardLimb gYbRightForearmLimb = { 
    { 1169, 0, 0 }, YB_LIMB_RIGHT_HAND - 1, LIMB_DONE,
    gYbRightForearmDL
};

StandardLimb gYbRightHandLimb = { 
    { 1004, 0, 0 }, LIMB_DONE, LIMB_DONE,
    gYbRightHandDL
};

StandardLimb gYbEmpty5EDCLimb = { 
    { 978, -200, 0 }, LIMB_DONE, YB_LIMB_TORSO - 1,
    gYbEndDisplayList4970DL
};

StandardLimb gYbUpperTorsoLimb = { 
    { 0, 0, 0 }, LIMB_DONE, LIMB_DONE,
    gYbUpperTorsoDL
};

void* gYbSkelLimbs[] = {
    &gYbMainRootLimb, /* YB_LIMB_MAIN_ROOT */
    &gYbPantsLimb, /* YB_LIMB_PANTS */
    &gYbLegsRootLimb, /* YB_LIMB_LEGS_ROOT */
    &gYbRightThighLimb, /* YB_LIMB_RIGHT_THIGH */
    &gYbRightShinLimb, /* YB_LIMB_RIGHT_SHIN */
    &gYbRightFootLimb, /* YB_LIMB_RIGHT_FOOT */
    &gYbLeftThighLimb, /* YB_LIMB_LEFT_THIGH */
    &gYbLeftShinLimb, /* YB_LIMB_LEFT_SHIN */
    &gYbLeftFootLimb, /* YB_LIMB_LEFT_FOOT */
    &gYbChestRootLimb, /* YB_LIMB_CHEST_ROOT */
    &gYbHeadLimb, /* YB_LIMB_HEAD */
    &gYbPonyTailLimb, /* YB_LIMB_PONYTAIL */
    &gYbEmpty5E88Limb, /* YB_LIMB_EMPTY_5E88 */
    &gYbLeftUpperArmLimb, /* YB_LIMB_LEFT_UPPER_ARM */
    &gYbLeftForearmLimb, /* YB_LIMB_LEFT_FOREARM */
    &gYbLeftHandLimb, /* YB_LIMB_LEFT_HAND */
    &gYbRightUpperArmLimb, /* YB_LIMB_RIGHT_UPPER_ARM */
    &gYbRightForearmLimb, /* YB_LIMB_RIGHT_FOREARM */
    &gYbRightHandLimb, /* YB_LIMB_RIGHT_HAND */
    &gYbEmpty5EDCLimb, /* YB_LIMB_EMPTY_5EDC */
    &gYbUpperTorsoLimb, /* YB_LIMB_TORSO */
};

FlexSkeletonHeader gYbSkel = { 
    { gYbSkelLimbs, ARRAY_COUNT(gYbSkelLimbs) }, 18
};

#include "DanceAnim.c"

#include "gThinkingAnim.c"
