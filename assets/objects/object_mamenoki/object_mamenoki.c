...
BgCamInfo gMagicBeanPlatformColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gMagicBeanPlatformCol = { 
    { -520, -300, -600 },
    { 520, 476, 600 },
    ARRAY_COUNT(gMagicBeanPlatformColVertices), gMagicBeanPlatformColVertices,
    ARRAY_COUNT(gMagicBeanPlatformColPolygons), gMagicBeanPlatformColPolygons,
