...
BgCamInfo gOcarinaWarpPadColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gOcarinaWarpPadCol = { 
    { -60, 0, -60 },
    { 60, 20, 60 },
    ARRAY_COUNT(gOcarinaWarpPadColVertices), gOcarinaWarpPadColVertices,
    ARRAY_COUNT(gOcarinaWarpPadColPolygons), gOcarinaWarpPadColPolygons,
