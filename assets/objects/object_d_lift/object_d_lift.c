...
BgCamInfo gCollapsingPlatformColCamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader gCollapsingPlatformCol = { 
    { -600, -180, -600 },
    { 600, 180, 600 },
    ARRAY_COUNT(gCollapsingPlatformColVertices), gCollapsingPlatformColVertices,
    ARRAY_COUNT(gCollapsingPlatformColPolygons), gCollapsingPlatformColPolygons,
