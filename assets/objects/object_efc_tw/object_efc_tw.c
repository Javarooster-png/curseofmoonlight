...
CurveInterpKnot object_efc_twCurveAnime_CurveInterpKnot_000038[] = {
    { 0x000C, 0x0001, 0, 0, 0.000010f },
    { 0x0014, 0x003C, 0, 0, 20.000000f },
};

CurveAnimationHeader gTimeWarpAnim = { 
    object_efc_twCurveAnime_Ref_000000,
    object_efc_twCurveAnime_CurveInterpKnot_000038,
...
CurveSkeletonHeader gTimeWarpSkel = { 
