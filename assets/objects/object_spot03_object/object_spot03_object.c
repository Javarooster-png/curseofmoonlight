...
BgCamInfo object_spot03_object_Col_000C98CamDataList[] = {
    { 0x0000, 0, NULL },
};
...
CollisionHeader object_spot03_object_Col_000C98 = { 
    { 0, 0, -2000 },
    { 800, 8351, 2000 },
    ARRAY_COUNT(object_spot03_object_Col_000C98Vertices), object_spot03_object_Col_000C98Vertices,
    ARRAY_COUNT(object_spot03_object_Col_000C98Polygons), object_spot03_object_Col_000C98Polygons,
