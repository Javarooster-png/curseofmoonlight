...
RomFile entra_n_sceneRoomList0x0000A8[] = {
    { (uintptr_t)_entra_n_room_0SegmentRomStart, (uintptr_t)_entra_n_room_0SegmentRomEnd },
};

Spawn entra_n_sceneEntranceList0x0000B0[] = {
    { 0x00, 0x00 },
    { 0x01, 0x00 },
    { 0x02, 0x00 },
    { 0x00, 0x00 },
...
EnvLightSettings entra_n_sceneLightSettings0x0000C0[] = {
...
Path entra_n_scenePathway_000104[] = {
    { ARRAY_COUNT(entra_n_scenePathwayList_0000D8), entra_n_scenePathwayList_0000D8 },
};
...
BgCamInfo entra_n_sceneCollisionHeader_0003F8CamDataList[] = {
    { 0x0019, 3, &entra_n_sceneCollisionHeader_0003F8CamPosData[0] },
    { 0x0000, 0, NULL },
};

SurfaceType entra_n_sceneCollisionHeader_0003F8SurfaceType[] = {
    {0x00000001, 0x00000FC2},   {0x00000301, 0x00000FC2},   {0x00000101, 0x00000FC2},
};
...
CollisionHeader entra_n_sceneCollisionHeader_0003F8 = { 
    { -571, 0, 1860 },
    { 313, 520, 3060 },
    ARRAY_COUNT(entra_n_sceneCollisionHeader_0003F8Vertices), entra_n_sceneCollisionHeader_0003F8Vertices,
    ARRAY_COUNT(entra_n_sceneCollisionHeader_0003F8Polygons), entra_n_sceneCollisionHeader_0003F8Polygons,
