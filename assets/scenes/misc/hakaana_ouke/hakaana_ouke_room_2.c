...
SceneCmd hakaana_ouke_room_2Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&hakaana_ouke_room_2RoomShapeNormal_0000A0),
    SCENE_CMD_OBJECT_LIST(7, hakaana_ouke_room_2ObjectList_00005C),
    SCENE_CMD_ACTOR_LIST(3, hakaana_ouke_room_2ActorEntry_00006C),
    SCENE_CMD_END(),
};
...
ActorEntry hakaana_ouke_room_2ActorEntry_00006C[] = {
...
RoomShapeNormal hakaana_ouke_room_2RoomShapeNormal_0000A0 = { 
    0, 1,
    hakaana_ouke_room_2RoomShapeDListsEntry_0000AC,
    hakaana_ouke_room_2RoomShapeDListsEntry_0000AC + ARRAY_COUNTU(hakaana_ouke_room_2RoomShapeDListsEntry_0000AC)
};

RoomShapeDListsEntry hakaana_ouke_room_2RoomShapeDListsEntry_0000AC[1] = {
...
SceneCmd hakaana_ouke_room_2Set_0000C0[] = {
    ...
    SCENE_CMD_ACTOR_LIST(3, hakaana_ouke_room_2ActorEntry_000108),
    SCENE_CMD_END(),
};
...
ActorEntry hakaana_ouke_room_2ActorEntry_000108[] = {
    { ACTOR_OBJ_SYOKUDAI,   {     60,     60,  -1112 }, {      0,      0,      0 }, 0x2400 },
    { ACTOR_OBJ_SYOKUDAI,   {    -60,     60,  -1112 }, {      0,      0,      0 }, 0x2400 },
    { ACTOR_EN_OKARINA_TAG, {     -1,    172,  -1202 }, {      0,      0,      0 }, 0x17FF },
};
...
SceneCmd hakaana_ouke_room_2Set_000140[] = {
    ...
    SCENE_CMD_ACTOR_LIST(3, hakaana_ouke_room_2ActorEntry_000188),
    SCENE_CMD_END(),
};
...
ActorEntry hakaana_ouke_room_2ActorEntry_000188[] = {
    { ACTOR_OBJ_SYOKUDAI,   {     60,     60,  -1112 }, {      0,      0,      0 }, 0x2400 },
    { ACTOR_OBJ_SYOKUDAI,   {    -60,     60,  -1112 }, {      0,      0,      0 }, 0x2400 },
    { ACTOR_EN_OKARINA_TAG, {     -1,    172,  -1202 }, {      0,      0,      0 }, 0x17FF },
};
