...
RomFile market_alley_n_sceneRoomList0x0000E8[] = {
    { (uintptr_t)_market_alley_n_room_0SegmentRomStart, (uintptr_t)_market_alley_n_room_0SegmentRomEnd },
};

Spawn market_alley_n_sceneEntranceList0x0000F0[] = {
    { 0x00, 0x00 },
    { 0x01, 0x00 },
    { 0x02, 0x00 },
    { 0x03, 0x00 },
...
EnvLightSettings market_alley_n_sceneLightSettings0x000108[] = {
...
Path market_alley_n_scenePathList_00019C[] = {
    { ARRAY_COUNT(market_alley_n_scenePathwayList_000120), market_alley_n_scenePathwayList_000120 },
    { ARRAY_COUNT(market_alley_n_scenePathwayList_00014C), market_alley_n_scenePathwayList_00014C },
    { ARRAY_COUNT(market_alley_n_scenePathwayList_000178), market_alley_n_scenePathwayList_000178 },
};
...
BgCamInfo market_alley_n_sceneCollisionHeader_0012C0CamDataList[] = {
...
SurfaceType market_alley_n_sceneCollisionHeader_0012C0SurfaceType[] = {
    ...
    {0x00000002, 0x00000802},   {0x00000003, 0x00000802},   {0x00000003, 0x00000FC2},   {0x00000303, 0x00000FC2},
    {0x00000403, 0x00000FC2},   {0x00000503, 0x00000FC2},   {0x00000003, 0x00000FCA},
};
...
CollisionHeader market_alley_n_sceneCollisionHeader_0012C0 = { 
    { -800, 0, 200 },
    { 800, 400, 1400 },
    ARRAY_COUNT(market_alley_n_sceneCollisionHeader_0012C0Vertices), market_alley_n_sceneCollisionHeader_0012C0Vertices,
    ARRAY_COUNT(market_alley_n_sceneCollisionHeader_0012C0Polygons), market_alley_n_sceneCollisionHeader_0012C0Polygons,
