...
RomFile enrui_sceneRoomList0x0000A0[] = {
    { (uintptr_t)_enrui_room_0SegmentRomStart, (uintptr_t)_enrui_room_0SegmentRomEnd },
};

Spawn enrui_sceneEntranceList0x0000A8[] = {
    { 0x00, 0x00 },
    { 0x01, 0x00 },
    { 0x02, 0x00 },
    { 0x00, 0x00 },
...
EnvLightSettings enrui_sceneLightSettings0x0000B8[] = {
...
BgCamInfo enrui_sceneCollisionHeader_0003B4CamDataList[] = {
    { 0x0019, 3, &enrui_sceneCollisionHeader_0003B4CamPosData[0] },
    { 0x0000, 0, NULL },
};

SurfaceType enrui_sceneCollisionHeader_0003B4SurfaceType[] = {
    {0x00000101, 0x00000802},   {0x00000001, 0x00000802},   {0x00000201, 0x00000802},   {0x00000301, 0x00000802},
};
...
CollisionHeader enrui_sceneCollisionHeader_0003B4 = { 
    { -571, 0, 1860 },
    { 313, 520, 3060 },
    ARRAY_COUNT(enrui_sceneCollisionHeader_0003B4Vertices), enrui_sceneCollisionHeader_0003B4Vertices,
    ARRAY_COUNT(enrui_sceneCollisionHeader_0003B4Polygons), enrui_sceneCollisionHeader_0003B4Polygons,
