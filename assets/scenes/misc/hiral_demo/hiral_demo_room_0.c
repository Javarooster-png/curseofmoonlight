...
SceneCmd hiral_demo_room_0Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&hiral_demo_room_0RoomShapeNormal_0000A0),
    SCENE_CMD_OBJECT_LIST(8, hiral_demo_room_0ObjectList_000078),
    SCENE_CMD_ACTOR_LIST(1, hiral_demo_room_0ActorEntry_000088),
    SCENE_CMD_END(),
};
...
ActorEntry hiral_demo_room_0ActorEntry_000088[] = {
...
RoomShapeNormal hiral_demo_room_0RoomShapeNormal_0000A0 = { 
    0, 1,
    hiral_demo_room_0RoomShapeDListsEntry_0000AC,
    hiral_demo_room_0RoomShapeDListsEntry_0000AC + ARRAY_COUNTU(hiral_demo_room_0RoomShapeDListsEntry_0000AC)
};

RoomShapeDListsEntry hiral_demo_room_0RoomShapeDListsEntry_0000AC[1] = {
...
SceneCmd hiral_demo_room_0Set_0001E0[] = {
    ...
    SCENE_CMD_ACTOR_LIST(4, hiral_demo_room_0ActorEntry_000230),
    SCENE_CMD_END(),
};
...
ActorEntry hiral_demo_room_0ActorEntry_000230[] = {
    { ACTOR_DEMO_KANKYO, {    158,    149,    315 }, {      0,      0,      0 }, 0x0000 },
...
SceneCmd hiral_demo_room_0Set_000270[] = {
    ...
    SCENE_CMD_ACTOR_LIST(2, hiral_demo_room_0ActorEntry_0002B4),
    SCENE_CMD_END(),
};
...
ActorEntry hiral_demo_room_0ActorEntry_0002B4[] = {
...
SceneCmd hiral_demo_room_0Set_0002E0[] = {
    ...
    SCENE_CMD_ACTOR_LIST(5, hiral_demo_room_0ActorEntry_000330),
    SCENE_CMD_END(),
};
...
ActorEntry hiral_demo_room_0ActorEntry_000330[] = {
    { ACTOR_DEMO_KANKYO, {    158,    149,    315 }, {      0,      0,      0 }, 0x0000 },
    { ACTOR_DEMO_EFFECT, {      4,     95,    -59 }, {      0,      0,      0 }, 0xF404 },
    { ACTOR_DEMO_EFFECT, {    150,    139,    -99 }, {      0,      0,      0 }, 0xF505 },
    { ACTOR_DEMO_EFFECT, {    165,    166,   -104 }, {      0,      0,      0 }, 0xF606 },
...
SceneCmd hiral_demo_room_0Set_000380[] = {
    ...
    SCENE_CMD_ACTOR_LIST(1, hiral_demo_room_0ActorEntry_0003C4),
    SCENE_CMD_END(),
};
...
ActorEntry hiral_demo_room_0ActorEntry_0003C4[] = {
...
SceneCmd hiral_demo_room_0Set_0003E0[] = {
    ...
    SCENE_CMD_ACTOR_LIST(2, hiral_demo_room_0ActorEntry_000430),
    SCENE_CMD_END(),
};
...
ActorEntry hiral_demo_room_0ActorEntry_000430[] = {
    { ACTOR_DEMO_KANKYO, {    158,    149,    315 }, {      0,      0,      0 }, 0x0000 },
    { ACTOR_DEMO_EFFECT, {   -510,    180,    278 }, {      0,      0,      0 }, 0xFF08 },
};
...
SceneCmd hiral_demo_room_0Set_000450[] = {
    ...
    SCENE_CMD_ACTOR_LIST(2, hiral_demo_room_0ActorEntry_000494),
    SCENE_CMD_END(),
};
...
ActorEntry hiral_demo_room_0ActorEntry_000494[] = {
    { ACTOR_EN_VIEWER, {    112,      0,     14 }, {      0,      0,      0 }, 0x05FF },
    { ACTOR_EN_VIEWER, {    101,      0,     23 }, {      0,      0,      0 }, 0x06FF },
};
...
SceneCmd hiral_demo_room_0Set_0004C0[] = {
    ...
    SCENE_CMD_ACTOR_LIST(2, hiral_demo_room_0ActorEntry_000504),
    SCENE_CMD_END(),
};
...
ActorEntry hiral_demo_room_0ActorEntry_000504[] = {
    { ACTOR_EN_VIEWER, {    112,      0,     14 }, {      0,      0,      0 }, 0x05FF },
    { ACTOR_EN_VIEWER, {    101,      0,     23 }, {      0,      0,      0 }, 0x06FF },
};
...
SceneCmd hiral_demo_room_0Set_000530[] = {
    ...
    SCENE_CMD_ACTOR_LIST(5, hiral_demo_room_0ActorEntry_000580),
    SCENE_CMD_END(),
};
...
ActorEntry hiral_demo_room_0ActorEntry_000580[] = {
    { ACTOR_DEMO_KANKYO, {    158,    149,    315 }, {      0,      0,      0 }, 0x0000 },
    { ACTOR_DEMO_EFFECT, {      4,     95,    -59 }, {      0,      0,      0 }, 0xF404 },
    { ACTOR_DEMO_EFFECT, {    150,    139,    -99 }, {      0,      0,      0 }, 0xF505 },
    { ACTOR_DEMO_EFFECT, {    165,    166,   -104 }, {      0,      0,      0 }, 0xF606 },
...
SceneCmd hiral_demo_room_0Set_0005D0[] = {
    ...
    SCENE_CMD_ACTOR_LIST(1, hiral_demo_room_0ActorEntry_000614),
    SCENE_CMD_END(),
};
...
ActorEntry hiral_demo_room_0ActorEntry_000614[] = {
