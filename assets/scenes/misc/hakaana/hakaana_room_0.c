...
SceneCmd hakaana_room_0Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&hakaana_room_0RoomShapeNormal_000090),
    SCENE_CMD_OBJECT_LIST(4, hakaana_room_0ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(4, hakaana_room_0ActorEntry_000048),
    SCENE_CMD_END(),
};
...
ActorEntry hakaana_room_0ActorEntry_000048[] = {
...
RoomShapeNormal hakaana_room_0RoomShapeNormal_000090 = { 
    0, 1,
    hakaana_room_0RoomShapeDListsEntry_00009C,
    hakaana_room_0RoomShapeDListsEntry_00009C + ARRAY_COUNTU(hakaana_room_0RoomShapeDListsEntry_00009C)
};

RoomShapeDListsEntry hakaana_room_0RoomShapeDListsEntry_00009C[1] = {
