...
RomFile kinsuta_sceneRoomList0x000080[] = {
    { (uintptr_t)_kinsuta_room_0SegmentRomStart, (uintptr_t)_kinsuta_room_0SegmentRomEnd },
};

Spawn kinsuta_sceneEntranceList0x000088[] = {
    { 0x00, 0x00 },
    { 0x00, 0x00 },
};
...
EnvLightSettings kinsuta_sceneLightSettings0x000090[] = {
...
BgCamInfo kinsuta_sceneCollisionHeader_0015E4CamDataList[] = {
    { 0x0000, 0, NULL },
    { 0x003A, 0, NULL },
    { 0x0001, 0, NULL },
};
...
SurfaceType kinsuta_sceneCollisionHeader_0015E4SurfaceType[] = {
    {0x00000000, 0x000017CA},   {0x00000001, 0x0000100A},   {0x00000002, 0x0000100A},   {0x00000000, 0x000017C0},
    {0x00000100, 0x0000100A},   {0x00000002, 0x000017C0},
};
...
CollisionHeader kinsuta_sceneCollisionHeader_0015E4 = { 
    { -291, -2, -336 },
    { 291, 474, 629 },
    ARRAY_COUNT(kinsuta_sceneCollisionHeader_0015E4Vertices), kinsuta_sceneCollisionHeader_0015E4Vertices,
    ARRAY_COUNT(kinsuta_sceneCollisionHeader_0015E4Polygons), kinsuta_sceneCollisionHeader_0015E4Polygons,
