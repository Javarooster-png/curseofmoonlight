...
SceneCmd kakusiana_room_9Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&kakusiana_room_9RoomShapeCullable_000080),
    SCENE_CMD_OBJECT_LIST(1, kakusiana_room_9ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(3, kakusiana_room_9ActorEntry_000044),
    SCENE_CMD_END(),
};
...
ActorEntry kakusiana_room_9ActorEntry_000044[] = {
...
RoomShapeCullable kakusiana_room_9RoomShapeCullable_000080 = { 
    2, 8,
    kakusiana_room_9RoomShapeCullableEntry_00008C,
    kakusiana_room_9RoomShapeCullableEntry_00008C + ARRAY_COUNTU(kakusiana_room_9RoomShapeCullableEntry_00008C)
};

RoomShapeCullableEntry kakusiana_room_9RoomShapeCullableEntry_00008C[8] = {
