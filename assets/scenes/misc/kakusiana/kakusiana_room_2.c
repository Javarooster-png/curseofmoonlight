...
SceneCmd kakusiana_room_2Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&kakusiana_room_2RoomShapeCullable_000080),
    SCENE_CMD_OBJECT_LIST(3, kakusiana_room_2ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(3, kakusiana_room_2ActorEntry_000048),
    SCENE_CMD_END(),
};
...
ActorEntry kakusiana_room_2ActorEntry_000048[] = {
...
RoomShapeCullable kakusiana_room_2RoomShapeCullable_000080 = { 
    2, 5,
    kakusiana_room_2RoomShapeCullableEntry_00008C,
    kakusiana_room_2RoomShapeCullableEntry_00008C + ARRAY_COUNTU(kakusiana_room_2RoomShapeCullableEntry_00008C)
};

RoomShapeCullableEntry kakusiana_room_2RoomShapeCullableEntry_00008C[5] = {
