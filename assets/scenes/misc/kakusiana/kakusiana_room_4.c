...
SceneCmd kakusiana_room_4Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&kakusiana_room_4RoomShapeCullable_000100),
    SCENE_CMD_OBJECT_LIST(5, kakusiana_room_4ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(11, kakusiana_room_4ActorEntry_00004C),
    SCENE_CMD_END(),
};
...
ActorEntry kakusiana_room_4ActorEntry_00004C[] = {
...
RoomShapeCullable kakusiana_room_4RoomShapeCullable_000100 = { 
    2, 8,
    kakusiana_room_4RoomShapeCullableEntry_00010C,
    kakusiana_room_4RoomShapeCullableEntry_00010C + ARRAY_COUNTU(kakusiana_room_4RoomShapeCullableEntry_00010C)
};

RoomShapeCullableEntry kakusiana_room_4RoomShapeCullableEntry_00010C[8] = {
