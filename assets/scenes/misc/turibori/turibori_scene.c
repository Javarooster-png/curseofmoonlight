...
RomFile turibori_sceneRoomList0x000080[] = {
    { (uintptr_t)_turibori_room_0SegmentRomStart, (uintptr_t)_turibori_room_0SegmentRomEnd },
};

Spawn turibori_sceneEntranceList0x000088[] = {
    { 0x00, 0x00 },
    { 0x00, 0x00 },
};
...
EnvLightSettings turibori_sceneLightSettings0x000090[] = {
...
BgCamInfo turibori_sceneCollisionHeader_001CACCamDataList[] = {
    { 0x0000, 0, NULL },
    { 0x003B, 0, NULL },
    { 0x0004, 0, NULL },
};
...
SurfaceType turibori_sceneCollisionHeader_001CACSurfaceType[] = {
    {0x00000000, 0x000017C2},   {0x00000000, 0x000017C0},   {0x00000100, 0x000017C2},   {0x00000001, 0x000017C0},
    {0x00000000, 0x000017C4},   {0x00200000, 0x000017C0},   {0x00000002, 0x000017C2},
};
...
CollisionHeader turibori_sceneCollisionHeader_001CAC = { 
    { -1400, -169, -1271 },
    { 1444, 932, 1501 },
    ARRAY_COUNT(turibori_sceneCollisionHeader_001CACVertices), turibori_sceneCollisionHeader_001CACVertices,
    ARRAY_COUNT(turibori_sceneCollisionHeader_001CACPolygons), turibori_sceneCollisionHeader_001CACPolygons,
    turibori_sceneCollisionHeader_001CACSurfaceType,
    turibori_sceneCollisionHeader_001CACCamDataList,
    ARRAY_COUNT(turibori_sceneCollisionHeader_001CACWaterBoxes), turibori_sceneCollisionHeader_001CACWaterBoxes
};
