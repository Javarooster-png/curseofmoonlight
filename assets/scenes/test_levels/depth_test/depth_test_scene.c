...
RomFile depth_test_sceneRoomList0x000048[] = {
    { (uintptr_t)_depth_test_room_0SegmentRomStart, (uintptr_t)_depth_test_room_0SegmentRomEnd },
};

Spawn depth_test_sceneEntranceList0x000050[] = {
    { 0x00, 0x00 },
    { 0x00, 0x00 },
};

EnvLightSettings depth_test_sceneLightSettings0x000054[] = {
...
BgCamInfo depth_test_sceneCollisionHeader_0002D4CamDataList[] = {
...
CollisionHeader depth_test_sceneCollisionHeader_0002D4 = { 
    { -1399, -4399, -13599 },
    { 6500, 1400, -7 },
    ARRAY_COUNT(depth_test_sceneCollisionHeader_0002D4Vertices), depth_test_sceneCollisionHeader_0002D4Vertices,
    ARRAY_COUNT(depth_test_sceneCollisionHeader_0002D4Polygons), depth_test_sceneCollisionHeader_0002D4Polygons,
