...
SceneCmd depth_test_room_0Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&depth_test_room_0RoomShapeImageSingle_000030),
    SCENE_CMD_END(),
};
...
RoomShapeImageSingle depth_test_room_0RoomShapeImageSingle_000030 = { 
    { 1, 1, &depth_test_room_0RoomShapeDListsEntry_000050, }, 
...
RoomShapeDListsEntry depth_test_room_0RoomShapeDListsEntry_000050 = { 
