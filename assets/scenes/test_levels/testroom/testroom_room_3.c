...
SceneCmd testroom_room_3Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&testroom_room_3RoomShapeNormal_000050),
...
RoomShapeNormal testroom_room_3RoomShapeNormal_000050 = { 
    0, 1,
    testroom_room_3RoomShapeDListsEntry_00005C,
    testroom_room_3RoomShapeDListsEntry_00005C + ARRAY_COUNTU(testroom_room_3RoomShapeDListsEntry_00005C)
};

RoomShapeDListsEntry testroom_room_3RoomShapeDListsEntry_00005C[1] = {
