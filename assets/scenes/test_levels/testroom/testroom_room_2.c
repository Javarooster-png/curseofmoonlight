...
SceneCmd testroom_room_2Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&testroom_room_2RoomShapeNormal_000110),
    SCENE_CMD_OBJECT_LIST(4, testroom_room_2ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(12, testroom_room_2ActorEntry_000048),
    SCENE_CMD_END(),
};
...
ActorEntry testroom_room_2ActorEntry_000048[] = {
    { ACTOR_EN_YUKABYUN, {   2580,     -8,    160 }, {      0,      0,      0 }, 0xFFFF },
    { ACTOR_EN_YUKABYUN, {   2980,     -8,    160 }, {      0,      0,      0 }, 0xFFFF },
    { ACTOR_EN_YUKABYUN, {   2580,     -8,    360 }, {      0,      0,      0 }, 0xFFFF },
    { ACTOR_EN_YUKABYUN, {   2980,     -8,    360 }, {      0,      0,      0 }, 0xFFFF },
    { ACTOR_EN_YUKABYUN, {   2780,     -8,    360 }, {      0,      0,      0 }, 0xFFFF },
    { ACTOR_EN_YUKABYUN, {   2780,     -8,    560 }, {      0,      0,      0 }, 0xFFFF },
    { ACTOR_EN_YUKABYUN, {   2980,     -8,    560 }, {      0,      0,      0 }, 0xFFFF },
    { ACTOR_EN_YUKABYUN, {   2580,     -8,    560 }, {      0,      0,      0 }, 0xFFFF },
...
RoomShapeNormal testroom_room_2RoomShapeNormal_000110 = { 
    0, 1,
    testroom_room_2RoomShapeDListsEntry_00011C,
    testroom_room_2RoomShapeDListsEntry_00011C + ARRAY_COUNTU(testroom_room_2RoomShapeDListsEntry_00011C)
};

RoomShapeDListsEntry testroom_room_2RoomShapeDListsEntry_00011C[1] = {
