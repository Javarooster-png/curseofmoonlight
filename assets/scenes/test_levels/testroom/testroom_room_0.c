...
SceneCmd testroom_room_0Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&testroom_room_0RoomShapeNormal_0001E0),
    SCENE_CMD_OBJECT_LIST(13, testroom_room_0ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(24, testroom_room_0ActorEntry_00005C),
    SCENE_CMD_END(),
};
...
ActorEntry testroom_room_0ActorEntry_00005C[] = {
...
RoomShapeNormal testroom_room_0RoomShapeNormal_0001E0 = { 
    0, 1,
    testroom_room_0RoomShapeDListsEntry_0001EC,
    testroom_room_0RoomShapeDListsEntry_0001EC + ARRAY_COUNTU(testroom_room_0RoomShapeDListsEntry_0001EC)
};

RoomShapeDListsEntry testroom_room_0RoomShapeDListsEntry_0001EC[1] = {
