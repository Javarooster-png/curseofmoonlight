...
SceneCmd sutaru_room_0Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&sutaru_room_0RoomShapeNormal_0000A0),
    SCENE_CMD_OBJECT_LIST(8, sutaru_room_0ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(1, sutaru_room_0ActorEntry_000050),
    SCENE_CMD_END(),
};
...
ActorEntry sutaru_room_0ActorEntry_000050[] = {
    { ACTOR_EN_TORCH2, {    119,    827,  -3240 }, {      0,      0,      0 }, 0xFFFF },
};

u8 sutaru_room_0_unaccounted_000060[] = {
    0x00, 0x69, 0xFF, 0xE9, 0x03, 0x3B, 0xF2, 0xCB, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x05, 0xFB, 
    0x00, 0x02, 0xFF, 0xE9, 0x03, 0x3B, 0xF2, 0xC1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 
    0x00, 0x02, 0xFF, 0xA7, 0x03, 0x3B, 0xF3, 0xDB, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 
    0x00, 0x5D, 0x00, 0x77, 0x03, 0x3B, 0xF3, 0x58, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 
};

RoomShapeNormal sutaru_room_0RoomShapeNormal_0000A0 = { 
    0, 1,
    sutaru_room_0RoomShapeDListsEntry_0000AC,
    sutaru_room_0RoomShapeDListsEntry_0000AC + ARRAY_COUNTU(sutaru_room_0RoomShapeDListsEntry_0000AC)
};

RoomShapeDListsEntry sutaru_room_0RoomShapeDListsEntry_0000AC[1] = {
