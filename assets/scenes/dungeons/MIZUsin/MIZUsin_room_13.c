...
SceneCmd MIZUsin_room_13Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&MIZUsin_room_13RoomShapeCullable_000060),
    SCENE_CMD_OBJECT_LIST(5, MIZUsin_room_13ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(1, MIZUsin_room_13ActorEntry_00004C),
    SCENE_CMD_END(),
};
...
ActorEntry MIZUsin_room_13ActorEntry_00004C[] = {
...
RoomShapeCullable MIZUsin_room_13RoomShapeCullable_000060 = { 
    2, 1,
    MIZUsin_room_13RoomShapeCullableEntry_00006C,
    MIZUsin_room_13RoomShapeCullableEntry_00006C + ARRAY_COUNTU(MIZUsin_room_13RoomShapeCullableEntry_00006C)
};

RoomShapeCullableEntry MIZUsin_room_13RoomShapeCullableEntry_00006C[1] = {
