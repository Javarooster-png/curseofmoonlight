...
SceneCmd MIZUsin_room_10Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&MIZUsin_room_10RoomShapeCullable_000190),
    SCENE_CMD_OBJECT_LIST(7, MIZUsin_room_10ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(20, MIZUsin_room_10ActorEntry_000050),
    SCENE_CMD_END(),
};
...
ActorEntry MIZUsin_room_10ActorEntry_000050[] = {
...
RoomShapeCullable MIZUsin_room_10RoomShapeCullable_000190 = { 
    2, 8,
    MIZUsin_room_10RoomShapeCullableEntry_00019C,
    MIZUsin_room_10RoomShapeCullableEntry_00019C + ARRAY_COUNTU(MIZUsin_room_10RoomShapeCullableEntry_00019C)
};

RoomShapeCullableEntry MIZUsin_room_10RoomShapeCullableEntry_00019C[8] = {
