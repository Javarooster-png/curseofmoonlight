...
SceneCmd MIZUsin_room_4Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&MIZUsin_room_4RoomShapeCullable_000150),
    SCENE_CMD_OBJECT_LIST(5, MIZUsin_room_4ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(16, MIZUsin_room_4ActorEntry_00004C),
    SCENE_CMD_END(),
};
...
ActorEntry MIZUsin_room_4ActorEntry_00004C[] = {
...
RoomShapeCullable MIZUsin_room_4RoomShapeCullable_000150 = { 
    2, 5,
    MIZUsin_room_4RoomShapeCullableEntry_00015C,
    MIZUsin_room_4RoomShapeCullableEntry_00015C + ARRAY_COUNTU(MIZUsin_room_4RoomShapeCullableEntry_00015C)
};

RoomShapeCullableEntry MIZUsin_room_4RoomShapeCullableEntry_00015C[5] = {
