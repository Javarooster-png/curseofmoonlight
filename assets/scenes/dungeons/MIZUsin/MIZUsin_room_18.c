...
SceneCmd MIZUsin_room_18Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&MIZUsin_room_18RoomShapeCullable_0000F0),
    SCENE_CMD_OBJECT_LIST(5, MIZUsin_room_18ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(10, MIZUsin_room_18ActorEntry_00004C),
    SCENE_CMD_END(),
};
...
ActorEntry MIZUsin_room_18ActorEntry_00004C[] = {
...
RoomShapeCullable MIZUsin_room_18RoomShapeCullable_0000F0 = { 
    2, 7,
    MIZUsin_room_18RoomShapeCullableEntry_0000FC,
    MIZUsin_room_18RoomShapeCullableEntry_0000FC + ARRAY_COUNTU(MIZUsin_room_18RoomShapeCullableEntry_0000FC)
};

RoomShapeCullableEntry MIZUsin_room_18RoomShapeCullableEntry_0000FC[7] = {
