...
SceneCmd MIZUsin_room_3Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&MIZUsin_room_3RoomShapeCullable_000200),
    SCENE_CMD_OBJECT_LIST(8, MIZUsin_room_3ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(27, MIZUsin_room_3ActorEntry_000050),
    SCENE_CMD_END(),
};
...
ActorEntry MIZUsin_room_3ActorEntry_000050[] = {
...
RoomShapeCullable MIZUsin_room_3RoomShapeCullable_000200 = { 
    2, 8,
    MIZUsin_room_3RoomShapeCullableEntry_00020C,
    MIZUsin_room_3RoomShapeCullableEntry_00020C + ARRAY_COUNTU(MIZUsin_room_3RoomShapeCullableEntry_00020C)
};

RoomShapeCullableEntry MIZUsin_room_3RoomShapeCullableEntry_00020C[8] = {
