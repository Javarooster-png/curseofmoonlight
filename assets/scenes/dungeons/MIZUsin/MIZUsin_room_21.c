...
SceneCmd MIZUsin_room_21Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&MIZUsin_room_21RoomShapeCullable_000190),
    SCENE_CMD_OBJECT_LIST(5, MIZUsin_room_21ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(20, MIZUsin_room_21ActorEntry_00004C),
    SCENE_CMD_END(),
};
...
ActorEntry MIZUsin_room_21ActorEntry_00004C[] = {
...
RoomShapeCullable MIZUsin_room_21RoomShapeCullable_000190 = { 
    2, 7,
    MIZUsin_room_21RoomShapeCullableEntry_00019C,
    MIZUsin_room_21RoomShapeCullableEntry_00019C + ARRAY_COUNTU(MIZUsin_room_21RoomShapeCullableEntry_00019C)
};

RoomShapeCullableEntry MIZUsin_room_21RoomShapeCullableEntry_00019C[7] = {
