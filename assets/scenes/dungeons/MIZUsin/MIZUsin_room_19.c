...
SceneCmd MIZUsin_room_19Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&MIZUsin_room_19RoomShapeCullable_0000B0),
    SCENE_CMD_OBJECT_LIST(4, MIZUsin_room_19ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(6, MIZUsin_room_19ActorEntry_000048),
    SCENE_CMD_END(),
};
...
ActorEntry MIZUsin_room_19ActorEntry_000048[] = {
...
RoomShapeCullable MIZUsin_room_19RoomShapeCullable_0000B0 = { 
    2, 1,
    MIZUsin_room_19RoomShapeCullableEntry_0000BC,
    MIZUsin_room_19RoomShapeCullableEntry_0000BC + ARRAY_COUNTU(MIZUsin_room_19RoomShapeCullableEntry_0000BC)
};

RoomShapeCullableEntry MIZUsin_room_19RoomShapeCullableEntry_0000BC[1] = {
