...
SceneCmd MIZUsin_room_16Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&MIZUsin_room_16RoomShapeCullable_0000F0),
    SCENE_CMD_OBJECT_LIST(5, MIZUsin_room_16ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(10, MIZUsin_room_16ActorEntry_00004C),
    SCENE_CMD_END(),
};
...
ActorEntry MIZUsin_room_16ActorEntry_00004C[] = {
...
RoomShapeCullable MIZUsin_room_16RoomShapeCullable_0000F0 = { 
    2, 1,
    MIZUsin_room_16RoomShapeCullableEntry_0000FC,
    MIZUsin_room_16RoomShapeCullableEntry_0000FC + ARRAY_COUNTU(MIZUsin_room_16RoomShapeCullableEntry_0000FC)
};

RoomShapeCullableEntry MIZUsin_room_16RoomShapeCullableEntry_0000FC[1] = {
