...
SceneCmd ganontika_room_16Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&ganontika_room_16RoomShapeCullable_0000B0),
    SCENE_CMD_OBJECT_LIST(5, ganontika_room_16ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(6, ganontika_room_16ActorEntry_00004C),
    SCENE_CMD_END(),
};
...
ActorEntry ganontika_room_16ActorEntry_00004C[] = {
...
RoomShapeCullable ganontika_room_16RoomShapeCullable_0000B0 = { 
    2, 3,
    ganontika_room_16RoomShapeCullableEntry_0000BC,
    ganontika_room_16RoomShapeCullableEntry_0000BC + ARRAY_COUNTU(ganontika_room_16RoomShapeCullableEntry_0000BC)
};

RoomShapeCullableEntry ganontika_room_16RoomShapeCullableEntry_0000BC[3] = {
