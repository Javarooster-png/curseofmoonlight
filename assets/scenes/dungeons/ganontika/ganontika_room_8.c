...
SceneCmd ganontika_room_8Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&ganontika_room_8RoomShapeCullable_0000C0),
    SCENE_CMD_OBJECT_LIST(6, ganontika_room_8ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(7, ganontika_room_8ActorEntry_00004C),
    SCENE_CMD_END(),
};
...
ActorEntry ganontika_room_8ActorEntry_00004C[] = {
...
RoomShapeCullable ganontika_room_8RoomShapeCullable_0000C0 = { 
    2, 4,
    ganontika_room_8RoomShapeCullableEntry_0000CC,
    ganontika_room_8RoomShapeCullableEntry_0000CC + ARRAY_COUNTU(ganontika_room_8RoomShapeCullableEntry_0000CC)
};

RoomShapeCullableEntry ganontika_room_8RoomShapeCullableEntry_0000CC[4] = {
