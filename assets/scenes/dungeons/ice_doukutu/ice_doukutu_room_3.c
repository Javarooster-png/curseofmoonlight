...
SceneCmd ice_doukutu_room_3Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&ice_doukutu_room_3RoomShapeNormal_0001B0),
    SCENE_CMD_OBJECT_LIST(13, ice_doukutu_room_3ObjectList_000058),
    SCENE_CMD_ACTOR_LIST(19, ice_doukutu_room_3ActorEntry_000074),
    SCENE_CMD_END(),
};
...
ActorEntry ice_doukutu_room_3ActorEntry_000074[] = {
...
RoomShapeNormal ice_doukutu_room_3RoomShapeNormal_0001B0 = { 
    0, 1,
    ice_doukutu_room_3RoomShapeDListsEntry_0001BC,
    ice_doukutu_room_3RoomShapeDListsEntry_0001BC + ARRAY_COUNTU(ice_doukutu_room_3RoomShapeDListsEntry_0001BC)
};

RoomShapeDListsEntry ice_doukutu_room_3RoomShapeDListsEntry_0001BC[1] = {
...
SceneCmd ice_doukutu_room_3Set_0001D0[] = {
    ...
    SCENE_CMD_ACTOR_LIST(5, ice_doukutu_room_3ActorEntry_000218),
    SCENE_CMD_END(),
};
...
ActorEntry ice_doukutu_room_3ActorEntry_000218[] = {
