...
SceneCmd ice_doukutu_room_1Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&ice_doukutu_room_1RoomShapeNormal_000140),
    SCENE_CMD_OBJECT_LIST(13, ice_doukutu_room_1ObjectList_000058),
    SCENE_CMD_ACTOR_LIST(12, ice_doukutu_room_1ActorEntry_000074),
    SCENE_CMD_END(),
};
...
ActorEntry ice_doukutu_room_1ActorEntry_000074[] = {
...
RoomShapeNormal ice_doukutu_room_1RoomShapeNormal_000140 = { 
    0, 1,
    ice_doukutu_room_1RoomShapeDListsEntry_00014C,
    ice_doukutu_room_1RoomShapeDListsEntry_00014C + ARRAY_COUNTU(ice_doukutu_room_1RoomShapeDListsEntry_00014C)
};

RoomShapeDListsEntry ice_doukutu_room_1RoomShapeDListsEntry_00014C[1] = {
