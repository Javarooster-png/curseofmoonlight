...
SceneCmd HAKAdan_bs_room_0Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&HAKAdan_bs_room_0RoomShapeNormal_0000B0),
    SCENE_CMD_OBJECT_LIST(6, HAKAdan_bs_room_0ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(6, HAKAdan_bs_room_0ActorEntry_00004C),
    SCENE_CMD_END(),
};
...
ActorEntry HAKAdan_bs_room_0ActorEntry_00004C[] = {
...
RoomShapeNormal HAKAdan_bs_room_0RoomShapeNormal_0000B0 = { 
    0, 1,
    HAKAdan_bs_room_0RoomShapeDListsEntry_0000BC,
    HAKAdan_bs_room_0RoomShapeDListsEntry_0000BC + ARRAY_COUNTU(HAKAdan_bs_room_0RoomShapeDListsEntry_0000BC)
};

RoomShapeDListsEntry HAKAdan_bs_room_0RoomShapeDListsEntry_0000BC[1] = {
