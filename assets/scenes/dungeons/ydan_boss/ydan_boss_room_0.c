...
SceneCmd ydan_boss_room_0Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&ydan_boss_room_0RoomShapeNormal_000050),
...
RoomShapeNormal ydan_boss_room_0RoomShapeNormal_000050 = { 
    0, 1,
    ydan_boss_room_0RoomShapeDListsEntry_00005C,
    ydan_boss_room_0RoomShapeDListsEntry_00005C + ARRAY_COUNTU(ydan_boss_room_0RoomShapeDListsEntry_00005C)
};

RoomShapeDListsEntry ydan_boss_room_0RoomShapeDListsEntry_00005C[1] = {
