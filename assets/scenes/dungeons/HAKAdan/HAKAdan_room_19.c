...
SceneCmd HAKAdan_room_19Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&HAKAdan_room_19RoomShapeCullable_0000D0),
    SCENE_CMD_OBJECT_LIST(7, HAKAdan_room_19ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(8, HAKAdan_room_19ActorEntry_000050),
    SCENE_CMD_END(),
};
...
ActorEntry HAKAdan_room_19ActorEntry_000050[] = {
...
RoomShapeCullable HAKAdan_room_19RoomShapeCullable_0000D0 = { 
    2, 4,
    HAKAdan_room_19RoomShapeCullableEntry_0000DC,
    HAKAdan_room_19RoomShapeCullableEntry_0000DC + ARRAY_COUNTU(HAKAdan_room_19RoomShapeCullableEntry_0000DC)
};

RoomShapeCullableEntry HAKAdan_room_19RoomShapeCullableEntry_0000DC[4] = {
