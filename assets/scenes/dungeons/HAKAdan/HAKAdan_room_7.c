...
SceneCmd HAKAdan_room_7Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&HAKAdan_room_7RoomShapeCullable_0000B0),
    SCENE_CMD_OBJECT_LIST(6, HAKAdan_room_7ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(6, HAKAdan_room_7ActorEntry_00004C),
    SCENE_CMD_END(),
};
...
ActorEntry HAKAdan_room_7ActorEntry_00004C[] = {
...
RoomShapeCullable HAKAdan_room_7RoomShapeCullable_0000B0 = { 
    2, 3,
    HAKAdan_room_7RoomShapeCullableEntry_0000BC,
    HAKAdan_room_7RoomShapeCullableEntry_0000BC + ARRAY_COUNTU(HAKAdan_room_7RoomShapeCullableEntry_0000BC)
};

RoomShapeCullableEntry HAKAdan_room_7RoomShapeCullableEntry_0000BC[3] = {
