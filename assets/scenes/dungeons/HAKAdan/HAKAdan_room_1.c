...
SceneCmd HAKAdan_room_1Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&HAKAdan_room_1RoomShapeCullable_0000C0),
    SCENE_CMD_OBJECT_LIST(7, HAKAdan_room_1ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(7, HAKAdan_room_1ActorEntry_000050),
    SCENE_CMD_END(),
};
...
ActorEntry HAKAdan_room_1ActorEntry_000050[] = {
...
RoomShapeCullable HAKAdan_room_1RoomShapeCullable_0000C0 = { 
    2, 3,
    HAKAdan_room_1RoomShapeCullableEntry_0000CC,
    HAKAdan_room_1RoomShapeCullableEntry_0000CC + ARRAY_COUNTU(HAKAdan_room_1RoomShapeCullableEntry_0000CC)
};

RoomShapeCullableEntry HAKAdan_room_1RoomShapeCullableEntry_0000CC[3] = {
