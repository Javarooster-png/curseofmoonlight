...
SceneCmd HAKAdan_room_3Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&HAKAdan_room_3RoomShapeCullable_000070),
    SCENE_CMD_OBJECT_LIST(8, HAKAdan_room_3ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(2, HAKAdan_room_3ActorEntry_000050),
    SCENE_CMD_END(),
};
...
ActorEntry HAKAdan_room_3ActorEntry_000050[] = {
    { ACTOR_EN_SW,          {  -3095,  -1401,    527 }, { 0X4000,      0,      0 }, 0x8804 },
    { ACTOR_BG_HAKA_MEGANE, {  -2742,  -1363,    309 }, {      0,      0,      0 }, 0x0005 },
};

RoomShapeCullable HAKAdan_room_3RoomShapeCullable_000070 = { 
    2, 4,
    HAKAdan_room_3RoomShapeCullableEntry_00007C,
    HAKAdan_room_3RoomShapeCullableEntry_00007C + ARRAY_COUNTU(HAKAdan_room_3RoomShapeCullableEntry_00007C)
};

RoomShapeCullableEntry HAKAdan_room_3RoomShapeCullableEntry_00007C[4] = {
