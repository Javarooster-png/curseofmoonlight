...
SceneCmd HAKAdan_room_22Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&HAKAdan_room_22RoomShapeCullable_000050),
...
RoomShapeCullable HAKAdan_room_22RoomShapeCullable_000050 = { 
    2, 1,
    HAKAdan_room_22RoomShapeCullableEntry_00005C,
    HAKAdan_room_22RoomShapeCullableEntry_00005C + ARRAY_COUNTU(HAKAdan_room_22RoomShapeCullableEntry_00005C)
};

RoomShapeCullableEntry HAKAdan_room_22RoomShapeCullableEntry_00005C[1] = {
