...
SceneCmd ddan_room_11Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&ddan_room_11RoomShapeCullable_000060),
    SCENE_CMD_OBJECT_LIST(2, ddan_room_11ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(1, ddan_room_11ActorEntry_000044),
    SCENE_CMD_END(),
};
...
ActorEntry ddan_room_11ActorEntry_000044[] = {
...
RoomShapeCullable ddan_room_11RoomShapeCullable_000060 = { 
    2, 1,
    ddan_room_11RoomShapeCullableEntry_00006C,
    ddan_room_11RoomShapeCullableEntry_00006C + ARRAY_COUNTU(ddan_room_11RoomShapeCullableEntry_00006C)
};

RoomShapeCullableEntry ddan_room_11RoomShapeCullableEntry_00006C[1] = {
