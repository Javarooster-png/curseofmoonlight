...
SceneCmd ddan_room_10Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&ddan_room_10RoomShapeCullable_0001A0),
    SCENE_CMD_OBJECT_LIST(15, ddan_room_10ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(20, ddan_room_10ActorEntry_000060),
    SCENE_CMD_END(),
};
...
ActorEntry ddan_room_10ActorEntry_000060[] = {
...
RoomShapeCullable ddan_room_10RoomShapeCullable_0001A0 = { 
    2, 1,
    ddan_room_10RoomShapeCullableEntry_0001AC,
    ddan_room_10RoomShapeCullableEntry_0001AC + ARRAY_COUNTU(ddan_room_10RoomShapeCullableEntry_0001AC)
};

RoomShapeCullableEntry ddan_room_10RoomShapeCullableEntry_0001AC[1] = {
