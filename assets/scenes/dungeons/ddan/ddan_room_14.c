...
SceneCmd ddan_room_14Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&ddan_room_14RoomShapeCullable_0000B0),
    SCENE_CMD_OBJECT_LIST(5, ddan_room_14ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(6, ddan_room_14ActorEntry_00004C),
    SCENE_CMD_END(),
};
...
ActorEntry ddan_room_14ActorEntry_00004C[] = {
...
RoomShapeCullable ddan_room_14RoomShapeCullable_0000B0 = { 
    2, 1,
    ddan_room_14RoomShapeCullableEntry_0000BC,
    ddan_room_14RoomShapeCullableEntry_0000BC + ARRAY_COUNTU(ddan_room_14RoomShapeCullableEntry_0000BC)
};

RoomShapeCullableEntry ddan_room_14RoomShapeCullableEntry_0000BC[1] = {
