...
SceneCmd FIRE_bs_room_0Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&FIRE_bs_room_0RoomShapeNormal_000050),
...
RoomShapeNormal FIRE_bs_room_0RoomShapeNormal_000050 = { 
    0, 1,
    FIRE_bs_room_0RoomShapeDListsEntry_00005C,
    FIRE_bs_room_0RoomShapeDListsEntry_00005C + ARRAY_COUNTU(FIRE_bs_room_0RoomShapeDListsEntry_00005C)
};

RoomShapeDListsEntry FIRE_bs_room_0RoomShapeDListsEntry_00005C[1] = {
