...
SceneCmd FIRE_bs_room_1Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&FIRE_bs_room_1RoomShapeNormal_000070),
    SCENE_CMD_OBJECT_LIST(7, FIRE_bs_room_1ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(2, FIRE_bs_room_1ActorEntry_000050),
    SCENE_CMD_END(),
};
...
ActorEntry FIRE_bs_room_1ActorEntry_000050[] = {
    { ACTOR_EN_RIVER_SOUND, {     -4,   -100,      5 }, {      0,      0,      0 }, 0x0007 },
    { ACTOR_BOSS_FD,        {     -2,     90,     11 }, {      0,      0,      0 }, 0xFFFF },
};

RoomShapeNormal FIRE_bs_room_1RoomShapeNormal_000070 = { 
    0, 1,
    FIRE_bs_room_1RoomShapeDListsEntry_00007C,
    FIRE_bs_room_1RoomShapeDListsEntry_00007C + ARRAY_COUNTU(FIRE_bs_room_1RoomShapeDListsEntry_00007C)
};

RoomShapeDListsEntry FIRE_bs_room_1RoomShapeDListsEntry_00007C[1] = {
