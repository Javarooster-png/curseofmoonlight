...
SceneCmd ydan_room_8Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&ydan_room_8RoomShapeCullable_000110),
    SCENE_CMD_OBJECT_LIST(10, ydan_room_8ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(11, ydan_room_8ActorEntry_000054),
    SCENE_CMD_END(),
};
...
ActorEntry ydan_room_8ActorEntry_000054[] = {
...
RoomShapeCullable ydan_room_8RoomShapeCullable_000110 = { 
    2, 1,
    ydan_room_8RoomShapeCullableEntry_00011C,
    ydan_room_8RoomShapeCullableEntry_00011C + ARRAY_COUNTU(ydan_room_8RoomShapeCullableEntry_00011C)
};

RoomShapeCullableEntry ydan_room_8RoomShapeCullableEntry_00011C[1] = {
