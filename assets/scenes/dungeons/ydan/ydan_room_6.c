...
SceneCmd ydan_room_6Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&ydan_room_6RoomShapeCullable_000120),
    SCENE_CMD_OBJECT_LIST(11, ydan_room_6ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(12, ydan_room_6ActorEntry_000058),
    SCENE_CMD_END(),
};
...
ActorEntry ydan_room_6ActorEntry_000058[] = {
...
RoomShapeCullable ydan_room_6RoomShapeCullable_000120 = { 
    2, 1,
    ydan_room_6RoomShapeCullableEntry_00012C,
    ydan_room_6RoomShapeCullableEntry_00012C + ARRAY_COUNTU(ydan_room_6RoomShapeCullableEntry_00012C)
};

RoomShapeCullableEntry ydan_room_6RoomShapeCullableEntry_00012C[1] = {
