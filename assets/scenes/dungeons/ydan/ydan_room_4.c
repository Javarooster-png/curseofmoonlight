...
SceneCmd ydan_room_4Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&ydan_room_4RoomShapeCullable_000120),
    SCENE_CMD_OBJECT_LIST(10, ydan_room_4ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(12, ydan_room_4ActorEntry_000054),
    SCENE_CMD_END(),
};
...
RoomShapeCullable ydan_room_4RoomShapeCullable_000120 = { 
    2, 2,
    ydan_room_4RoomShapeCullableEntry_00012C,
    ydan_room_4RoomShapeCullableEntry_00012C + ARRAY_COUNTU(ydan_room_4RoomShapeCullableEntry_00012C)
};

RoomShapeCullableEntry ydan_room_4RoomShapeCullableEntry_00012C[2] = {
