...
SceneCmd ydan_room_9Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&ydan_room_9RoomShapeCullable_0000F0),
    SCENE_CMD_OBJECT_LIST(13, ydan_room_9ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(9, ydan_room_9ActorEntry_00005C),
    SCENE_CMD_END(),
};
...
ActorEntry ydan_room_9ActorEntry_00005C[] = {
...
RoomShapeCullable ydan_room_9RoomShapeCullable_0000F0 = { 
    2, 5,
    ydan_room_9RoomShapeCullableEntry_0000FC,
    ydan_room_9RoomShapeCullableEntry_0000FC + ARRAY_COUNTU(ydan_room_9RoomShapeCullableEntry_0000FC)
};

RoomShapeCullableEntry ydan_room_9RoomShapeCullableEntry_0000FC[5] = {
