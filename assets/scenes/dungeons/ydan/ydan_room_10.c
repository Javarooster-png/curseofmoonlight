...
SceneCmd ydan_room_10Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&ydan_room_10RoomShapeCullable_0001B0),
    SCENE_CMD_OBJECT_LIST(10, ydan_room_10ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(21, ydan_room_10ActorEntry_000054),
    SCENE_CMD_END(),
};
...
ActorEntry ydan_room_10ActorEntry_000054[] = {
...
RoomShapeCullable ydan_room_10RoomShapeCullable_0001B0 = { 
    2, 2,
    ydan_room_10RoomShapeCullableEntry_0001BC,
    ydan_room_10RoomShapeCullableEntry_0001BC + ARRAY_COUNTU(ydan_room_10RoomShapeCullableEntry_0001BC)
};

RoomShapeCullableEntry ydan_room_10RoomShapeCullableEntry_0001BC[2] = {
