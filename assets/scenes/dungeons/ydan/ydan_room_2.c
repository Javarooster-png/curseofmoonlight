...
SceneCmd ydan_room_2Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&ydan_room_2RoomShapeCullable_000200),
    SCENE_CMD_OBJECT_LIST(14, ydan_room_2ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(26, ydan_room_2ActorEntry_00005C),
    SCENE_CMD_END(),
};
...
ActorEntry ydan_room_2ActorEntry_00005C[] = {
...
RoomShapeCullable ydan_room_2RoomShapeCullable_000200 = { 
    2, 1,
    ydan_room_2RoomShapeCullableEntry_00020C,
    ydan_room_2RoomShapeCullableEntry_00020C + ARRAY_COUNTU(ydan_room_2RoomShapeCullableEntry_00020C)
};

RoomShapeCullableEntry ydan_room_2RoomShapeCullableEntry_00020C[1] = {
