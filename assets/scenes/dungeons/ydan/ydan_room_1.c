...
SceneCmd ydan_room_1Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&ydan_room_1RoomShapeCullable_000120),
    SCENE_CMD_OBJECT_LIST(10, ydan_room_1ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(12, ydan_room_1ActorEntry_000054),
    SCENE_CMD_END(),
};
...
ActorEntry ydan_room_1ActorEntry_000054[] = {
...
RoomShapeCullable ydan_room_1RoomShapeCullable_000120 = { 
    2, 1,
    ydan_room_1RoomShapeCullableEntry_00012C,
    ydan_room_1RoomShapeCullableEntry_00012C + ARRAY_COUNTU(ydan_room_1RoomShapeCullableEntry_00012C)
};

RoomShapeCullableEntry ydan_room_1RoomShapeCullableEntry_00012C[1] = {
