...
SceneCmd MIZUsin_bs_room_1Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&MIZUsin_bs_room_1RoomShapeNormal_000060),
    SCENE_CMD_OBJECT_LIST(8, MIZUsin_bs_room_1ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(1, MIZUsin_bs_room_1ActorEntry_000050),
    SCENE_CMD_END(),
};
...
ActorEntry MIZUsin_bs_room_1ActorEntry_000050[] = {
    { ACTOR_BOSS_MO, {     20,   -280,     14 }, {      0,      0,      0 }, 0xFFFF },
};

RoomShapeNormal MIZUsin_bs_room_1RoomShapeNormal_000060 = { 
    0, 1,
    MIZUsin_bs_room_1RoomShapeDListsEntry_00006C,
    MIZUsin_bs_room_1RoomShapeDListsEntry_00006C + ARRAY_COUNTU(MIZUsin_bs_room_1RoomShapeDListsEntry_00006C)
};

RoomShapeDListsEntry MIZUsin_bs_room_1RoomShapeDListsEntry_00006C[1] = {
