...
SceneCmd MIZUsin_bs_room_0Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&MIZUsin_bs_room_0RoomShapeNormal_000050),
...
RoomShapeNormal MIZUsin_bs_room_0RoomShapeNormal_000050 = { 
    0, 1,
    MIZUsin_bs_room_0RoomShapeDListsEntry_00005C,
    MIZUsin_bs_room_0RoomShapeDListsEntry_00005C + ARRAY_COUNTU(MIZUsin_bs_room_0RoomShapeDListsEntry_00005C)
};

RoomShapeDListsEntry MIZUsin_bs_room_0RoomShapeDListsEntry_00005C[1] = {
