...
SceneCmd gerudoway_room_4Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&gerudoway_room_4RoomShapeCullable_000110),
    SCENE_CMD_OBJECT_LIST(7, gerudoway_room_4ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(12, gerudoway_room_4ActorEntry_000050),
    SCENE_CMD_END(),
};
...
ActorEntry gerudoway_room_4ActorEntry_000050[] = {
...
RoomShapeCullable gerudoway_room_4RoomShapeCullable_000110 = { 
    2, 6,
    gerudoway_room_4RoomShapeCullableEntry_00011C,
    gerudoway_room_4RoomShapeCullableEntry_00011C + ARRAY_COUNTU(gerudoway_room_4RoomShapeCullableEntry_00011C)
};

RoomShapeCullableEntry gerudoway_room_4RoomShapeCullableEntry_00011C[6] = {
