...
SceneCmd HAKAdanCH_room_5Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&HAKAdanCH_room_5RoomShapeCullable_0000F0),
    SCENE_CMD_OBJECT_LIST(14, HAKAdanCH_room_5ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(9, HAKAdanCH_room_5ActorEntry_00005C),
    SCENE_CMD_END(),
};
...
ActorEntry HAKAdanCH_room_5ActorEntry_00005C[] = {
...
RoomShapeCullable HAKAdanCH_room_5RoomShapeCullable_0000F0 = { 
    2, 5,
    HAKAdanCH_room_5RoomShapeCullableEntry_0000FC,
    HAKAdanCH_room_5RoomShapeCullableEntry_0000FC + ARRAY_COUNTU(HAKAdanCH_room_5RoomShapeCullableEntry_0000FC)
};

RoomShapeCullableEntry HAKAdanCH_room_5RoomShapeCullableEntry_0000FC[5] = {
