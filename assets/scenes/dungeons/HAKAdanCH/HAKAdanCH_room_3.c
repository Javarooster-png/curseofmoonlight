...
SceneCmd HAKAdanCH_room_3Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&HAKAdanCH_room_3RoomShapeCullable_000120),
    SCENE_CMD_OBJECT_LIST(14, HAKAdanCH_room_3ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(12, HAKAdanCH_room_3ActorEntry_00005C),
    SCENE_CMD_END(),
};
...
ActorEntry HAKAdanCH_room_3ActorEntry_00005C[] = {
...
RoomShapeCullable HAKAdanCH_room_3RoomShapeCullable_000120 = { 
    2, 3,
    HAKAdanCH_room_3RoomShapeCullableEntry_00012C,
    HAKAdanCH_room_3RoomShapeCullableEntry_00012C + ARRAY_COUNTU(HAKAdanCH_room_3RoomShapeCullableEntry_00012C)
};

RoomShapeCullableEntry HAKAdanCH_room_3RoomShapeCullableEntry_00012C[3] = {
