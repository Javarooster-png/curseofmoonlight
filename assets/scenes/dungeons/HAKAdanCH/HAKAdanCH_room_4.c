...
SceneCmd HAKAdanCH_room_4Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&HAKAdanCH_room_4RoomShapeCullable_000110),
    SCENE_CMD_OBJECT_LIST(5, HAKAdanCH_room_4ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(12, HAKAdanCH_room_4ActorEntry_00004C),
    SCENE_CMD_END(),
};
...
ActorEntry HAKAdanCH_room_4ActorEntry_00004C[] = {
...
RoomShapeCullable HAKAdanCH_room_4RoomShapeCullable_000110 = { 
    2, 3,
    HAKAdanCH_room_4RoomShapeCullableEntry_00011C,
    HAKAdanCH_room_4RoomShapeCullableEntry_00011C + ARRAY_COUNTU(HAKAdanCH_room_4RoomShapeCullableEntry_00011C)
};

RoomShapeCullableEntry HAKAdanCH_room_4RoomShapeCullableEntry_00011C[3] = {
