...
SceneCmd HAKAdanCH_room_6Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&HAKAdanCH_room_6RoomShapeCullable_0000C0),
    SCENE_CMD_OBJECT_LIST(7, HAKAdanCH_room_6ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(7, HAKAdanCH_room_6ActorEntry_000050),
    SCENE_CMD_END(),
};
...
ActorEntry HAKAdanCH_room_6ActorEntry_000050[] = {
...
RoomShapeCullable HAKAdanCH_room_6RoomShapeCullable_0000C0 = { 
    2, 2,
    HAKAdanCH_room_6RoomShapeCullableEntry_0000CC,
    HAKAdanCH_room_6RoomShapeCullableEntry_0000CC + ARRAY_COUNTU(HAKAdanCH_room_6RoomShapeCullableEntry_0000CC)
};

RoomShapeCullableEntry HAKAdanCH_room_6RoomShapeCullableEntry_0000CC[2] = {
