...
SceneCmd HAKAdanCH_room_2Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&HAKAdanCH_room_2RoomShapeCullable_000110),
    SCENE_CMD_OBJECT_LIST(8, HAKAdanCH_room_2ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(12, HAKAdanCH_room_2ActorEntry_000050),
    SCENE_CMD_END(),
};
...
ActorEntry HAKAdanCH_room_2ActorEntry_000050[] = {
...
RoomShapeCullable HAKAdanCH_room_2RoomShapeCullable_000110 = { 
    2, 3,
    HAKAdanCH_room_2RoomShapeCullableEntry_00011C,
    HAKAdanCH_room_2RoomShapeCullableEntry_00011C + ARRAY_COUNTU(HAKAdanCH_room_2RoomShapeCullableEntry_00011C)
};

RoomShapeCullableEntry HAKAdanCH_room_2RoomShapeCullableEntry_00011C[3] = {
