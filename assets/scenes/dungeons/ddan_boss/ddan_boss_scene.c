...
RomFile ddan_boss_sceneRoomList0x000080[] = {
    { (uintptr_t)_ddan_boss_room_0SegmentRomStart, (uintptr_t)_ddan_boss_room_0SegmentRomEnd },
    { (uintptr_t)_ddan_boss_room_1SegmentRomStart, (uintptr_t)_ddan_boss_room_1SegmentRomEnd },
};

Spawn ddan_boss_sceneEntranceList0x000090[] = {
    { 0x00, 0x01 },
    { 0x00, 0x00 },
};
...
EnvLightSettings ddan_boss_sceneLightSettings0x000098[] = {
...
BgCamInfo ddan_boss_sceneCollisionHeader_000E20CamDataList[] = {
    { 0x0000, 0, NULL },
};

SurfaceType ddan_boss_sceneCollisionHeader_000E20SurfaceType[] = {
    {0x00000100, 0x00003FE0},   {0x00000000, 0x00007FC0},   {0x0000C000, 0x00007FC0},   {0x00000000, 0x00003FC0},
    {0x2400C000, 0x00003FC0},   {0x00006000, 0x00007FC7},   {0x0000C000, 0x00003FC0},
};
...
CollisionHeader ddan_boss_sceneCollisionHeader_000E20 = { 
    { -1490, -1524, -3904 },
    { 620, -144, -1994 },
    ARRAY_COUNT(ddan_boss_sceneCollisionHeader_000E20Vertices), ddan_boss_sceneCollisionHeader_000E20Vertices,
    ARRAY_COUNT(ddan_boss_sceneCollisionHeader_000E20Polygons), ddan_boss_sceneCollisionHeader_000E20Polygons,
