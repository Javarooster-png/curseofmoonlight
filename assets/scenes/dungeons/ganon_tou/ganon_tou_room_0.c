...
SceneCmd ganon_tou_room_0Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&ganon_tou_room_0RoomShapeNormal_000140),
    SCENE_CMD_OBJECT_LIST(8, ganon_tou_room_0ObjectList_000060),
    SCENE_CMD_ACTOR_LIST(13, ganon_tou_room_0ActorEntry_000070),
    SCENE_CMD_END(),
};
...
ActorEntry ganon_tou_room_0ActorEntry_000070[] = {
...
RoomShapeNormal ganon_tou_room_0RoomShapeNormal_000140 = { 
    0, 1,
    ganon_tou_room_0RoomShapeDListsEntry_00014C,
    ganon_tou_room_0RoomShapeDListsEntry_00014C + ARRAY_COUNTU(ganon_tou_room_0RoomShapeDListsEntry_00014C)
};

RoomShapeDListsEntry ganon_tou_room_0RoomShapeDListsEntry_00014C[1] = {
...
SceneCmd ganon_tou_room_0Set_000160[] = {
    ...
    SCENE_CMD_ACTOR_LIST(3, ganon_tou_room_0ActorEntry_0001B4),
    SCENE_CMD_END(),
};
...
ActorEntry ganon_tou_room_0ActorEntry_0001B4[] = {
    { ACTOR_BG_GJYO_BRIDGE, {   -197,   1571,   1037 }, {      0,      0,      0 }, 0xFFFF },
    { ACTOR_DEMO_6K,        {    100,   1358,   1466 }, {      0,      0,      0 }, 0x0000 },
    { ACTOR_DEMO_EFFECT,    {   -335,   1626,    583 }, {      0,      0,      0 }, 0x1012 },
};
