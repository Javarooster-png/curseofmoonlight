...
SceneCmd bdan_room_9Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&bdan_room_9RoomShapeNormal_000080),
    SCENE_CMD_OBJECT_LIST(4, bdan_room_9ObjectList_000058),
    SCENE_CMD_ACTOR_LIST(2, bdan_room_9ActorEntry_000060),
    SCENE_CMD_END(),
};
...
ActorEntry bdan_room_9ActorEntry_000060[] = {
    { ACTOR_OBJ_ROOMTIMER, {   1543,   -340,  -4829 }, {      0,      0,      0 }, 0x2BFF },
    { ACTOR_EN_BA,         {   1561,     20,  -4679 }, {      0, 0XC000,      0 }, 0x0A02 },
};

RoomShapeNormal bdan_room_9RoomShapeNormal_000080 = { 
    0, 1,
    bdan_room_9RoomShapeDListsEntry_00008C,
    bdan_room_9RoomShapeDListsEntry_00008C + ARRAY_COUNTU(bdan_room_9RoomShapeDListsEntry_00008C)
};

RoomShapeDListsEntry bdan_room_9RoomShapeDListsEntry_00008C[1] = {
...
SceneCmd bdan_room_9Set_0000A0[] = {
    ...
    SCENE_CMD_ACTOR_LIST(3, bdan_room_9ActorEntry_0000EC),
    SCENE_CMD_END(),
};
...
ActorEntry bdan_room_9ActorEntry_0000EC[] = {
