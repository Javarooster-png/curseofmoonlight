...
SceneCmd bdan_room_11Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&bdan_room_11RoomShapeNormal_000270),
    SCENE_CMD_OBJECT_LIST(13, bdan_room_11ObjectList_000058),
    SCENE_CMD_ACTOR_LIST(31, bdan_room_11ActorEntry_000074),
    SCENE_CMD_END(),
};
...
ActorEntry bdan_room_11ActorEntry_000074[] = {
...
RoomShapeNormal bdan_room_11RoomShapeNormal_000270 = { 
    0, 1,
    bdan_room_11RoomShapeDListsEntry_00027C,
    bdan_room_11RoomShapeDListsEntry_00027C + ARRAY_COUNTU(bdan_room_11RoomShapeDListsEntry_00027C)
};

RoomShapeDListsEntry bdan_room_11RoomShapeDListsEntry_00027C[1] = {
...
SceneCmd bdan_room_11Set_000290[] = {
    ...
    SCENE_CMD_ACTOR_LIST(2, bdan_room_11ActorEntry_0002D8),
    SCENE_CMD_END(),
};
...
ActorEntry bdan_room_11ActorEntry_0002D8[] = {
