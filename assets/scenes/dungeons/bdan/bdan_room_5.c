...
SceneCmd bdan_room_5Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&bdan_room_5RoomShapeNormal_000160),
    SCENE_CMD_OBJECT_LIST(10, bdan_room_5ObjectList_000058),
    SCENE_CMD_ACTOR_LIST(15, bdan_room_5ActorEntry_00006C),
    SCENE_CMD_END(),
};
...
ActorEntry bdan_room_5ActorEntry_00006C[] = {
...
RoomShapeNormal bdan_room_5RoomShapeNormal_000160 = { 
    0, 1,
    bdan_room_5RoomShapeDListsEntry_00016C,
    bdan_room_5RoomShapeDListsEntry_00016C + ARRAY_COUNTU(bdan_room_5RoomShapeDListsEntry_00016C)
};

RoomShapeDListsEntry bdan_room_5RoomShapeDListsEntry_00016C[1] = {
...
SceneCmd bdan_room_5Set_000180[] = {
    ...
    SCENE_CMD_ACTOR_LIST(4, bdan_room_5ActorEntry_0001C8),
    SCENE_CMD_END(),
};
...
ActorEntry bdan_room_5ActorEntry_0001C8[] = {
