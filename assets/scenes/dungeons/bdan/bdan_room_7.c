...
SceneCmd bdan_room_7Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&bdan_room_7RoomShapeNormal_000130),
    SCENE_CMD_OBJECT_LIST(9, bdan_room_7ObjectList_000058),
    SCENE_CMD_ACTOR_LIST(12, bdan_room_7ActorEntry_00006C),
    SCENE_CMD_END(),
};
...
ActorEntry bdan_room_7ActorEntry_00006C[] = {
...
RoomShapeNormal bdan_room_7RoomShapeNormal_000130 = { 
    0, 1,
    bdan_room_7RoomShapeDListsEntry_00013C,
    bdan_room_7RoomShapeDListsEntry_00013C + ARRAY_COUNTU(bdan_room_7RoomShapeDListsEntry_00013C)
};

RoomShapeDListsEntry bdan_room_7RoomShapeDListsEntry_00013C[1] = {
...
SceneCmd bdan_room_7Set_000150[] = {
    ...
    SCENE_CMD_ACTOR_LIST(7, bdan_room_7ActorEntry_000198),
    SCENE_CMD_END(),
};
...
ActorEntry bdan_room_7ActorEntry_000198[] = {
