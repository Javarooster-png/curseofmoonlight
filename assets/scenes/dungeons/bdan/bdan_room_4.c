...
SceneCmd bdan_room_4Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&bdan_room_4RoomShapeNormal_000150),
    SCENE_CMD_OBJECT_LIST(10, bdan_room_4ObjectList_000058),
    SCENE_CMD_ACTOR_LIST(14, bdan_room_4ActorEntry_00006C),
    SCENE_CMD_END(),
};
...
ActorEntry bdan_room_4ActorEntry_00006C[] = {
...
RoomShapeNormal bdan_room_4RoomShapeNormal_000150 = { 
    0, 1,
    bdan_room_4RoomShapeDListsEntry_00015C,
    bdan_room_4RoomShapeDListsEntry_00015C + ARRAY_COUNTU(bdan_room_4RoomShapeDListsEntry_00015C)
};

RoomShapeDListsEntry bdan_room_4RoomShapeDListsEntry_00015C[1] = {
...
SceneCmd bdan_room_4Set_000170[] = {
    ...
    SCENE_CMD_ACTOR_LIST(3, bdan_room_4ActorEntry_0001B8),
    SCENE_CMD_END(),
};
...
ActorEntry bdan_room_4ActorEntry_0001B8[] = {
