...
SceneCmd bdan_room_10Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&bdan_room_10RoomShapeNormal_000080),
    SCENE_CMD_OBJECT_LIST(3, bdan_room_10ObjectList_000058),
    SCENE_CMD_ACTOR_LIST(2, bdan_room_10ActorEntry_000060),
    SCENE_CMD_END(),
};
...
ActorEntry bdan_room_10ActorEntry_000060[] = {
    { ACTOR_OBJ_ROOMTIMER, {  -1558,     33,  -4664 }, {      0,      0,      0 }, 0x33FF },
    { ACTOR_EN_BA,         {  -1562,     20,  -4683 }, {      0, 0X4000,      0 }, 0x0C01 },
};

RoomShapeNormal bdan_room_10RoomShapeNormal_000080 = { 
    0, 1,
    bdan_room_10RoomShapeDListsEntry_00008C,
    bdan_room_10RoomShapeDListsEntry_00008C + ARRAY_COUNTU(bdan_room_10RoomShapeDListsEntry_00008C)
};

RoomShapeDListsEntry bdan_room_10RoomShapeDListsEntry_00008C[1] = {
...
SceneCmd bdan_room_10Set_0000A0[] = {
    ...
    SCENE_CMD_ACTOR_LIST(2, bdan_room_10ActorEntry_0000EC),
    SCENE_CMD_END(),
};
...
ActorEntry bdan_room_10ActorEntry_0000EC[] = {
