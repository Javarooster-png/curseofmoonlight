...
SceneCmd bdan_room_0Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&bdan_room_0RoomShapeNormal_000190),
    SCENE_CMD_OBJECT_LIST(11, bdan_room_0ObjectList_000058),
    SCENE_CMD_ACTOR_LIST(18, bdan_room_0ActorEntry_000070),
    SCENE_CMD_END(),
};
...
ActorEntry bdan_room_0ActorEntry_000070[] = {
...
RoomShapeNormal bdan_room_0RoomShapeNormal_000190 = { 
    0, 1,
    bdan_room_0RoomShapeDListsEntry_00019C,
    bdan_room_0RoomShapeDListsEntry_00019C + ARRAY_COUNTU(bdan_room_0RoomShapeDListsEntry_00019C)
};

RoomShapeDListsEntry bdan_room_0RoomShapeDListsEntry_00019C[1] = {
...
SceneCmd bdan_room_0Set_0001B0[] = {
    ...
    SCENE_CMD_ACTOR_LIST(5, bdan_room_0ActorEntry_0001F8),
    SCENE_CMD_END(),
};
...
ActorEntry bdan_room_0ActorEntry_0001F8[] = {
