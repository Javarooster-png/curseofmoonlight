...
SceneCmd Bmori1_room_14Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&Bmori1_room_14RoomShapeNormal_000100),
    SCENE_CMD_OBJECT_LIST(9, Bmori1_room_14ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(10, Bmori1_room_14ActorEntry_000054),
    SCENE_CMD_END(),
};
...
ActorEntry Bmori1_room_14ActorEntry_000054[] = {
...
RoomShapeNormal Bmori1_room_14RoomShapeNormal_000100 = { 
    0, 1,
    Bmori1_room_14RoomShapeDListsEntry_00010C,
    Bmori1_room_14RoomShapeDListsEntry_00010C + ARRAY_COUNTU(Bmori1_room_14RoomShapeDListsEntry_00010C)
};

RoomShapeDListsEntry Bmori1_room_14RoomShapeDListsEntry_00010C[1] = {
