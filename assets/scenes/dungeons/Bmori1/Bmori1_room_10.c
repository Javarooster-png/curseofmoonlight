...
SceneCmd Bmori1_room_10Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&Bmori1_room_10RoomShapeNormal_000090),
    SCENE_CMD_OBJECT_LIST(9, Bmori1_room_10ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(3, Bmori1_room_10ActorEntry_000054),
    SCENE_CMD_END(),
};
...
ActorEntry Bmori1_room_10ActorEntry_000054[] = {
...
RoomShapeNormal Bmori1_room_10RoomShapeNormal_000090 = { 
    0, 1,
    Bmori1_room_10RoomShapeDListsEntry_00009C,
    Bmori1_room_10RoomShapeDListsEntry_00009C + ARRAY_COUNTU(Bmori1_room_10RoomShapeDListsEntry_00009C)
};

RoomShapeDListsEntry Bmori1_room_10RoomShapeDListsEntry_00009C[1] = {
