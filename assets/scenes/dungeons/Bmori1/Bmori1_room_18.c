...
SceneCmd Bmori1_room_18Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&Bmori1_room_18RoomShapeNormal_000070),
    SCENE_CMD_OBJECT_LIST(8, Bmori1_room_18ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(2, Bmori1_room_18ActorEntry_000050),
    SCENE_CMD_END(),
};
...
ActorEntry Bmori1_room_18ActorEntry_000050[] = {
    { ACTOR_EN_RD,  {  -1987,    503,  -1842 }, {      0, 0X53E9,      0 }, 0x7F00 },
    { ACTOR_EN_BOX, {  -2060,    503,  -2044 }, {      0, 0XC000,      0 }, 0x7842 },
};

RoomShapeNormal Bmori1_room_18RoomShapeNormal_000070 = { 
    0, 1,
    Bmori1_room_18RoomShapeDListsEntry_00007C,
    Bmori1_room_18RoomShapeDListsEntry_00007C + ARRAY_COUNTU(Bmori1_room_18RoomShapeDListsEntry_00007C)
};

RoomShapeDListsEntry Bmori1_room_18RoomShapeDListsEntry_00007C[1] = {
