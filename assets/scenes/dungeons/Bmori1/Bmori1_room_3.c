...
SceneCmd Bmori1_room_3Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&Bmori1_room_3RoomShapeNormal_000090),
    SCENE_CMD_OBJECT_LIST(6, Bmori1_room_3ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(4, Bmori1_room_3ActorEntry_00004C),
    SCENE_CMD_END(),
};
...
ActorEntry Bmori1_room_3ActorEntry_00004C[] = {
...
RoomShapeNormal Bmori1_room_3RoomShapeNormal_000090 = { 
    0, 1,
    Bmori1_room_3RoomShapeDListsEntry_00009C,
    Bmori1_room_3RoomShapeDListsEntry_00009C + ARRAY_COUNTU(Bmori1_room_3RoomShapeDListsEntry_00009C)
};

RoomShapeDListsEntry Bmori1_room_3RoomShapeDListsEntry_00009C[1] = {
