...
SceneCmd Bmori1_room_20Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&Bmori1_room_20RoomShapeNormal_0000B0),
    SCENE_CMD_OBJECT_LIST(9, Bmori1_room_20ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(5, Bmori1_room_20ActorEntry_000054),
    SCENE_CMD_END(),
};
...
ActorEntry Bmori1_room_20ActorEntry_000054[] = {
...
RoomShapeNormal Bmori1_room_20RoomShapeNormal_0000B0 = { 
    0, 1,
    Bmori1_room_20RoomShapeDListsEntry_0000BC,
    Bmori1_room_20RoomShapeDListsEntry_0000BC + ARRAY_COUNTU(Bmori1_room_20RoomShapeDListsEntry_0000BC)
};

RoomShapeDListsEntry Bmori1_room_20RoomShapeDListsEntry_0000BC[1] = {
