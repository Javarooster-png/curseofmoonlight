...
SceneCmd Bmori1_room_19Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&Bmori1_room_19RoomShapeNormal_0000A0),
    SCENE_CMD_OBJECT_LIST(10, Bmori1_room_19ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(4, Bmori1_room_19ActorEntry_000054),
    SCENE_CMD_END(),
};
...
ActorEntry Bmori1_room_19ActorEntry_000054[] = {
...
RoomShapeNormal Bmori1_room_19RoomShapeNormal_0000A0 = { 
    0, 1,
    Bmori1_room_19RoomShapeDListsEntry_0000AC,
    Bmori1_room_19RoomShapeDListsEntry_0000AC + ARRAY_COUNTU(Bmori1_room_19RoomShapeDListsEntry_0000AC)
};

RoomShapeDListsEntry Bmori1_room_19RoomShapeDListsEntry_0000AC[1] = {
