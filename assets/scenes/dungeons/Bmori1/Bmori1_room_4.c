...
SceneCmd Bmori1_room_4Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&Bmori1_room_4RoomShapeNormal_000070),
    SCENE_CMD_OBJECT_LIST(8, Bmori1_room_4ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(2, Bmori1_room_4ActorEntry_000050),
    SCENE_CMD_END(),
};
...
ActorEntry Bmori1_room_4ActorEntry_000050[] = {
    { ACTOR_ELF_MSG2,      {    120,    520,  -2874 }, {      0,   0X21,    0X1 }, 0x3F05 },
    { ACTOR_OBJ_TIMEBLOCK, {    120,    468,  -2940 }, {      0,      0,      0 }, 0xB820 },
};

RoomShapeNormal Bmori1_room_4RoomShapeNormal_000070 = { 
    0, 1,
    Bmori1_room_4RoomShapeDListsEntry_00007C,
    Bmori1_room_4RoomShapeDListsEntry_00007C + ARRAY_COUNTU(Bmori1_room_4RoomShapeDListsEntry_00007C)
};

RoomShapeDListsEntry Bmori1_room_4RoomShapeDListsEntry_00007C[1] = {
