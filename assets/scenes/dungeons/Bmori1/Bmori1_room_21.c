...
SceneCmd Bmori1_room_21Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&Bmori1_room_21RoomShapeNormal_000070),
    SCENE_CMD_OBJECT_LIST(10, Bmori1_room_21ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(1, Bmori1_room_21ActorEntry_000054),
    SCENE_CMD_END(),
};
...
ActorEntry Bmori1_room_21ActorEntry_000054[] = {
...
RoomShapeNormal Bmori1_room_21RoomShapeNormal_000070 = { 
    0, 1,
    Bmori1_room_21RoomShapeDListsEntry_00007C,
    Bmori1_room_21RoomShapeDListsEntry_00007C + ARRAY_COUNTU(Bmori1_room_21RoomShapeDListsEntry_00007C)
};

RoomShapeDListsEntry Bmori1_room_21RoomShapeDListsEntry_00007C[1] = {
