...
SceneCmd HIDAN_room_19Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&HIDAN_room_19RoomShapeCullable_000150),
    SCENE_CMD_OBJECT_LIST(5, HIDAN_room_19ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(16, HIDAN_room_19ActorEntry_00004C),
    SCENE_CMD_END(),
};
...
ActorEntry HIDAN_room_19ActorEntry_00004C[] = {
...
RoomShapeCullable HIDAN_room_19RoomShapeCullable_000150 = { 
    2, 1,
    HIDAN_room_19RoomShapeCullableEntry_00015C,
    HIDAN_room_19RoomShapeCullableEntry_00015C + ARRAY_COUNTU(HIDAN_room_19RoomShapeCullableEntry_00015C)
};

RoomShapeCullableEntry HIDAN_room_19RoomShapeCullableEntry_00015C[1] = {
