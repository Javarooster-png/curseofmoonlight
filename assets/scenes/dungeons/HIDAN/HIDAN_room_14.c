...
SceneCmd HIDAN_room_14Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&HIDAN_room_14RoomShapeCullable_0000A0),
    SCENE_CMD_OBJECT_LIST(4, HIDAN_room_14ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(5, HIDAN_room_14ActorEntry_000048),
    SCENE_CMD_END(),
};
...
ActorEntry HIDAN_room_14ActorEntry_000048[] = {
...
RoomShapeCullable HIDAN_room_14RoomShapeCullable_0000A0 = { 
    2, 1,
    HIDAN_room_14RoomShapeCullableEntry_0000AC,
    HIDAN_room_14RoomShapeCullableEntry_0000AC + ARRAY_COUNTU(HIDAN_room_14RoomShapeCullableEntry_0000AC)
};

RoomShapeCullableEntry HIDAN_room_14RoomShapeCullableEntry_0000AC[1] = {
