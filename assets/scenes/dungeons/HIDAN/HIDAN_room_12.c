...
SceneCmd HIDAN_room_12Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&HIDAN_room_12RoomShapeCullable_000060),
    SCENE_CMD_OBJECT_LIST(7, HIDAN_room_12ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(1, HIDAN_room_12ActorEntry_000050),
    SCENE_CMD_END(),
};
...
ActorEntry HIDAN_room_12ActorEntry_000050[] = {
    { ACTOR_EN_WONDER_ITEM, {  -2482,   4149,    153 }, {      0,      0,    0X6 }, 0x1AFF },
};

RoomShapeCullable HIDAN_room_12RoomShapeCullable_000060 = { 
    2, 3,
    HIDAN_room_12RoomShapeCullableEntry_00006C,
    HIDAN_room_12RoomShapeCullableEntry_00006C + ARRAY_COUNTU(HIDAN_room_12RoomShapeCullableEntry_00006C)
};

RoomShapeCullableEntry HIDAN_room_12RoomShapeCullableEntry_00006C[3] = {
