...
SceneCmd HIDAN_room_6Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&HIDAN_room_6RoomShapeCullable_000090),
    SCENE_CMD_OBJECT_LIST(6, HIDAN_room_6ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(4, HIDAN_room_6ActorEntry_00004C),
    SCENE_CMD_END(),
};
...
ActorEntry HIDAN_room_6ActorEntry_00004C[] = {
...
RoomShapeCullable HIDAN_room_6RoomShapeCullable_000090 = { 
    2, 3,
    HIDAN_room_6RoomShapeCullableEntry_00009C,
    HIDAN_room_6RoomShapeCullableEntry_00009C + ARRAY_COUNTU(HIDAN_room_6RoomShapeCullableEntry_00009C)
};

RoomShapeCullableEntry HIDAN_room_6RoomShapeCullableEntry_00009C[3] = {
