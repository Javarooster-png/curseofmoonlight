...
SceneCmd HIDAN_room_18Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&HIDAN_room_18RoomShapeCullable_000150),
    SCENE_CMD_OBJECT_LIST(4, HIDAN_room_18ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(16, HIDAN_room_18ActorEntry_000048),
    SCENE_CMD_END(),
};
...
ActorEntry HIDAN_room_18ActorEntry_000048[] = {
...
RoomShapeCullable HIDAN_room_18RoomShapeCullable_000150 = { 
    2, 1,
    HIDAN_room_18RoomShapeCullableEntry_00015C,
    HIDAN_room_18RoomShapeCullableEntry_00015C + ARRAY_COUNTU(HIDAN_room_18RoomShapeCullableEntry_00015C)
};

RoomShapeCullableEntry HIDAN_room_18RoomShapeCullableEntry_00015C[1] = {
