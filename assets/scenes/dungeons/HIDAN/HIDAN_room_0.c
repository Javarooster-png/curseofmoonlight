...
SceneCmd HIDAN_room_0Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&HIDAN_room_0RoomShapeCullable_000100),
    SCENE_CMD_OBJECT_LIST(4, HIDAN_room_0ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(11, HIDAN_room_0ActorEntry_000048),
    SCENE_CMD_END(),
};
...
ActorEntry HIDAN_room_0ActorEntry_000048[] = {
...
RoomShapeCullable HIDAN_room_0RoomShapeCullable_000100 = { 
    2, 1,
    HIDAN_room_0RoomShapeCullableEntry_00010C,
    HIDAN_room_0RoomShapeCullableEntry_00010C + ARRAY_COUNTU(HIDAN_room_0RoomShapeCullableEntry_00010C)
};

RoomShapeCullableEntry HIDAN_room_0RoomShapeCullableEntry_00010C[1] = {
