...
SceneCmd HIDAN_room_25Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&HIDAN_room_25RoomShapeCullable_000090),
    SCENE_CMD_OBJECT_LIST(4, HIDAN_room_25ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(4, HIDAN_room_25ActorEntry_000048),
    SCENE_CMD_END(),
};
...
ActorEntry HIDAN_room_25ActorEntry_000048[] = {
...
RoomShapeCullable HIDAN_room_25RoomShapeCullable_000090 = { 
    2, 1,
    HIDAN_room_25RoomShapeCullableEntry_00009C,
    HIDAN_room_25RoomShapeCullableEntry_00009C + ARRAY_COUNTU(HIDAN_room_25RoomShapeCullableEntry_00009C)
};

RoomShapeCullableEntry HIDAN_room_25RoomShapeCullableEntry_00009C[1] = {
