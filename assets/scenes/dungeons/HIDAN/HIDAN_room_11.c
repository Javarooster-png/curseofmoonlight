...
SceneCmd HIDAN_room_11Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&HIDAN_room_11RoomShapeCullable_000100),
    SCENE_CMD_OBJECT_LIST(7, HIDAN_room_11ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(11, HIDAN_room_11ActorEntry_000050),
    SCENE_CMD_END(),
};
...
ActorEntry HIDAN_room_11ActorEntry_000050[] = {
    ...
    { ACTOR_BG_HIDAN_FIREWALL,     {  -1674,   2980,    140 }, {      0, 0XC000,      0 }, 0x00FF },
    { ACTOR_BG_HIDAN_FIREWALL,     {  -1674,   2980,    280 }, {      0, 0XC000,      0 }, 0x00FF },
    { ACTOR_BG_HIDAN_FWBIG,        {  -1892,   2900,      1 }, {      0, 0XC000,      0 }, 0x00FF },
    { ACTOR_BG_HIDAN_KOWARERUKABE, {  -1562,   2800,     -3 }, {      0, 0XC000,      0 }, 0x0B02 },
    { ACTOR_EN_SW,                 {  -1483,   2844,     -2 }, { 0XC000, 0X4000,      0 }, 0x8508 },
};

RoomShapeCullable HIDAN_room_11RoomShapeCullable_000100 = { 
    2, 3,
    HIDAN_room_11RoomShapeCullableEntry_00010C,
    HIDAN_room_11RoomShapeCullableEntry_00010C + ARRAY_COUNTU(HIDAN_room_11RoomShapeCullableEntry_00010C)
};

RoomShapeCullableEntry HIDAN_room_11RoomShapeCullableEntry_00010C[3] = {
