...
SceneCmd ganon_room_9Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&ganon_room_9RoomShapeNormal_000040),
...
RoomShapeNormal ganon_room_9RoomShapeNormal_000040 = { 
    0, 1,
    ganon_room_9RoomShapeDListsEntry_00004C,
    ganon_room_9RoomShapeDListsEntry_00004C + ARRAY_COUNTU(ganon_room_9RoomShapeDListsEntry_00004C)
};

RoomShapeDListsEntry ganon_room_9RoomShapeDListsEntry_00004C[1] = {
