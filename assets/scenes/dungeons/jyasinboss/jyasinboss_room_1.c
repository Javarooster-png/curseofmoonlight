...
SceneCmd jyasinboss_room_1Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&jyasinboss_room_1RoomShapeNormal_000190),
    SCENE_CMD_OBJECT_LIST(7, jyasinboss_room_1ObjectList_000060),
    SCENE_CMD_ACTOR_LIST(18, jyasinboss_room_1ActorEntry_000070),
    SCENE_CMD_END(),
};
...
ActorEntry jyasinboss_room_1ActorEntry_000070[] = {
...
RoomShapeNormal jyasinboss_room_1RoomShapeNormal_000190 = { 
    0, 1,
    jyasinboss_room_1RoomShapeDListsEntry_00019C,
    jyasinboss_room_1RoomShapeDListsEntry_00019C + ARRAY_COUNTU(jyasinboss_room_1RoomShapeDListsEntry_00019C)
};

RoomShapeDListsEntry jyasinboss_room_1RoomShapeDListsEntry_00019C[1] = {
...
SceneCmd jyasinboss_room_1Set_0001B0[] = {
    ...
    SCENE_CMD_ACTOR_LIST(18, jyasinboss_room_1ActorEntry_0001FC),
    SCENE_CMD_END(),
};
...
ActorEntry jyasinboss_room_1ActorEntry_0001FC[] = {
    { ACTOR_BG_JYA_IRONOBJ, {  -1482,      0,   1652 }, {      0, 0XDF4A,      0 }, 0x0000 },
    { ACTOR_BG_JYA_IRONOBJ, {  -1652,      0,   1482 }, {      0, 0XE0B6,      0 }, 0x0000 },
    { ACTOR_BG_JYA_IRONOBJ, {  -1340,      0,   1510 }, {      0, 0XE0B6,      0 }, 0x0000 },
    { ACTOR_BG_JYA_IRONOBJ, {  -1510,      0,   1340 }, {      0, 0XDF4A,      0 }, 0x0000 },
...
SceneCmd jyasinboss_room_1Set_000320[] = {
    ...
    SCENE_CMD_ACTOR_LIST(18, jyasinboss_room_1ActorEntry_00036C),
    SCENE_CMD_END(),
};
...
ActorEntry jyasinboss_room_1ActorEntry_00036C[] = {
    { ACTOR_BG_JYA_IRONOBJ, {  -1482,      0,   1652 }, {      0, 0XDF4A,      0 }, 0x0000 },
    { ACTOR_BG_JYA_IRONOBJ, {  -1652,      0,   1482 }, {      0, 0XE0B6,      0 }, 0x0000 },
    { ACTOR_BG_JYA_IRONOBJ, {  -1340,      0,   1510 }, {      0, 0XE0B6,      0 }, 0x0000 },
    { ACTOR_BG_JYA_IRONOBJ, {  -1510,      0,   1340 }, {      0, 0XDF4A,      0 }, 0x0000 },
...
SceneCmd jyasinboss_room_1Set_000490[] = {
    ...
    SCENE_CMD_ACTOR_LIST(10, jyasinboss_room_1ActorEntry_0004DC),
    SCENE_CMD_END(),
};
...
ActorEntry jyasinboss_room_1ActorEntry_0004DC[] = {
    { ACTOR_EN_NB,          {  -1212,     16,   1210 }, {      0, 0XE000,      0 }, 0x0004 },
    { ACTOR_EN_TR,          {  -1303,      0,   1136 }, {      0, 0XE000,      0 }, 0x0000 },
    { ACTOR_EN_TR,          {  -1125,      0,   1301 }, {      0, 0XE000,      0 }, 0x0001 },
    { ACTOR_BG_JYA_IRONOBJ, {  -1482,      0,   1652 }, {      0, 0XDF4A,      0 }, 0x0000 },
