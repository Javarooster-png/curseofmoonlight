...
SceneCmd jyasinboss_room_0Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&jyasinboss_room_0RoomShapeNormal_000060),
...
RoomShapeNormal jyasinboss_room_0RoomShapeNormal_000060 = { 
    0, 1,
    jyasinboss_room_0RoomShapeDListsEntry_00006C,
    jyasinboss_room_0RoomShapeDListsEntry_00006C + ARRAY_COUNTU(jyasinboss_room_0RoomShapeDListsEntry_00006C)
};

RoomShapeDListsEntry jyasinboss_room_0RoomShapeDListsEntry_00006C[1] = {
