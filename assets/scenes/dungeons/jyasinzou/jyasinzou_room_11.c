...
SceneCmd jyasinzou_room_11Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&jyasinzou_room_11RoomShapeCullable_000040),
...
RoomShapeCullable jyasinzou_room_11RoomShapeCullable_000040 = { 
    2, 2,
    jyasinzou_room_11RoomShapeCullableEntry_00004C,
    jyasinzou_room_11RoomShapeCullableEntry_00004C + ARRAY_COUNTU(jyasinzou_room_11RoomShapeCullableEntry_00004C)
};

RoomShapeCullableEntry jyasinzou_room_11RoomShapeCullableEntry_00004C[2] = {
