...
SceneCmd jyasinzou_room_3Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&jyasinzou_room_3RoomShapeCullable_000140),
    SCENE_CMD_OBJECT_LIST(8, jyasinzou_room_3ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(15, jyasinzou_room_3ActorEntry_000050),
    SCENE_CMD_END(),
};
...
ActorEntry jyasinzou_room_3ActorEntry_000050[] = {
...
RoomShapeCullable jyasinzou_room_3RoomShapeCullable_000140 = { 
    2, 4,
    jyasinzou_room_3RoomShapeCullableEntry_00014C,
    jyasinzou_room_3RoomShapeCullableEntry_00014C + ARRAY_COUNTU(jyasinzou_room_3RoomShapeCullableEntry_00014C)
};

RoomShapeCullableEntry jyasinzou_room_3RoomShapeCullableEntry_00014C[4] = {
