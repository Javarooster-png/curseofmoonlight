...
SceneCmd jyasinzou_room_12Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&jyasinzou_room_12RoomShapeCullable_000100),
    SCENE_CMD_OBJECT_LIST(6, jyasinzou_room_12ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(11, jyasinzou_room_12ActorEntry_00004C),
    SCENE_CMD_END(),
};
...
ActorEntry jyasinzou_room_12ActorEntry_00004C[] = {
...
RoomShapeCullable jyasinzou_room_12RoomShapeCullable_000100 = { 
    2, 3,
    jyasinzou_room_12RoomShapeCullableEntry_00010C,
    jyasinzou_room_12RoomShapeCullableEntry_00010C + ARRAY_COUNTU(jyasinzou_room_12RoomShapeCullableEntry_00010C)
};

RoomShapeCullableEntry jyasinzou_room_12RoomShapeCullableEntry_00010C[3] = {
