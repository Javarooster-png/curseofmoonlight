...
RomFile drag_sceneRoomList0x000088[] = {
    { (uintptr_t)_drag_room_0SegmentRomStart, (uintptr_t)_drag_room_0SegmentRomEnd },
};

Spawn drag_sceneEntranceList0x000090[] = {
    { 0x00, 0x00 },
    { 0x01, 0x00 },
    { 0x02, 0x00 },
    { 0x00, 0x00 },
...
EnvLightSettings drag_sceneLightSettings0x00009C[] = {
...
BgCamInfo drag_sceneCollisionHeader_0003C0CamDataList[] = {
...
SurfaceType drag_sceneCollisionHeader_0003C0SurfaceType[] = {
    {0x00000202, 0x040C57C2},   {0x00000002, 0x000057C2},   {0x00000102, 0x000C57C2},   {0x00000002, 0x000057CA},
};
...
CollisionHeader drag_sceneCollisionHeader_0003C0 = { 
    { -160, 0, -120 },
    { 160, 144, 242 },
    ARRAY_COUNT(drag_sceneCollisionHeader_0003C0Vertices), drag_sceneCollisionHeader_0003C0Vertices,
    ARRAY_COUNT(drag_sceneCollisionHeader_0003C0Polygons), drag_sceneCollisionHeader_0003C0Polygons,
