...
SceneCmd zoora_room_0Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&zoora_room_0RoomShapeImageSingle_000090),
    SCENE_CMD_OBJECT_LIST(10, zoora_room_0ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(3, zoora_room_0ActorEntry_000054),
    SCENE_CMD_END(),
};
...
ActorEntry zoora_room_0ActorEntry_000054[] = {
...
RoomShapeImageSingle zoora_room_0RoomShapeImageSingle_000090 = { 
    { 1, 1, &zoora_room_0RoomShapeDListsEntry_0000B0, }, 
...
RoomShapeDListsEntry zoora_room_0RoomShapeDListsEntry_0000B0 = { 
