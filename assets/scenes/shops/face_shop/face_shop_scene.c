...
RomFile face_shop_sceneRoomList0x000060[] = {
    { (uintptr_t)_face_shop_room_0SegmentRomStart, (uintptr_t)_face_shop_room_0SegmentRomEnd },
};

Spawn face_shop_sceneEntranceList0x000068[] = {
    { 0x00, 0x00 },
    { 0x00, 0x00 },
};
...
EnvLightSettings face_shop_sceneLightSettings0x000070[] = {
...
BgCamInfo face_shop_sceneCollisionHeader_000338CamDataList[] = {
...
SurfaceType face_shop_sceneCollisionHeader_000338SurfaceType[] = {
    {0x00000102, 0x000C3FC2},   {0x00000102, 0x00003FC2},   {0x00000002, 0x00003FC2},   {0x00000002, 0x00003802},
};
...
CollisionHeader face_shop_sceneCollisionHeader_000338 = { 
    { -172, -11, -200 },
    { 172, 320, 320 },
    ARRAY_COUNT(face_shop_sceneCollisionHeader_000338Vertices), face_shop_sceneCollisionHeader_000338Vertices,
    ARRAY_COUNT(face_shop_sceneCollisionHeader_000338Polygons), face_shop_sceneCollisionHeader_000338Polygons,
