...
RomFile golon_sceneRoomList0x000060[] = {
    { (uintptr_t)_golon_room_0SegmentRomStart, (uintptr_t)_golon_room_0SegmentRomEnd },
};

Spawn golon_sceneEntranceList0x000068[] = {
    { 0x00, 0x00 },
    { 0x00, 0x00 },
};
...
EnvLightSettings golon_sceneLightSettings0x000070[] = {
...
BgCamInfo golon_sceneCollisionHeader_000368CamDataList[] = {
...
SurfaceType golon_sceneCollisionHeader_000368SurfaceType[] = {
    {0x00000002, 0x000057C2},   {0x00200002, 0x000057C2},   {0x00000102, 0x000C5002},
};
...
CollisionHeader golon_sceneCollisionHeader_000368 = { 
    { -200, -1, -250 },
    { 200, 120, 80 },
    ARRAY_COUNT(golon_sceneCollisionHeader_000368Vertices), golon_sceneCollisionHeader_000368Vertices,
    ARRAY_COUNT(golon_sceneCollisionHeader_000368Polygons), golon_sceneCollisionHeader_000368Polygons,
