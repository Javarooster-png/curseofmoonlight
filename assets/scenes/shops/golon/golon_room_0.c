...
SceneCmd golon_room_0Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&golon_room_0RoomShapeImageSingle_000080),
    SCENE_CMD_OBJECT_LIST(10, golon_room_0ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(2, golon_room_0ActorEntry_000054),
    SCENE_CMD_END(),
};
...
ActorEntry golon_room_0ActorEntry_000054[] = {
...
RoomShapeImageSingle golon_room_0RoomShapeImageSingle_000080 = { 
    { 1, 1, &golon_room_0RoomShapeDListsEntry_0000A0, }, 
...
RoomShapeDListsEntry golon_room_0RoomShapeDListsEntry_0000A0 = { 
