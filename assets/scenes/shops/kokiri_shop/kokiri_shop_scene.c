...
RomFile kokiri_shop_sceneRoomList0x000068[] = {
    { (uintptr_t)_kokiri_shop_room_0SegmentRomStart, (uintptr_t)_kokiri_shop_room_0SegmentRomEnd },
};

Spawn kokiri_shop_sceneEntranceList0x000070[] = {
    { 0x00, 0x00 },
    { 0x00, 0x00 },
};
...
EnvLightSettings kokiri_shop_sceneLightSettings0x000078[] = {
...
BgCamInfo kokiri_shop_sceneCollisionHeader_000950CamDataList[] = {
...
SurfaceType kokiri_shop_sceneCollisionHeader_000950SurfaceType[] = {
    {0x00200002, 0x00003000},   {0x00000002, 0x000037C0},   {0x00000002, 0x00003000},   {0x00000102, 0x000C3000},
...
CollisionHeader kokiri_shop_sceneCollisionHeader_000950 = { 
    { -200, -1, -176 },
    { 200, 160, 220 },
    ARRAY_COUNT(kokiri_shop_sceneCollisionHeader_000950Vertices), kokiri_shop_sceneCollisionHeader_000950Vertices,
    ARRAY_COUNT(kokiri_shop_sceneCollisionHeader_000950Polygons), kokiri_shop_sceneCollisionHeader_000950Polygons,
