...
RomFile shop1_sceneRoomList0x000078[] = {
    { (uintptr_t)_shop1_room_0SegmentRomStart, (uintptr_t)_shop1_room_0SegmentRomEnd },
};

Spawn shop1_sceneEntranceList0x000080[] = {
    { 0x00, 0x00 },
    { 0x01, 0x00 },
};
...
EnvLightSettings shop1_sceneLightSettings0x000088[] = {
...
BgCamInfo shop1_sceneCollisionHeader_0002B8CamDataList[] = {
...
SurfaceType shop1_sceneCollisionHeader_0002B8SurfaceType[] = {
    {0x00000002, 0x000017C2},   {0x00000102, 0x000C3002},   {0x00000102, 0x00003002},
};
...
CollisionHeader shop1_sceneCollisionHeader_0002B8 = { 
    { -160, 0, -200 },
    { 160, 120, 240 },
    ARRAY_COUNT(shop1_sceneCollisionHeader_0002B8Vertices), shop1_sceneCollisionHeader_0002B8Vertices,
    ARRAY_COUNT(shop1_sceneCollisionHeader_0002B8Polygons), shop1_sceneCollisionHeader_0002B8Polygons,
