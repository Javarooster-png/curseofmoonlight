...
SceneCmd spot07_room_1Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&spot07_room_1RoomShapeCullable_000210),
    SCENE_CMD_OBJECT_LIST(7, spot07_room_1ObjectList_000058),
    SCENE_CMD_ACTOR_LIST(26, spot07_room_1ActorEntry_000068),
    SCENE_CMD_END(),
};
...
ActorEntry spot07_room_1ActorEntry_000068[] = {
...
RoomShapeCullable spot07_room_1RoomShapeCullable_000210 = { 
    2, 20,
    spot07_room_1RoomShapeCullableEntry_00021C,
    spot07_room_1RoomShapeCullableEntry_00021C + ARRAY_COUNTU(spot07_room_1RoomShapeCullableEntry_00021C)
};

RoomShapeCullableEntry spot07_room_1RoomShapeCullableEntry_00021C[20] = {
...
SceneCmd spot07_room_1Set_000360[] = {
    ...
    SCENE_CMD_ACTOR_LIST(17, spot07_room_1ActorEntry_0003B0),
    SCENE_CMD_END(),
};
...
ActorEntry spot07_room_1ActorEntry_0003B0[] = {
    { ACTOR_BG_SPOT07_TAKI, {      0,      0,      0 }, {      0,      0,      0 }, 0x0000 },
...
SceneCmd spot07_room_1Set_0004C0[] = {
    ...
    SCENE_CMD_ACTOR_LIST(1, spot07_room_1ActorEntry_000508),
    SCENE_CMD_END(),
};
...
ActorEntry spot07_room_1ActorEntry_000508[] = {
    { ACTOR_BG_SPOT07_TAKI, {      0,      0,      0 }, {      0,      0,      0 }, 0x0000 },
};
