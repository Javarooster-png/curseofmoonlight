...
SceneCmd spot10_room_2Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&spot10_room_2RoomShapeNormal_0000F0),
    SCENE_CMD_OBJECT_LIST(11, spot10_room_2ObjectList_000058),
    SCENE_CMD_ACTOR_LIST(8, spot10_room_2ActorEntry_000070),
    SCENE_CMD_END(),
};
...
ActorEntry spot10_room_2ActorEntry_000070[] = {
...
RoomShapeNormal spot10_room_2RoomShapeNormal_0000F0 = { 
    0, 1,
    spot10_room_2RoomShapeDListsEntry_0000FC,
    spot10_room_2RoomShapeDListsEntry_0000FC + ARRAY_COUNTU(spot10_room_2RoomShapeDListsEntry_0000FC)
};

RoomShapeDListsEntry spot10_room_2RoomShapeDListsEntry_0000FC[1] = {
...
SceneCmd spot10_room_2Set_000110[] = {
    ...
    SCENE_CMD_ACTOR_LIST(8, spot10_room_2ActorEntry_000168),
    SCENE_CMD_END(),
};
...
ActorEntry spot10_room_2ActorEntry_000168[] = {
    { ACTOR_EN_RIVER_SOUND, {   1061,      0,   -803 }, {      0,      0,      0 }, 0x000C },
    { ACTOR_OBJECT_KANKYO,  {    798,      0,   -897 }, {      0,      0,      0 }, 0x0000 },
    { ACTOR_DOOR_ANA,       {    915,      0,   -925 }, {      0, 0XE000,      0 }, 0x0014 },
