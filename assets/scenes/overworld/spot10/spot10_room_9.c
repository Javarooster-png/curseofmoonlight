...
SceneCmd spot10_room_9Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&spot10_room_9RoomShapeNormal_000090),
    SCENE_CMD_OBJECT_LIST(11, spot10_room_9ObjectList_000058),
    SCENE_CMD_ACTOR_LIST(2, spot10_room_9ActorEntry_000070),
    SCENE_CMD_END(),
};
...
ActorEntry spot10_room_9ActorEntry_000070[] = {
    { ACTOR_EN_SKJ, {  -1132,     80,   -128 }, {      0, 0X22D8,      0 }, 0x03FF },
    { ACTOR_EN_SKJ, {   -951,     20,     52 }, {      0, 0XA000,      0 }, 0x17FF },
};

RoomShapeNormal spot10_room_9RoomShapeNormal_000090 = { 
    0, 1,
    spot10_room_9RoomShapeDListsEntry_00009C,
    spot10_room_9RoomShapeDListsEntry_00009C + ARRAY_COUNTU(spot10_room_9RoomShapeDListsEntry_00009C)
};

RoomShapeDListsEntry spot10_room_9RoomShapeDListsEntry_00009C[1] = {
...
SceneCmd spot10_room_9Set_0000B0[] = {
    ...
    SCENE_CMD_ACTOR_LIST(3, spot10_room_9ActorEntry_000108),
    SCENE_CMD_END(),
};
...
ActorEntry spot10_room_9ActorEntry_000108[] = {
