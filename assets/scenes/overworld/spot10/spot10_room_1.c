...
SceneCmd spot10_room_1Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&spot10_room_1RoomShapeNormal_0000F0),
    SCENE_CMD_OBJECT_LIST(11, spot10_room_1ObjectList_000058),
    SCENE_CMD_ACTOR_LIST(8, spot10_room_1ActorEntry_000070),
    SCENE_CMD_END(),
};
...
ActorEntry spot10_room_1ActorEntry_000070[] = {
...
RoomShapeNormal spot10_room_1RoomShapeNormal_0000F0 = { 
    0, 1,
    spot10_room_1RoomShapeDListsEntry_0000FC,
    spot10_room_1RoomShapeDListsEntry_0000FC + ARRAY_COUNTU(spot10_room_1RoomShapeDListsEntry_0000FC)
};

RoomShapeDListsEntry spot10_room_1RoomShapeDListsEntry_0000FC[1] = {
...
SceneCmd spot10_room_1Set_000110[] = {
    ...
    SCENE_CMD_ACTOR_LIST(3, spot10_room_1ActorEntry_000168),
    SCENE_CMD_END(),
};
...
ActorEntry spot10_room_1ActorEntry_000168[] = {
    { ACTOR_EN_RIVER_SOUND, {    796,      0,   -274 }, {      0,      0,      0 }, 0x000C },
