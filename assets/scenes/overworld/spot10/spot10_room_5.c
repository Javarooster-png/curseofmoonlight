...
SceneCmd spot10_room_5Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&spot10_room_5RoomShapeNormal_0000C0),
    SCENE_CMD_OBJECT_LIST(11, spot10_room_5ObjectList_000058),
    SCENE_CMD_ACTOR_LIST(5, spot10_room_5ActorEntry_000070),
    SCENE_CMD_END(),
};
...
ActorEntry spot10_room_5ActorEntry_000070[] = {
...
RoomShapeNormal spot10_room_5RoomShapeNormal_0000C0 = { 
    0, 1,
    spot10_room_5RoomShapeDListsEntry_0000CC,
    spot10_room_5RoomShapeDListsEntry_0000CC + ARRAY_COUNTU(spot10_room_5RoomShapeDListsEntry_0000CC)
};

RoomShapeDListsEntry spot10_room_5RoomShapeDListsEntry_0000CC[1] = {
...
SceneCmd spot10_room_5Set_0000E0[] = {
    ...
    SCENE_CMD_ACTOR_LIST(4, spot10_room_5ActorEntry_000138),
    SCENE_CMD_END(),
};
...
ActorEntry spot10_room_5ActorEntry_000138[] = {
    { ACTOR_OBJECT_KANKYO, {  -1191,   -220,   1626 }, {      0,      0,      0 }, 0x0000 },
...
SceneCmd spot10_room_5Set_000180[] = {
    ...
    SCENE_CMD_ACTOR_LIST(4, spot10_room_5ActorEntry_0001C8),
    SCENE_CMD_END(),
};
...
ActorEntry spot10_room_5ActorEntry_0001C8[] = {
