...
SceneCmd spot10_room_0Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&spot10_room_0RoomShapeNormal_000090),
    SCENE_CMD_OBJECT_LIST(11, spot10_room_0ObjectList_000058),
    SCENE_CMD_ACTOR_LIST(2, spot10_room_0ActorEntry_000070),
    SCENE_CMD_END(),
};
...
ActorEntry spot10_room_0ActorEntry_000070[] = {
    { ACTOR_EN_RIVER_SOUND, {    287,      0,     -2 }, {      0,      0,      0 }, 0x000C },
    { ACTOR_OBJECT_KANKYO,  {     52,      0,    -52 }, {      0,      0,      0 }, 0x0000 },
};

RoomShapeNormal spot10_room_0RoomShapeNormal_000090 = { 
    0, 1,
    spot10_room_0RoomShapeDListsEntry_00009C,
    spot10_room_0RoomShapeDListsEntry_00009C + ARRAY_COUNTU(spot10_room_0RoomShapeDListsEntry_00009C)
};

RoomShapeDListsEntry spot10_room_0RoomShapeDListsEntry_00009C[1] = {
...
SceneCmd spot10_room_0Set_0000B0[] = {
    ...
    SCENE_CMD_ACTOR_LIST(2, spot10_room_0ActorEntry_000108),
    SCENE_CMD_END(),
};
...
ActorEntry spot10_room_0ActorEntry_000108[] = {
    { ACTOR_EN_RIVER_SOUND, {    287,      0,     -2 }, {      0,      0,      0 }, 0x000C },
    { ACTOR_OBJECT_KANKYO,  {     52,      0,    -52 }, {      0,      0,      0 }, 0x0000 },
};
