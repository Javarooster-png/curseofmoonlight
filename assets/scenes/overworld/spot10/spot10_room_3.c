...
SceneCmd spot10_room_3Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&spot10_room_3RoomShapeNormal_000130),
    SCENE_CMD_OBJECT_LIST(11, spot10_room_3ObjectList_000058),
    SCENE_CMD_ACTOR_LIST(12, spot10_room_3ActorEntry_000070),
    SCENE_CMD_END(),
};
...
ActorEntry spot10_room_3ActorEntry_000070[] = {
...
RoomShapeNormal spot10_room_3RoomShapeNormal_000130 = { 
    0, 1,
    spot10_room_3RoomShapeDListsEntry_00013C,
    spot10_room_3RoomShapeDListsEntry_00013C + ARRAY_COUNTU(spot10_room_3RoomShapeDListsEntry_00013C)
};

RoomShapeDListsEntry spot10_room_3RoomShapeDListsEntry_00013C[1] = {
...
SceneCmd spot10_room_3Set_000150[] = {
    ...
    SCENE_CMD_ACTOR_LIST(6, spot10_room_3ActorEntry_0001A8),
    SCENE_CMD_END(),
};
...
ActorEntry spot10_room_3ActorEntry_0001A8[] = {
    { ACTOR_EN_RIVER_SOUND, {   1596,      0,  -1067 }, {      0,      0,      0 }, 0x000C },
    { ACTOR_OBJECT_KANKYO,  {   1735,      0,   -792 }, {      0,      0,      0 }, 0x0000 },
    { ACTOR_EN_OKUTA,       {   2114,    -20,   -847 }, {      0, 0XC000,      0 }, 0xFF00 },
