...
SceneCmd spot04_room_1Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&spot04_room_1RoomShapeCullable_000120),
    SCENE_CMD_OBJECT_LIST(5, spot04_room_1ObjectList_00007C),
    SCENE_CMD_ACTOR_LIST(9, spot04_room_1ActorEntry_000088),
    SCENE_CMD_END(),
};
...
ActorEntry spot04_room_1ActorEntry_000088[] = {
...
RoomShapeCullable spot04_room_1RoomShapeCullable_000120 = { 
    2, 3,
    spot04_room_1RoomShapeCullableEntry_00012C,
    spot04_room_1RoomShapeCullableEntry_00012C + ARRAY_COUNTU(spot04_room_1RoomShapeCullableEntry_00012C)
};

RoomShapeCullableEntry spot04_room_1RoomShapeCullableEntry_00012C[3] = {
...
SceneCmd spot04_room_1Set_000160[] = {
    ...
    SCENE_CMD_ACTOR_LIST(10, spot04_room_1ActorEntry_0001A8),
    SCENE_CMD_END(),
};
...
ActorEntry spot04_room_1ActorEntry_0001A8[] = {
    { ACTOR_OBJECT_KANKYO, {   3409,   -143,   -818 }, {      0,      0,      0 }, 0x0000 },
    { ACTOR_BG_TREEMOUTH,  {   3882,   -171,  -1161 }, {      0,      0,      0 }, 0xFFFF },
...
SceneCmd spot04_room_1Set_000250[] = {
    ...
    SCENE_CMD_ACTOR_LIST(5, spot04_room_1ActorEntry_00029C),
    SCENE_CMD_END(),
};
...
ActorEntry spot04_room_1ActorEntry_00029C[] = {
    { ACTOR_OBJECT_KANKYO, {   3409,   -143,   -818 }, {      0,      0,      0 }, 0x0000 },
...
SceneCmd spot04_room_1Set_0002F0[] = {
    ...
    SCENE_CMD_ACTOR_LIST(3, spot04_room_1ActorEntry_000338),
    SCENE_CMD_END(),
};
...
ActorEntry spot04_room_1ActorEntry_000338[] = {
    { ACTOR_BG_TREEMOUTH,  {   3882,   -171,  -1161 }, {      0,      0,      0 }, 0xFFFF },
...
SceneCmd spot04_room_1Set_000370[] = {
    ...
    SCENE_CMD_ACTOR_LIST(4, spot04_room_1ActorEntry_0003B8),
    SCENE_CMD_END(),
};
...
ActorEntry spot04_room_1ActorEntry_0003B8[] = {
    { ACTOR_BG_TREEMOUTH,  {   3882,   -171,  -1161 }, {      0,      0,      0 }, 0xFFFF },
...
SceneCmd spot04_room_1Set_000400[] = {
    ...
    SCENE_CMD_ACTOR_LIST(5, spot04_room_1ActorEntry_000448),
    SCENE_CMD_END(),
};
...
ActorEntry spot04_room_1ActorEntry_000448[] = {
    { ACTOR_BG_TREEMOUTH,  {   3882,   -171,  -1161 }, {      0,      0,      0 }, 0xFFFF },
...
SceneCmd spot04_room_1Set_0004A0[] = {
    ...
    SCENE_CMD_ACTOR_LIST(2, spot04_room_1ActorEntry_0004E8),
    SCENE_CMD_END(),
};
...
ActorEntry spot04_room_1ActorEntry_0004E8[] = {
    { ACTOR_OBJECT_KANKYO, {   3409,   -143,   -818 }, {      0,      0,      0 }, 0x0000 },
    { ACTOR_BG_TREEMOUTH,  {   3882,   -171,  -1161 }, {      0,      0,      0 }, 0xFFFF },
};
...
SceneCmd spot04_room_1Set_000510[] = {
    ...
    SCENE_CMD_ACTOR_LIST(14, spot04_room_1ActorEntry_000558),
    SCENE_CMD_END(),
};
...
ActorEntry spot04_room_1ActorEntry_000558[] = {
...
SceneCmd spot04_room_1Set_000640[] = {
    ...
    SCENE_CMD_ACTOR_LIST(14, spot04_room_1ActorEntry_000688),
    SCENE_CMD_END(),
};
...
ActorEntry spot04_room_1ActorEntry_000688[] = {
    { ACTOR_EN_RIVER_SOUND, {    402,    -12,   -491 }, {      0,      0,      0 }, 0x0001 },
    { ACTOR_OBJECT_KANKYO,  {    -29,      1,    216 }, {      0,      0,      0 }, 0x0000 },
    { ACTOR_ITEM_SHIELD,    {     18,    100,   1011 }, {      0,      0,      0 }, 0x0000 },
    { ACTOR_ITEM_SHIELD,    {    829,    119,   -348 }, {      0,      0,      0 }, 0x0000 },
...
SceneCmd spot04_room_1Set_000770[] = {
    ...
    SCENE_CMD_ACTOR_LIST(4, spot04_room_1ActorEntry_0007B4),
    SCENE_CMD_END(),
};
...
ActorEntry spot04_room_1ActorEntry_0007B4[] = {
    { ACTOR_OBJECT_KANKYO, {    -29,      1,    216 }, {      0,      0,      0 }, 0x0000 },
...
SceneCmd spot04_room_1Set_000800[] = {
    ...
    SCENE_CMD_ACTOR_LIST(1, spot04_room_1ActorEntry_000848),
    SCENE_CMD_END(),
};
...
ActorEntry spot04_room_1ActorEntry_000848[] = {
    { ACTOR_OBJECT_KANKYO, {   3554,   -173,   -856 }, {      0,      0,      0 }, 0x0000 },
};
...
SceneCmd spot04_room_1Set_000860[] = {
    ...
    SCENE_CMD_ACTOR_LIST(5, spot04_room_1ActorEntry_0008A8),
    SCENE_CMD_END(),
};
...
ActorEntry spot04_room_1ActorEntry_0008A8[] = {
    { ACTOR_OBJECT_KANKYO, {    -29,      1,    216 }, {      0,      0,      0 }, 0x0000 },
    { ACTOR_OBJECT_KANKYO, {   3554,   -173,   -856 }, {      0,      0,      0 }, 0x0000 },
    { ACTOR_OBJ_DEKUJR,    {   3704,   -172,  -1074 }, {      0,      0,      0 }, 0x1E00 },
    { ACTOR_BG_TREEMOUTH,  {   3882,   -171,  -1161 }, {      0,      0,      0 }, 0xFFFF },
...
SceneCmd spot04_room_1Set_000900[] = {
    ...
    SCENE_CMD_ACTOR_LIST(4, spot04_room_1ActorEntry_000944),
    SCENE_CMD_END(),
};
...
ActorEntry spot04_room_1ActorEntry_000944[] = {
    { ACTOR_OBJECT_KANKYO, {    -29,      1,    216 }, {      0,      0,      0 }, 0x0000 },
    { ACTOR_OBJECT_KANKYO, {   3554,   -173,   -856 }, {      0,      0,      0 }, 0x0000 },
    { ACTOR_OBJ_DEKUJR,    {   3704,   -172,  -1074 }, {      0,      0,      0 }, 0x1E00 },
    { ACTOR_BG_TREEMOUTH,  {   3882,   -171,  -1161 }, {      0,      0,      0 }, 0xFFFF },
