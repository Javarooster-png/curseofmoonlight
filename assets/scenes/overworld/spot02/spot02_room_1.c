...
SceneCmd spot02_room_1Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&spot02_room_1RoomShapeCullable_000340),
...
RoomShapeCullable spot02_room_1RoomShapeCullable_000340 = { 
    2, 20,
    spot02_room_1RoomShapeCullableEntry_00034C,
    spot02_room_1RoomShapeCullableEntry_00034C + ARRAY_COUNTU(spot02_room_1RoomShapeCullableEntry_00034C)
};

RoomShapeCullableEntry spot02_room_1RoomShapeCullableEntry_00034C[20] = {
...
SceneCmd spot02_room_1Set_000490[] = {
    ...
    SCENE_CMD_ACTOR_LIST(57, spot02_room_1ActorEntry_0004EC),
    SCENE_CMD_END(),
};
...
ActorEntry spot02_room_1ActorEntry_0004EC[] = {
    { ACTOR_BG_SPOT01_FUSYA,   {  -3200,    880,    150 }, {      0, 0XC000,      0 }, 0xFFFF },
    { ACTOR_EN_GS,             {   1290,    340,    -75 }, {      0, 0XE000,      0 }, 0x380A },
...
SceneCmd spot02_room_1Set_000880[] = {
    ...
    SCENE_CMD_ACTOR_LIST(57, spot02_room_1ActorEntry_0008DC),
    SCENE_CMD_END(),
};
...
ActorEntry spot02_room_1ActorEntry_0008DC[] = {
    { ACTOR_BG_SPOT01_FUSYA,   {  -3200,    880,    150 }, {      0, 0XC000,      0 }, 0xFFFF },
    { ACTOR_EN_GS,             {   1290,    340,    -75 }, {      0, 0XE000,      0 }, 0x380A },
    { ACTOR_EN_FIREFLY,        {    -25,    133,    -81 }, {      0, 0X4000,      0 }, 0x0003 },
    { ACTOR_EN_FIREFLY,        {    -39,    133,    150 }, {      0, 0XC000,      0 }, 0x0003 },
...
SceneCmd spot02_room_1Set_000C70[] = {
    ...
    SCENE_CMD_ACTOR_LIST(52, spot02_room_1ActorEntry_000CCC),
    SCENE_CMD_END(),
};
...
ActorEntry spot02_room_1ActorEntry_000CCC[] = {
    { ACTOR_BG_SPOT01_FUSYA,   {  -3200,    880,    150 }, {      0, 0XC000,      0 }, 0xFFFF },
...
SceneCmd spot02_room_1Set_001010[] = {
    ...
    SCENE_CMD_ACTOR_LIST(31, spot02_room_1ActorEntry_001068),
    SCENE_CMD_END(),
};
...
ActorEntry spot02_room_1ActorEntry_001068[] = {
...
SceneCmd spot02_room_1Set_001260[] = {
    ...
    SCENE_CMD_ACTOR_LIST(31, spot02_room_1ActorEntry_0012B8),
    SCENE_CMD_END(),
};
...
ActorEntry spot02_room_1ActorEntry_0012B8[] = {
    { ACTOR_EN_BOX,            {  -1100,    264,   -300 }, {      0, 0XC000,      0 }, 0x07C0 },
    { ACTOR_EN_POH,            {   -330,    120,   -260 }, {      0,      0,      0 }, 0x0000 },
    { ACTOR_BG_MJIN,           {   1145,    340,     85 }, {      0, 0X1555,      0 }, 0x0002 },
    { ACTOR_BG_HAKA,           {   -348,     60,     59 }, {      0, 0XC000,      0 }, 0x0000 },
