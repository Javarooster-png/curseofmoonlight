...
RomFile hairal_niwa_n_sceneRoomList0x000068[] = {
    { (uintptr_t)_hairal_niwa_n_room_0SegmentRomStart, (uintptr_t)_hairal_niwa_n_room_0SegmentRomEnd },
};

Spawn hairal_niwa_n_sceneEntranceList0x000070[] = {
    { 0x00, 0x00 },
    { 0x00, 0x00 },
};
...
EnvLightSettings hairal_niwa_n_sceneLightSettings0x000078[] = {
...
BgCamInfo hairal_niwa_n_sceneCollisionHeader_0010C4CamDataList[] = {
...
SurfaceType hairal_niwa_n_sceneCollisionHeader_0010C4SurfaceType[] = {
    {0x00A00002, 0x000057C8},   {0x00000002, 0x000057C8},   {0x00000102, 0x000057C8},   {0x00000002, 0x000057C2},
    {0x00000002, 0x000057CA},   {0x00000001, 0x000057C2},   {0x00000001, 0x000057C4},   {0x00000001, 0x000057C8},
};
...
CollisionHeader hairal_niwa_n_sceneCollisionHeader_0010C4 = { 
    { 370, -80, -280 },
    { 2400, 602, 400 },
    ARRAY_COUNT(hairal_niwa_n_sceneCollisionHeader_0010C4Vertices), hairal_niwa_n_sceneCollisionHeader_0010C4Vertices,
    ARRAY_COUNT(hairal_niwa_n_sceneCollisionHeader_0010C4Polygons), hairal_niwa_n_sceneCollisionHeader_0010C4Polygons,
