...
RomFile syatekijyou_sceneRoomList0x0000B0[] = {
    { (uintptr_t)_syatekijyou_room_0SegmentRomStart, (uintptr_t)_syatekijyou_room_0SegmentRomEnd },
};

Spawn syatekijyou_sceneEntranceList0x0000B8[] = {
    { 0x00, 0x00 },
    { 0x01, 0x00 },
};
...
EnvLightSettings syatekijyou_sceneLightSettings0x0000C0[] = {
...
BgCamInfo syatekijyou_sceneCollisionHeader_001420CamDataList[] = {
...
SurfaceType syatekijyou_sceneCollisionHeader_001420SurfaceType[] = {
    {0x00000001, 0x00000FC0},   {0x20000001, 0x00000FC0},   {0x00200001, 0x00000FC0},   {0x80000001, 0x0000080A},
    {0x80000001, 0x00020FC0},   {0x20000001, 0x00000800},   {0x00000001, 0x00000800},   {0x00000000, 0x00000FC2},
    {0x00000000, 0x0000080A},   {0x00000101, 0x00000800},
};
...
CollisionHeader syatekijyou_sceneCollisionHeader_001420 = { 
    { -260, 0, -400 },
    { 260, 261, 527 },
    ARRAY_COUNT(syatekijyou_sceneCollisionHeader_001420Vertices), syatekijyou_sceneCollisionHeader_001420Vertices,
    ARRAY_COUNT(syatekijyou_sceneCollisionHeader_001420Polygons), syatekijyou_sceneCollisionHeader_001420Polygons,
...
CutsceneData syatekijyou_sceneCutsceneData_001450[] = {
    ...
    CS_CAM_EYE_SPLINE(0, 391),
        CS_CAM_POINT(CS_CAM_CONTINUE, 0x00, 0, 60.000000f, -23, 44, 365, 0x2020),
        CS_CAM_POINT(CS_CAM_CONTINUE, 0x00, 0, 60.000000f, -23, 44, 365, 0x0000),
        CS_CAM_POINT(CS_CAM_CONTINUE, 0x00, 0, 60.000000f, -23, 44, 365, 0x0000),
        CS_CAM_POINT(CS_CAM_CONTINUE, 0x00, 0, 60.000000f, -23, 44, 365, 0x0000),
        CS_CAM_POINT(CS_CAM_CONTINUE, 0x00, 0, 60.000000f, -23, 44, 365, 0x0000),
        CS_CAM_POINT(CS_CAM_CONTINUE, 0x00, 0, 60.000000f, -23, 41, 365, 0x0000),
        CS_CAM_POINT(CS_CAM_CONTINUE, 0x2D, 0, 60.000000f, -23, 41, 365, 0x0000),
        CS_CAM_POINT(CS_CAM_CONTINUE, 0x00, 0, 60.000000f, -23, 41, 365, 0x0000),
        CS_CAM_POINT(CS_CAM_CONTINUE, 0xFFFFFFD3, 0, 60.000000f, -23, 41, 365, 0x0000),
        CS_CAM_POINT(CS_CAM_CONTINUE, 0x00, 0, 60.000000f, -23, 41, 365, 0x0000),
        CS_CAM_POINT(CS_CAM_CONTINUE, 0x00, 0, 60.000000f, -23, 41, 365, 0x0000),
        CS_CAM_POINT(CS_CAM_CONTINUE, 0x00, 0, 60.000000f, -23, 41, 365, 0x0000),
        CS_CAM_POINT(CS_CAM_CONTINUE, 0x00, 0, 60.000000f, -23, 41, 365, 0x0000),
        CS_CAM_POINT(CS_CAM_STOP, 0x00, 0, 60.000000f, -23, 41, 365, 0x0000),
    CS_CAM_AT_SPLINE(0, 420),
        CS_CAM_POINT(CS_CAM_CONTINUE, 0x00, 30, 60.000000f, -23, 40, 228, 0x2020),
        CS_CAM_POINT(CS_CAM_CONTINUE, 0x00, 30, 60.000000f, -23, 40, 228, 0x0000),
        CS_CAM_POINT(CS_CAM_CONTINUE, 0x00, 30, 60.000000f, -23, 40, 228, 0x0000),
        CS_CAM_POINT(CS_CAM_CONTINUE, 0x00, 30, 60.000000f, -23, 40, 228, 0x0000),
        CS_CAM_POINT(CS_CAM_CONTINUE, 0x00, 30, 60.000000f, -23, 40, 228, 0x0000),
        CS_CAM_POINT(CS_CAM_CONTINUE, 0x2D, 30, 60.000000f, -23, 40, 228, 0x0000),
        CS_CAM_POINT(CS_CAM_CONTINUE, 0x00, 30, 60.000000f, -23, 40, 228, 0x0000),
        CS_CAM_POINT(CS_CAM_CONTINUE, 0xFFFFFFD3, 30, 60.000000f, -23, 40, 228, 0x0000),
        CS_CAM_POINT(CS_CAM_CONTINUE, 0x00, 30, 60.000000f, -23, 40, 228, 0x0000),
        CS_CAM_POINT(CS_CAM_CONTINUE, 0x00, 30, 60.000000f, -23, 40, 228, 0x0000),
        CS_CAM_POINT(CS_CAM_CONTINUE, 0x00, 30, 60.000000f, -23, 40, 228, 0x0000),
        CS_CAM_POINT(CS_CAM_CONTINUE, 0x00, 30, 60.000000f, -23, 40, 228, 0x0000),
        CS_CAM_POINT(CS_CAM_CONTINUE, 0x00, 30, 60.000000f, -23, 40, 228, 0x0000),
        CS_CAM_POINT(CS_CAM_STOP, 0x00, 30, 60.000000f, -23, 40, 228, 0x0000),
    CS_END(),
};
...
Spawn syatekijyou_sceneEntranceList0x001AA0[] = {
    { 0x00, 0x00 },
    { 0x00, 0x00 },
};

EnvLightSettings syatekijyou_sceneLightSettings0x001AA4[] = {
...
Spawn syatekijyou_sceneEntranceList0x001B50[] = {
    { 0x00, 0x00 },
    { 0x00, 0x00 },
};
...
EnvLightSettings syatekijyou_sceneLightSettings0x001B58[] = {
    { 0x3C, 0x3C, 0x3C, 0x49, 0x49, 0x49, 0x78, 0x78, 0x78, 0xB7, 0xB7, 0xB7, 0x32, 0x50, 0x50, 0x00, 0x00, 0x00,
    0x07E4, 0x3200 },
};
...
Spawn syatekijyou_sceneEntranceList0x001C00[] = {
    { 0x00, 0x00 },
    { 0x00, 0x00 },
};
...
EnvLightSettings syatekijyou_sceneLightSettings0x001C08[] = {
    { 0x3C, 0x3C, 0x3C, 0x49, 0x49, 0x49, 0x78, 0x78, 0x78, 0xB7, 0xB7, 0xB7, 0x32, 0x50, 0x50, 0x00, 0x00, 0x00,
    0x07E4, 0x3200 },
