...
SceneCmd miharigoya_room_0Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&miharigoya_room_0RoomShapeCullable_0003A0),
    SCENE_CMD_OBJECT_LIST(5, miharigoya_room_0ObjectList_000054),
    SCENE_CMD_ACTOR_LIST(52, miharigoya_room_0ActorEntry_000060),
    SCENE_CMD_END(),
};
...
ActorEntry miharigoya_room_0ActorEntry_000060[] = {
...
RoomShapeCullable miharigoya_room_0RoomShapeCullable_0003A0 = { 
    2, 12,
    miharigoya_room_0RoomShapeCullableEntry_0003AC,
    miharigoya_room_0RoomShapeCullableEntry_0003AC + ARRAY_COUNTU(miharigoya_room_0RoomShapeCullableEntry_0003AC)
};

RoomShapeCullableEntry miharigoya_room_0RoomShapeCullableEntry_0003AC[12] = {
...
SceneCmd miharigoya_room_0Set_000470[] = {
    ...
    SCENE_CMD_ACTOR_LIST(14, miharigoya_room_0ActorEntry_0004B4),
    SCENE_CMD_END(),
};
...
ActorEntry miharigoya_room_0ActorEntry_0004B4[] = {
