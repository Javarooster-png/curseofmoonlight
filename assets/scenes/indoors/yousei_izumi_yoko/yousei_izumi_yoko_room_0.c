...
SceneCmd yousei_izumi_yoko_room_0Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&yousei_izumi_yoko_room_0RoomShapeNormal_0000B0),
    SCENE_CMD_OBJECT_LIST(3, yousei_izumi_yoko_room_0ObjectList_000060),
    SCENE_CMD_ACTOR_LIST(4, yousei_izumi_yoko_room_0ActorEntry_000068),
    SCENE_CMD_END(),
};
...
ActorEntry yousei_izumi_yoko_room_0ActorEntry_000068[] = {
...
RoomShapeNormal yousei_izumi_yoko_room_0RoomShapeNormal_0000B0 = { 
    0, 1,
    yousei_izumi_yoko_room_0RoomShapeDListsEntry_0000BC,
    yousei_izumi_yoko_room_0RoomShapeDListsEntry_0000BC +
    ARRAY_COUNTU(yousei_izumi_yoko_room_0RoomShapeDListsEntry_0000BC)
};

RoomShapeDListsEntry yousei_izumi_yoko_room_0RoomShapeDListsEntry_0000BC[1] = {
...
SceneCmd yousei_izumi_yoko_room_0Set_0000D0[] = {
    ...
    SCENE_CMD_ACTOR_LIST(5, yousei_izumi_yoko_room_0ActorEntry_000118),
    SCENE_CMD_END(),
};
...
ActorEntry yousei_izumi_yoko_room_0ActorEntry_000118[] = {
...
SceneCmd yousei_izumi_yoko_room_0Set_000170[] = {
    ...
    SCENE_CMD_ACTOR_LIST(5, yousei_izumi_yoko_room_0ActorEntry_0001B8),
    SCENE_CMD_END(),
};
...
ActorEntry yousei_izumi_yoko_room_0ActorEntry_0001B8[] = {
    { ACTOR_EN_LIGHT,      {   -171,    113,   -854 }, {      0,      0,      0 }, 0x03F0 },
    { ACTOR_EN_LIGHT,      {    134,    113,   -854 }, {      0,      0,      0 }, 0x03F0 },
    { ACTOR_EN_LIGHT,      {   -171,    113,   -854 }, {      0,      0,      0 }, 0x03F3 },
    { ACTOR_EN_LIGHT,      {    134,    113,   -854 }, {      0,      0,      0 }, 0x03F3 },
...
SceneCmd yousei_izumi_yoko_room_0Set_000210[] = {
    ...
    SCENE_CMD_ACTOR_LIST(5, yousei_izumi_yoko_room_0ActorEntry_000258),
    SCENE_CMD_END(),
};
...
ActorEntry yousei_izumi_yoko_room_0ActorEntry_000258[] = {
    { ACTOR_EN_LIGHT,      {   -171,    113,   -854 }, {      0,      0,      0 }, 0x03F0 },
    { ACTOR_EN_LIGHT,      {    134,    113,   -854 }, {      0,      0,      0 }, 0x03F0 },
    { ACTOR_EN_LIGHT,      {   -171,    113,   -854 }, {      0,      0,      0 }, 0x03F3 },
    { ACTOR_EN_LIGHT,      {    134,    113,   -854 }, {      0,      0,      0 }, 0x03F3 },
