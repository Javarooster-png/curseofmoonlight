...
SceneCmd takaraya_room_1Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&takaraya_room_1RoomShapeNormal_000080),
    SCENE_CMD_OBJECT_LIST(6, takaraya_room_1ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(3, takaraya_room_1ActorEntry_00004C),
    SCENE_CMD_END(),
};
...
ActorEntry takaraya_room_1ActorEntry_00004C[] = {
...
RoomShapeNormal takaraya_room_1RoomShapeNormal_000080 = { 
    0, 1,
    takaraya_room_1RoomShapeDListsEntry_00008C,
    takaraya_room_1RoomShapeDListsEntry_00008C + ARRAY_COUNTU(takaraya_room_1RoomShapeDListsEntry_00008C)
};

RoomShapeDListsEntry takaraya_room_1RoomShapeDListsEntry_00008C[1] = {
