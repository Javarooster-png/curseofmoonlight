...
SceneCmd takaraya_room_3Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&takaraya_room_3RoomShapeNormal_000090),
    SCENE_CMD_OBJECT_LIST(6, takaraya_room_3ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(4, takaraya_room_3ActorEntry_00004C),
    SCENE_CMD_END(),
};
...
ActorEntry takaraya_room_3ActorEntry_00004C[] = {
...
RoomShapeNormal takaraya_room_3RoomShapeNormal_000090 = { 
    0, 1,
    takaraya_room_3RoomShapeDListsEntry_00009C,
    takaraya_room_3RoomShapeDListsEntry_00009C + ARRAY_COUNTU(takaraya_room_3RoomShapeDListsEntry_00009C)
};

RoomShapeDListsEntry takaraya_room_3RoomShapeDListsEntry_00009C[1] = {
