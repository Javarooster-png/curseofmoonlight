...
SceneCmd impa_room_0Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&impa_room_0RoomShapeImageSingle_000090),
    SCENE_CMD_OBJECT_LIST(11, impa_room_0ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(3, impa_room_0ActorEntry_000058),
    SCENE_CMD_END(),
};
...
ActorEntry impa_room_0ActorEntry_000058[] = {
...
RoomShapeImageSingle impa_room_0RoomShapeImageSingle_000090 = { 
    { 1, 1, &impa_room_0RoomShapeDListsEntry_0000B0, }, 
...
RoomShapeDListsEntry impa_room_0RoomShapeDListsEntry_0000B0 = { 
