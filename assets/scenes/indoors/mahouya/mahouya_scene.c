...
RomFile mahouya_sceneRoomList0x000080[] = {
    { (uintptr_t)_mahouya_room_0SegmentRomStart, (uintptr_t)_mahouya_room_0SegmentRomEnd },
};

Spawn mahouya_sceneEntranceList0x000088[] = {
    { 0x00, 0x00 },
    { 0x00, 0x00 },
};
...
EnvLightSettings mahouya_sceneLightSettings0x000090[] = {
...
BgCamInfo mahouya_sceneCollisionHeader_0009F4CamDataList[] = {
    { 0x0040, 3, &mahouya_sceneCollisionHeader_0009F4CamPosData[0] },
    { 0x0000, 0, NULL },
};

SurfaceType mahouya_sceneCollisionHeader_0009F4SurfaceType[] = {
    {0x00000001, 0x0000080D},   {0x00000000, 0x0000080A},   {0x00000000, 0x00000FCA},   {0x00000001, 0x00000FCD},
    {0x00000000, 0x0000080D},   {0x00000101, 0x0000080D},
};
...
CollisionHeader mahouya_sceneCollisionHeader_0009F4 = { 
    { -160, 0, -109 },
    { 161, 218, 502 },
    ARRAY_COUNT(mahouya_sceneCollisionHeader_0009F4Vertices), mahouya_sceneCollisionHeader_0009F4Vertices,
    ARRAY_COUNT(mahouya_sceneCollisionHeader_0009F4Polygons), mahouya_sceneCollisionHeader_0009F4Polygons,
