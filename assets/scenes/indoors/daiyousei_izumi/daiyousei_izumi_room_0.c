...
SceneCmd daiyousei_izumi_room_0Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&daiyousei_izumi_room_0RoomShapeNormal_0000C0),
    SCENE_CMD_OBJECT_LIST(4, daiyousei_izumi_room_0ObjectList_000060),
    SCENE_CMD_ACTOR_LIST(5, daiyousei_izumi_room_0ActorEntry_000068),
    SCENE_CMD_END(),
};
...
ActorEntry daiyousei_izumi_room_0ActorEntry_000068[] = {
...
RoomShapeNormal daiyousei_izumi_room_0RoomShapeNormal_0000C0 = { 
    0, 1,
    daiyousei_izumi_room_0RoomShapeDListsEntry_0000CC,
    daiyousei_izumi_room_0RoomShapeDListsEntry_0000CC + ARRAY_COUNTU(daiyousei_izumi_room_0RoomShapeDListsEntry_0000CC)
};

RoomShapeDListsEntry daiyousei_izumi_room_0RoomShapeDListsEntry_0000CC[1] = {
...
SceneCmd daiyousei_izumi_room_0Set_000160[] = {
    ...
    SCENE_CMD_ACTOR_LIST(3, daiyousei_izumi_room_0ActorEntry_0001A8),
    SCENE_CMD_END(),
};
...
ActorEntry daiyousei_izumi_room_0ActorEntry_0001A8[] = {
...
SceneCmd daiyousei_izumi_room_0Set_0001E0[] = {
    ...
    SCENE_CMD_ACTOR_LIST(3, daiyousei_izumi_room_0ActorEntry_000228),
    SCENE_CMD_END(),
};
...
ActorEntry daiyousei_izumi_room_0ActorEntry_000228[] = {
    { ACTOR_EN_LIGHT,      {   -171,    113,   -854 }, {      0,      0,      0 }, 0x03F0 },
    { ACTOR_EN_LIGHT,      {    134,    113,   -854 }, {      0,      0,      0 }, 0x03F0 },
    { ACTOR_BG_DY_YOSEIZO, {    -19,     -2,  -1000 }, {      0,      0,      0 }, 0x0000 },
};
...
SceneCmd daiyousei_izumi_room_0Set_000260[] = {
    ...
    SCENE_CMD_ACTOR_LIST(3, daiyousei_izumi_room_0ActorEntry_0002A8),
    SCENE_CMD_END(),
};
...
ActorEntry daiyousei_izumi_room_0ActorEntry_0002A8[] = {
    { ACTOR_EN_LIGHT,      {   -171,    113,   -854 }, {      0,      0,      0 }, 0x03F0 },
    { ACTOR_EN_LIGHT,      {    134,    113,   -854 }, {      0,      0,      0 }, 0x03F0 },
    { ACTOR_BG_DY_YOSEIZO, {    -19,     -2,  -1000 }, {      0,      0,      0 }, 0x0000 },
};
