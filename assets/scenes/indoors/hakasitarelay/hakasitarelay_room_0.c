...
SceneCmd hakasitarelay_room_0Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&hakasitarelay_room_0RoomShapeNormal_0000F0),
    SCENE_CMD_OBJECT_LIST(8, hakasitarelay_room_0ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(10, hakasitarelay_room_0ActorEntry_000050),
    SCENE_CMD_END(),
};
...
ActorEntry hakasitarelay_room_0ActorEntry_000050[] = {
