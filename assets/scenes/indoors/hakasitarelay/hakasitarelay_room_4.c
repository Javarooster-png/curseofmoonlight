...
SceneCmd hakasitarelay_room_4Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&hakasitarelay_room_4RoomShapeNormal_0000A0),
    SCENE_CMD_OBJECT_LIST(10, hakasitarelay_room_4ObjectList_000040),
    SCENE_CMD_ACTOR_LIST(4, hakasitarelay_room_4ActorEntry_000054),
    SCENE_CMD_END(),
};
...
ActorEntry hakasitarelay_room_4ActorEntry_000054[] = {
...
RoomShapeNormal hakasitarelay_room_4RoomShapeNormal_0000A0 = { 
    0, 1,
    hakasitarelay_room_4RoomShapeDListsEntry_0000AC,
    hakasitarelay_room_4RoomShapeDListsEntry_0000AC + ARRAY_COUNTU(hakasitarelay_room_4RoomShapeDListsEntry_0000AC)
};

RoomShapeDListsEntry hakasitarelay_room_4RoomShapeDListsEntry_0000AC[1] = {
