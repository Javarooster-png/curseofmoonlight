...
SceneCmd kenjyanoma_room_0Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&kenjyanoma_room_0RoomShapeNormal_0000F0),
    SCENE_CMD_OBJECT_LIST(8, kenjyanoma_room_0ObjectList_000060),
    SCENE_CMD_ACTOR_LIST(8, kenjyanoma_room_0ActorEntry_000070),
    SCENE_CMD_END(),
};
...
ActorEntry kenjyanoma_room_0ActorEntry_000070[] = {
...
RoomShapeNormal kenjyanoma_room_0RoomShapeNormal_0000F0 = { 
    0, 1,
    kenjyanoma_room_0RoomShapeDListsEntry_0000FC,
    kenjyanoma_room_0RoomShapeDListsEntry_0000FC + ARRAY_COUNTU(kenjyanoma_room_0RoomShapeDListsEntry_0000FC)
};

RoomShapeDListsEntry kenjyanoma_room_0RoomShapeDListsEntry_0000FC[1] = {
...
SceneCmd kenjyanoma_room_0Set_000110[] = {
    ...
    SCENE_CMD_ACTOR_LIST(2, kenjyanoma_room_0ActorEntry_000160),
    SCENE_CMD_END(),
};
...
ActorEntry kenjyanoma_room_0ActorEntry_000160[] = {
...
SceneCmd kenjyanoma_room_0Set_000180[] = {
    ...
    SCENE_CMD_ACTOR_LIST(6, kenjyanoma_room_0ActorEntry_0001D0),
    SCENE_CMD_END(),
};
...
ActorEntry kenjyanoma_room_0ActorEntry_0001D0[] = {
    { ACTOR_DEMO_SA,        {    -97,      6,   -168 }, {      0, 0X1555,      0 }, 0x0000 },
    { ACTOR_DEMO_DU,        {     93,      6,   -161 }, {      0, 0XEAAB,      0 }, 0x0000 },
...
SceneCmd kenjyanoma_room_0Set_000230[] = {
    ...
    SCENE_CMD_ACTOR_LIST(8, kenjyanoma_room_0ActorEntry_000284),
    SCENE_CMD_END(),
};
...
ActorEntry kenjyanoma_room_0ActorEntry_000284[] = {
