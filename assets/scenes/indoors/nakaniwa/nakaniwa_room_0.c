...
SceneCmd nakaniwa_room_0Commands[] = {
    ...
    SCENE_CMD_ROOM_SHAPE(&nakaniwa_room_0RoomShapeNormal_000100),
    SCENE_CMD_OBJECT_LIST(8, nakaniwa_room_0ObjectList_000060),
    SCENE_CMD_ACTOR_LIST(9, nakaniwa_room_0ActorEntry_000070),
    SCENE_CMD_END(),
};
...
ActorEntry nakaniwa_room_0ActorEntry_000070[] = {
...
RoomShapeNormal nakaniwa_room_0RoomShapeNormal_000100 = { 
    0, 1,
    nakaniwa_room_0RoomShapeDListsEntry_00010C,
    nakaniwa_room_0RoomShapeDListsEntry_00010C + ARRAY_COUNTU(nakaniwa_room_0RoomShapeDListsEntry_00010C)
};

RoomShapeDListsEntry nakaniwa_room_0RoomShapeDListsEntry_00010C[1] = {
...
SceneCmd nakaniwa_room_0Set_000120[] = {
    ...
    SCENE_CMD_ACTOR_LIST(4, nakaniwa_room_0ActorEntry_000164),
    SCENE_CMD_END(),
};
...
ActorEntry nakaniwa_room_0ActorEntry_000164[] = {
...
SceneCmd nakaniwa_room_0Set_0001B0[] = {
    ...
    SCENE_CMD_ACTOR_LIST(4, nakaniwa_room_0ActorEntry_0001F4),
    SCENE_CMD_END(),
};
...
ActorEntry nakaniwa_room_0ActorEntry_0001F4[] = {
    { ACTOR_EN_HEISHI2, {  -1037,     84,     58 }, {      0, 0X4000,      0 }, 0xFF06 },
    { ACTOR_EN_HEISHI2, {  -1037,     84,    -58 }, {      0, 0X4000,      0 }, 0xFF06 },
...
SceneCmd nakaniwa_room_0Set_000240[] = {
    ...
    SCENE_CMD_ACTOR_LIST(4, nakaniwa_room_0ActorEntry_000284),
    SCENE_CMD_END(),
};
...
ActorEntry nakaniwa_room_0ActorEntry_000284[] = {
    { ACTOR_EN_HEISHI2, {  -1037,     84,     58 }, {      0, 0X4000,      0 }, 0xFF06 },
    { ACTOR_EN_HEISHI2, {  -1037,     84,    -58 }, {      0, 0X4000,      0 }, 0xFF06 },
    { ACTOR_EN_ZL1,     {   -485,     84,      0 }, {      0, 0X4000,      0 }, 0xFFFF },
    { ACTOR_DEMO_IM,    {    336,     44,      0 }, {      0, 0XC000,      0 }, 0x0005 },
