...
beginseg
    name "code"
    after "dmadata"
    include "build/src/code/z_screen_text.o"
...
beginseg
    name "ovl_En_Ybb"
    include "build/src/overlays/actors/ovl_En_Ybb/z_en_ybb.o"
    include "build/src/overlays/actors/ovl_En_Ybb/ovl_En_Ybb_reloc.o"
endseg
...
beginseg
    name "ovl_Door_Gate"
    include "build/src/overlays/actors/ovl_Door_Gate/z_Door_Gate.o"
    include "build/src/overlays/actors/ovl_Door_Gate/ovl_Door_Gate_reloc.o"
endseg

beginseg
    name "ovl_Bg_Lampvater"
    include "build/src/overlays/actors/ovl_Bg_Lampvater/z_Bg_Lampvater.o"
    include "build/src/overlays/actors/ovl_Bg_Lampvater/ovl_Bg_Lampvater_reloc.o"
endseg

beginseg
    name "ovl_Bg_IronGate"
    include "build/src/overlays/actors/ovl_Bg_IronGate/z_Bg_IronGate.o"
    include "build/src/overlays/actors/ovl_Bg_IronGate/ovl_Bg_IronGate_reloc.o"
endseg

beginseg
    name "ovl_En_Go_Mm"
    include "build/src/overlays/actors/ovl_En_Go_Mm/z_en_go_mm.o"
    include "build/src/overlays/actors/ovl_En_Go_Mm/ovl_En_Go_Mm_reloc.o"
endseg

beginseg
    name "ovl_En_Weredrip"
    include "build/src/overlays/actors/ovl_En_Weredrip/z_En_Weredrip.o"
    include "build/src/overlays/actors/ovl_En_Weredrip/ovl_En_Weredrip_reloc.o"
endseg

beginseg
    name "ovl_En_Weredrip2"
    include "build/src/overlays/actors/ovl_En_Weredrip2/z_En_Weredrip2.o"
    include "build/src/overlays/actors/ovl_En_Weredrip2/ovl_En_Weredrip2_reloc.o"
endseg

beginseg
    name "ovl_En_Weredrip3"
    include "build/src/overlays/actors/ovl_En_Weredrip3/z_En_Weredrip3.o"
    include "build/src/overlays/actors/ovl_En_Weredrip3/ovl_En_Weredrip3_reloc.o"
endseg
...
beginseg
    name "ovl_En_Rover"
    include "build/src/overlays/actors/ovl_En_Rover/z_en_rover.o"
    include "build/src/overlays/actors/ovl_En_Rover/ovl_En_Rover_reloc.o"
endseg

beginseg
    name "ovl_En_Beast"
    include "build/src/overlays/actors/ovl_En_Beast/z_En_Beast.o"
    include "build/src/overlays/actors/ovl_En_Beast/ovl_En_Beast_reloc.o"
endseg

beginseg
    name "ovl_En_Barten"
    include "build/src/overlays/actors/ovl_En_Barten/z_en_barten.o"
    include "build/src/overlays/actors/ovl_En_Barten/ovl_En_Barten_reloc.o"
endseg

beginseg
    name "ovl_En_SkelB"
    include "build/src/overlays/actors/ovl_En_SkelB/z_En_SkelB.o"
    include "build/src/overlays/actors/ovl_En_SkelB/ovl_En_SkelB_reloc.o"
endseg

beginseg
    name "ovl_En_Spider"
    include "build/src/overlays/actors/ovl_En_Spider/z_En_Spider.o"
    include "build/src/overlays/actors/ovl_En_Spider/ovl_En_Spider_reloc.o"
endseg

beginseg
    name "ovl_En_Zomb"
    include "build/src/overlays/actors/ovl_En_Zomb/z_En_Zomb.o"
    include "build/src/overlays/actors/ovl_En_Zomb/ovl_En_Zomb_reloc.o"
endseg

beginseg
    name "ovl_En_Eldritch"
    include "build/src/overlays/actors/ovl_En_Eldritch/z_En_Eldritch.o"
    include "build/src/overlays/actors/ovl_En_Eldritch/ovl_En_Eldritch_reloc.o"
endseg

beginseg
    name "ovl_En_Thefather"
    include "build/src/overlays/actors/ovl_En_Thefather/z_En_Thefather.o"
    include "build/src/overlays/actors/ovl_En_Thefather/ovl_En_Thefather_reloc.o"
endseg
...
beginseg
    name "ovl_Bg_Stained"
    include "build/src/overlays/actors/ovl_Bg_Stained/z_bg_stained.o"
    include "build/src/overlays/actors/ovl_Bg_Stained/ovl_Bg_Stained_reloc.o"
endseg

beginseg
    name "ovl_Bg_Portc"
    include "build/src/overlays/actors/ovl_Bg_Portc/z_Bg_Portc.o"
    include "build/src/overlays/actors/ovl_Bg_Portc/ovl_Bg_Portc_reloc.o"
endseg

beginseg
    name "ovl_Bg_DrawB"
    include "build/src/overlays/actors/ovl_Bg_DrawB/z_Bg_DrawB.o"
    include "build/src/overlays/actors/ovl_Bg_DrawB/ovl_Bg_DrawB_reloc.o"
endseg

beginseg
    name "ovl_Wall_Pull_Switch"
    include "build/src/overlays/actors/ovl_Wall_Pull_Switch/wall_pull_switch.o"
    include "build/src/overlays/actors/ovl_Wall_Pull_Switch/ovl_Wall_Pull_Switch_reloc.o"
endseg
...
beginseg
    ...
    romalign 0x1000
    number 6
    include "build/assets/objects/object_ybb/object_ybb.o"
endseg
...
beginseg
    name "object_gate"
    romalign 0x1000
    include "build/assets/objects/object_gate/object_gate.o"
    number 6
endseg

beginseg
    name "object_lampvater"
    romalign 0x1000
    include "build/assets/objects/object_lampvater/gElevatorDL.o"
    include "build/assets/objects/object_lampvater/gElevatorDLLight.o"
    include "build/assets/objects/object_lampvater/gElevatorDL_collision.o"
    number 6
endseg


beginseg
    name "object_irongate"
    romalign 0x1000
    include "build/assets/objects/object_irongate/gIronGateDL.o"
    include "build/assets/objects/object_irongate/gIronGateDL_collision_collision.o"
    number 6
endseg

beginseg
    name "object_oF1d_map_mm"
    romalign 0x1000
    include "build/assets/objects/object_oF1d_map_mm/object_oF1d_map_mm.o"
    number 6
endseg

beginseg
    name "object_weredrip"
    romalign 0x1000
    include "build/assets/objects/object_weredrip/object_weredrip.o"
    number 6
endseg

beginseg
    name "object_weredrip2"
    romalign 0x1000
    include "build/assets/objects/object_weredrip2/object_weredrip2.o"
    number 6
endseg

beginseg
    name "object_weredrip3"
    romalign 0x1000
    include "build/assets/objects/object_weredrip3/object_weredrip3.o"
    number 6
endseg
...
beginseg
    name "object_beast"
    romalign 0x1000
    include "build/assets/objects/object_beast/object_beast.o"
    number 6
endseg
...
beginseg
    name "object_skelb"
    romalign 0x1000
    include "build/assets/objects/object_skelb/object_skelb.o"
    number 6
endseg
...
beginseg
    name "object_spider"
    romalign 0x1000
    include "build/assets/objects/object_spider/object_spider.o"
    number 6
endseg
...
beginseg
    name "object_zomb"
    romalign 0x1000
    include "build/assets/objects/object_zomb/object_zomb.o"
    number 6
endseg

beginseg
    name "object_eldritch"
    romalign 0x1000
    include "build/assets/objects/object_eldritch/object_eldritch.o"
    number 6
endseg

beginseg
    name "object_thefather"
    romalign 0x1000
    include "build/assets/objects/object_thefather/object_thefather.o"
    number 6
endseg
...
beginseg
    name "object_stained"
    romalign 0x1000
    include "build/assets/objects/object_stained/gWindowMesh_transparent.o"
    include "build/assets/objects/object_stained/gWindowMeshDL.o"
    include "build/assets/objects/object_stained/gShard.o"
    number 6
endseg

beginseg
    name "object_portcullis"
    romalign 0x1000
    include "build/assets/objects/object_portcullis/gPortcDL.o"
    include "build/assets/objects/object_portcullis/gPortcDL_collision.o"
    number 6
endseg

beginseg
    name "object_drawbridge"
    romalign 0x1000
    include "build/assets/objects/object_drawbridge/gDrawBridgeDL.o"
    include "build/assets/objects/object_drawbridge/gDrawBridgeDL_collision.o"
    include "build/assets/objects/object_drawbridge/gDrawBridge2DL.o"
    include "build/assets/objects/object_drawbridge/gDrawBridge2DL_collision.o"
    include "build/assets/objects/object_drawbridge/gDrawBridge3DL.o"
    include "build/assets/objects/object_drawbridge/gDrawBridge3DL_collision.o"
    number 6
endseg
...
beginseg
    ...
    romalign 0x1000
    include "build/assets/objects/object_wall_pull_switch/object_wall_pull_switch.o"
    number 6
endseg
...
beginseg
    name "Calmdiyah"
    romalign 0x1000
    include "build/assets/scenes/custom/Calmdiyah/Calmdiyah_scene.o"
    number 2
endseg

beginseg
    name "Calmdiyah_room_0"
    romalign 0x1000
    include "build/assets/scenes/custom/Calmdiyah/Calmdiyah_room_0.o"
    number 3
endseg

beginseg
    name "Calmdiyah_room_1"
    romalign 0x1000
    include "build/assets/scenes/custom/Calmdiyah/Calmdiyah_room_1.o"
    number 3
endseg

beginseg
    name "Calmdiyah_room_2"
    romalign 0x1000
    include "build/assets/scenes/custom/Calmdiyah/Calmdiyah_room_2.o"
    number 3
endseg

beginseg
    name "Calmdiyah_room_3"
    romalign 0x1000
    include "build/assets/scenes/custom/Calmdiyah/Calmdiyah_room_3.o"
    number 3
endseg

beginseg
    name "Calmdiyah_room_4"
    romalign 0x1000
    include "build/assets/scenes/custom/Calmdiyah/Calmdiyah_room_4.o"
    number 3
endseg

beginseg
    name "Calmdiyah_room_5"
    romalign 0x1000
    include "build/assets/scenes/custom/Calmdiyah/Calmdiyah_room_5.o"
    number 3
endseg

beginseg
    name "Calmdiyah_room_6"
    romalign 0x1000
    include "build/assets/scenes/custom/Calmdiyah/Calmdiyah_room_6.o"
    number 3
endseg

beginseg
    name "Calmdiyah_room_7"
    romalign 0x1000
    include "build/assets/scenes/custom/Calmdiyah/Calmdiyah_room_7.o"
    number 3
endseg

beginseg
    name "Calmdiyah_room_8"
    romalign 0x1000
    include "build/assets/scenes/custom/Calmdiyah/Calmdiyah_room_8.o"
    number 3
endseg

beginseg
    name "Calmdiyah_room_9"
    romalign 0x1000
    include "build/assets/scenes/custom/Calmdiyah/Calmdiyah_room_9.o"
    number 3
endseg
...
beginseg
    ...
    romalign 0x1000
    include "build/assets/scenes/custom/Catacombs/Catacombs_scene.o"
    number 2
endseg
...
beginseg
    ...
    romalign 0x1000
    include "build/assets/scenes/custom/Catacombs/Catacombs_room_0.o"
    number 3
endseg
...
beginseg
    name "GroundTest_scene"
    romalign 0x1000
    include "build/assets/scenes/overworld/GroundTest/GroundTest_scene.o"
    number 2
endseg

beginseg
    name "GroundTest_room_0"
    romalign 0x1000
    include "build/assets/scenes/overworld/GroundTest/GroundTest_room_0.o"
    number 3
endseg
...
beginseg
    name "Cathedral"
    romalign 0x1000
    include "build/assets/scenes/custom/Cathedral/Cathedral_scene.o"
    number 2
endseg

beginseg
    name "Cathedral_room_0"
    romalign 0x1000
    include "build/assets/scenes/custom/Cathedral/Cathedral_room_0.o"
    number 3
endseg

beginseg
    name "Cathedral_room_1"
    romalign 0x1000
    include "build/assets/scenes/custom/Cathedral/Cathedral_room_1.o"
    number 3
endseg

beginseg
    name "Cathedral_room_2"
    romalign 0x1000
    include "build/assets/scenes/custom/Cathedral/Cathedral_room_2.o"
    number 3
endseg

beginseg
    name "Cathedral_room_3"
    romalign 0x1000
    include "build/assets/scenes/custom/Cathedral/Cathedral_room_3.o"
    number 3
endseg

beginseg
    name "Cathedral_room_4"
    romalign 0x1000
    include "build/assets/scenes/custom/Cathedral/Cathedral_room_4.o"
    number 3
endseg

beginseg
    name "Cathedral_room_5"
    romalign 0x1000
    include "build/assets/scenes/custom/Cathedral/Cathedral_room_5.o"
    number 3
endseg

beginseg
    name "Cathedral_room_6"
    romalign 0x1000
    include "build/assets/scenes/custom/Cathedral/Cathedral_room_6.o"
    number 3
endseg
...
beginseg
    name "CathedralBoss"
    romalign 0x1000
    include "build/assets/scenes/custom/CathedralBoss/CathedralBoss_scene.o"
    number 2
endseg

beginseg
    name "CathedralBoss_room_0"
    romalign 0x1000
    include "build/assets/scenes/custom/CathedralBoss/CathedralBoss_room_0.o"
    number 3
endseg
...
beginseg
    name "Cata"
    romalign 0x1000
    include "build/assets/scenes/custom/Cata/Cata_scene.o"
    number 2
endseg
...
beginseg
    name "Cata_room_0"
    romalign 0x1000
    include "build/assets/scenes/custom/Cata/Cata_room_0.o"
    number 3
endseg
...
beginseg
    name "Cata_room_1"
    romalign 0x1000
    include "build/assets/scenes/custom/Cata/Cata_room_1.o"
    number 3
endseg
...
beginseg
    name "Cata_room_2"
    romalign 0x1000
    include "build/assets/scenes/custom/Cata/Cata_room_2.o"
    number 3
endseg
...
beginseg
    name "Cata_room_3"
    romalign 0x1000
    include "build/assets/scenes/custom/Cata/Cata_room_3.o"
    number 3
endseg
...
beginseg
    name "Cata_room_4"
    romalign 0x1000
    include "build/assets/scenes/custom/Cata/Cata_room_4.o"
    number 3
endseg
...
beginseg
    name "Cata_room_5"
    romalign 0x1000
    include "build/assets/scenes/custom/Cata/Cata_room_5.o"
    number 3
endseg
...
beginseg
    name "DarkWoods"
    romalign 0x1000
    include "build/assets/scenes/custom/DarkWoods/DarkWoods_scene.o"
    number 2
endseg

beginseg
    name "DarkWoods_room_0"
    romalign 0x1000
    include "build/assets/scenes/custom/DarkWoods/DarkWoods_room_0.o"
    number 3
endseg

beginseg
    name "DarkWoods_room_1"
    romalign 0x1000
    include "build/assets/scenes/custom/DarkWoods/DarkWoods_room_1.o"
    number 3
endseg

beginseg
    name "DarkWoods_room_2"
    romalign 0x1000
    include "build/assets/scenes/custom/DarkWoods/DarkWoods_room_2.o"
    number 3
endseg

beginseg
    name "DarkWoods_room_3"
    romalign 0x1000
    include "build/assets/scenes/custom/DarkWoods/DarkWoods_room_3.o"
    number 3
endseg

beginseg
    name "DarkWoods_room_4"
    romalign 0x1000
    include "build/assets/scenes/custom/DarkWoods/DarkWoods_room_4.o"
    number 3
endseg

beginseg
    name "DarkWoods_room_5"
    romalign 0x1000
    include "build/assets/scenes/custom/DarkWoods/DarkWoods_room_5.o"
    number 3
endseg

beginseg
    name "DarkWoods_room_6"
    romalign 0x1000
    include "build/assets/scenes/custom/DarkWoods/DarkWoods_room_6.o"
    number 3
endseg
...
beginseg
    name "CAVEINTERIOR"
    romalign 0x1000
    include "build/assets/scenes/custom/CAVEINTERIOR/CAVEINTERIOR_scene.o"
    number 2
endseg

beginseg
    name "CAVEINTERIOR_room_0"
    romalign 0x1000
    include "build/assets/scenes/custom/CAVEINTERIOR/CAVEINTERIOR_room_0.o"
    number 3
endseg

beginseg
    name "CAVEINTERIOR_room_1"
    romalign 0x1000
    include "build/assets/scenes/custom/CAVEINTERIOR/CAVEINTERIOR_room_1.o"
    number 3
endseg

beginseg
    name "CAVEINTERIOR_room_2"
    romalign 0x1000
    include "build/assets/scenes/custom/CAVEINTERIOR/CAVEINTERIOR_room_2.o"
    number 3
endseg

beginseg
    name "CAVEINTERIOR_room_3"
    romalign 0x1000
    include "build/assets/scenes/custom/CAVEINTERIOR/CAVEINTERIOR_room_3.o"
    number 3
endseg
