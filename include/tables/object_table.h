...
/* 0x0191 */ DEFINE_OBJECT(object_zl4, OBJECT_ZL4)
             DEFINE_OBJECT(object_yb, OBJECT_YB)
             DEFINE_OBJECT(object_ybb, OBJECT_YBB)
             DEFINE_OBJECT(object_bal, OBJECT_BAL)
             DEFINE_OBJECT(object_harfgibud, OBJECT_HARFGIBUD)
             DEFINE_OBJECT(object_rz, OBJECT_RZ)
/* 0x0192 */ DEFINE_OBJECT(object_gate, OBJECT_GATE)
/* 0x0193 */ DEFINE_OBJECT(object_lampvater, OBJECT_LAMPVATER)
/* 0x0194 */ DEFINE_OBJECT(object_irongate, OBJECT_IRONGATE)
             DEFINE_OBJECT(object_oF1d_map_mm, OBJECT_OF1D_MAP_MM)
/* 0x0194 */ DEFINE_OBJECT(object_weredrip, OBJECT_WEREDRIP)
/* 0x0194 */ DEFINE_OBJECT(object_weredrip2, OBJECT_WEREDRIP2)
/* 0x0194 */ DEFINE_OBJECT(object_weredrip3, OBJECT_WEREDRIP3)
             DEFINE_OBJECT(object_gg, OBJECT_GG)
             DEFINE_OBJECT(object_jg, OBJECT_JG)
             DEFINE_OBJECT(object_dai, OBJECT_DAI)
/* 0x0194 */ DEFINE_OBJECT(object_beast, OBJECT_BEAST)
             DEFINE_OBJECT(object_tab, OBJECT_TAB)
             DEFINE_OBJECT(object_skelb, OBJECT_SKELB)
             DEFINE_OBJECT(object_spider, OBJECT_SPIDER)
             DEFINE_OBJECT(object_zomb, OBJECT_ZOMB)
             DEFINE_OBJECT(object_eldritch, OBJECT_ELDRITCH)
             DEFINE_OBJECT(object_thefather, OBJECT_THEFATHER)
             DEFINE_OBJECT(object_wiz, OBJECT_WIZ)
             DEFINE_OBJECT(object_stained, OBJECT_STAINED)
             DEFINE_OBJECT(object_portcullis, OBJECT_PORTCULLIS)
             DEFINE_OBJECT(object_drawbridge, OBJECT_DRAWBRIDGE)
