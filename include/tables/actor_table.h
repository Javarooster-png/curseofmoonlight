...
/* 0x01D6 */ DEFINE_ACTOR(Obj_Warp2block, ACTOR_OBJ_WARP2BLOCK, ACTOROVL_ALLOC_NORMAL, "Obj_Warp2block")
             DEFINE_ACTOR(En_Yb, ACTOR_EN_YB, ACTOROVL_ALLOC_NORMAL, "En_Yb")
             DEFINE_ACTOR(En_Ybb, ACTOR_EN_YBB, ACTOROVL_ALLOC_NORMAL, "En_Ybb")
             DEFINE_ACTOR(En_Bal, ACTOR_EN_BAL, ACTOROVL_ALLOC_NORMAL, "En_Bal")
             DEFINE_ACTOR(En_Hg, ACTOR_EN_HG, ACTOROVL_ALLOC_NORMAL, "En_Hg")
             DEFINE_ACTOR(En_Rz, ACTOR_EN_RZ, ACTOROVL_ALLOC_NORMAL, "En_Rz")
/* 0x01D7 */ DEFINE_ACTOR(Door_Gate, ACTOR_GATE, ACTOROVL_ALLOC_NORMAL, "Door_Gate")
/* 0x01D8 */ DEFINE_ACTOR(Bg_Lampvater, ACTOR_LAMPVATER, ACTOROVL_ALLOC_NORMAL, "Bg_Lampvater")
/* 0x01D9 */ DEFINE_ACTOR(Bg_IronGate, ACTOR_IRONGATE, ACTOROVL_ALLOC_NORMAL, "Bg_IronGate")
             DEFINE_ACTOR(En_Go_Mm, ACTOR_EN_GO_MM, ACTOROVL_ALLOC_NORMAL, "En_Go_Mm")
/* 0x01D9 */ DEFINE_ACTOR(En_Weredrip, ACTOR_WEREDRIP, ACTOROVL_ALLOC_NORMAL, "En_Weredrip")
/* 0x01D9 */ DEFINE_ACTOR(En_Weredrip2, ACTOR_WEREDRIP2, ACTOROVL_ALLOC_NORMAL, "En_Weredrip2")
/* 0x01D9 */ DEFINE_ACTOR(En_Weredrip3, ACTOR_WEREDRIP3, ACTOROVL_ALLOC_NORMAL, "En_Weredrip3")
             DEFINE_ACTOR(En_Gg, ACTOR_EN_GG, ACTOROVL_ALLOC_NORMAL, "En_Gg")
             DEFINE_ACTOR(En_Jg, ACTOR_EN_JG, ACTOROVL_ALLOC_NORMAL, "En_Jg")
             DEFINE_ACTOR(En_Ig, ACTOR_EN_IG, ACTOROVL_ALLOC_NORMAL, "En_Ig")
             DEFINE_ACTOR(En_Rover, ACTOR_EN_ROVER, ACTOROVL_ALLOC_NORMAL, "En_Rover")
/* 0x01D9 */ DEFINE_ACTOR(En_Beast, ACTOR_BEAST, ACTOROVL_ALLOC_NORMAL, "En_Beast")
             DEFINE_ACTOR(En_Barten, ACTOR_EN_BARTEN, ACTOROVL_ALLOC_NORMAL, "En_Barten")
/* 0x01D9 */ DEFINE_ACTOR(En_SkelB, ACTOR_SKELB, ACTOROVL_ALLOC_NORMAL, "En_SkelB")
/* 0x01D9 */ DEFINE_ACTOR(En_Spider, ACTOR_SPIDER, ACTOROVL_ALLOC_NORMAL, "En_Spider")
/* 0x01D9 */ DEFINE_ACTOR(En_Zomb, ACTOR_ZOMB, ACTOROVL_ALLOC_NORMAL, "En_Zomb")
/* 0x01D9 */ DEFINE_ACTOR(En_Eldritch, ACTOR_ELDRITCH, ACTOROVL_ALLOC_NORMAL, "En_Eldritch")
/* 0x01D9 */ DEFINE_ACTOR(En_Thefather, ACTOR_THEFATHER, ACTOROVL_ALLOC_NORMAL, "En_Thefather")
             DEFINE_ACTOR(En_Wiz, ACTOR_EN_WIZ, ACTOROVL_ALLOC_NORMAL, "En_Wiz")
             DEFINE_ACTOR(Bg_Stained, ACTOR_STAINED, ACTOROVL_ALLOC_NORMAL, "Bg_Stained")
             DEFINE_ACTOR(Bg_Portc, ACTOR_PORTC, ACTOROVL_ALLOC_NORMAL, "Bg_Portc")
             DEFINE_ACTOR(Bg_DrawB, ACTOR_DRAWB, ACTOROVL_ALLOC_NORMAL, "Bg_DrawB")
